...
<ToolBar width='100%' height='100%'>
	...
	<ToolButton name='btnDelete' label='删除' icon='tool.delete' icon_disable='tool.deleted' disp_access='U' page='delete@#/design/webtree/WebTree.wa'/>
	<ToolButtonSplit/>
	<ToolButton name='btnInsertColumn' label='新建列' icon='#webtree.column' icon_disable='tool.insertd' disp_access='U' page='insert@#/design/webtree/WebControl.wa?form_name=design.webtree.TreeColumnForm'/>
	<ToolButton name='btnInsertType' label='新建类型' icon='#webtree.type' icon_disable='tool.insertd' disp_access='U' page='insert@#/design/webtree/WebControl.wa?form_name=design.webtree.TreeNodeTypeForm'/>
	<ToolButton name='btnInsertLevel' label='新建层次' icon='#webtree.level' icon_disable='tool.insertd' disp_access='U' page='insert@#/design/webtree/WebControl.wa?form_name=design.webtree.TreeLevelForm'/>
	<ToolButton name='btnInsertNode' label='新建节点' icon='#webtree.node' icon_disable='tool.insertd' disp_access='U' page='insert@#/design/webtree/WebControl.wa?form_name=design.webtree.TreeNodeForm'/>
</ToolBar>
</XML>
<!-- Form ---------------------------------------------------->
