...
<ToolBar width='100%' height='100%'>
	...
	<ToolButtonSplit/>
	<ToolButton name='btnInsert' caption='新建控件'  icon='tool.insert' icon_disable='tool.saved' disp_access='U' hotkey='F5' page='insert@#/design/webtree/WebControl.wa'/>
	<ToolButton name='btnSave' caption='保存'  icon='tool.save' icon_disable='tool.saved' hotkey='F8' action='doSave()'/>
	<ToolButton name='btnDelete' caption='删除'  icon='tool.delete' icon_disable='tool.deleted' disp_access='U' hotkey='F6' page='delete@#/design/webtree/WebControl.wa'/>
	<!-- <ToolButtonSplit/>
