...
<ToolBar width='100%' height='100%' align='right'>
	<ToolButtonText name='btnForm' label='配置列表' icon='sys.pst.mgr' target='frmMain' page='#/system/config/Config.wa?do=list&amp;form_name=system.config.ConfigurationList'/>
	<ToolButton name='btnRefresh' icon='tool.refresh' action='refreshNode()'/>
</ToolBar>
</XML>
<!-- TreeView config ----------------------------------------->
<jc:tree name='xTree' source='system.system.config'/>
<!-- Body begin ---------------------------------------------->
