...
function FGroup_onBuildEdit(b){
   ...
   for(n = 0; n<20; n++){
	  ...
	  if(o.itemType == 'Check'){
	     ...
	     var hce = RBuilder.appendRadio(hcc);
	  }
	  hce.style.border = 0;
...
function FCellButton_buildForm(){
   ...
   if(bs){
      ...
      for(var n=0; n<bs.count; n++){
         ...
         RControl.attachEvent(o, 'onButtonEnter', hbp, o.onButtonEnter)
         RControl.attachEvent(o, 'onButtonLeave', hbp, o.onButtonLeave);
         RControl.attachEvent(o, 'onButtonClick', hbp)
         var ht = null;
         if(b.label){
            if(b.icon){
               hi.title = b.label;
...
function FTreeNode_loadNode(x){
   ...
   var ni = RString.nvl(o.icon, o.type ? o.type.icon : t.iconEmpty);
...
function FTreeNode_pushChanged(trd){
   var o = this;
   if(o.checkChanged()){
      var d = new TNode('checked', RBool.toString(o.check()));
      trd.push(d)
   }
...
function FCheckWindow_set(tl){
   ...
   for(var n = 0; n < tl.count; n++){
      ...
      hc1.width = '20';
      var hc2 = hr.insertCell();
      hc2.innerHTML = '<span>' + c.label + '</span>';
