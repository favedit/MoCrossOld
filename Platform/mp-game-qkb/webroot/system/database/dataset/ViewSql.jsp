...
function doExecute(){
	fmMain.action = '<jh:context/>/database/dataset/Dataset.wa?do=viewSourceSave';
	fmMain.submit();
}
function _onloadAll(){
	MoJS.connect();
...
<!-- Form begin ---------------------------------------------->
<TEXTAREA name='viewSql' wrap='off' style='border:1 solid #008800; width:100%;height:100%;'><jh:write source='&page.viewSql' format='text'/></TEXTAREA>
<!-- Form end ------------------------------------------------>
</TD></TR>
</TABLE>
</jh:form>
