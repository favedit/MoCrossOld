...
<jc:toolbar name='top.frames.frmToolbar.oToolbar' inFrame='frmWork' inForm='frmConsole' target='frmWork' action='refresh'>
   <jc:tbButton caption='trs:this|button.save|Save' pageAction='/system/property/PropertyDeleteSave.wa' icon='sys.save'/>
</jc:toolbar>
...
<TR><TD>
   ...
   <TR>
      <TD>Name:</TD>
      <TD><jh:item item='&property.name'/></TD>
   </TR>
   <TR>
      <TD>Label:</TD>
      <TD><jh:item item='&property.label'/></TD>
   </TR>
   <TR>
      <TD>Note:</TD>
      <TD><jh:item item='&property.note'/></TD>
   </TR>
</TD></TR>
</TABLE>
