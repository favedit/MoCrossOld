...
<jh:define source='&message_form.error_message_info' alias='error_message_info'/>
<jh:default action='_onBack()'/>

<SCRIPT language='javascript'>
function _onBack(){
   frmConsole.wa = "<jh:source source='&message_form.uri_prior'/>";
   frmConsole.submit();
}
</SCRIPT>
...
<jh:edit type='hidden' source='&message_form.check_flag' value='CHECKED@[MessageConstants]'/>

<TABLE width='100%' cellspacing='8' border='0'>
<TR><TD>
   <TABLE width='100%' border='0' cellspacing='1' cellpadding='4'>
      <TR><TD align='center' valign='middle'>
         <jh:img src='/res/img/sys/msg/lerror.gif' align='absmiddle'/><jh:img src='/res/img/n.gif' width='8'/><jh:write source='txt|sys|Message.Error.Title'/>
      </TD></TR>
   </TABLE>
</TD></TR>
...
<TR>
    ...
    <TD><FONT color='red'><jh:source source='&error_message_info.message'/></FONT></TD>
</TR>
