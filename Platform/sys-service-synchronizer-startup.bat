...
"%JDK_PATH%\bin\java.exe" -cp "%MO_CLASS%" com.zqinet.app.synchronizer.RStartup -home "%MO_PATH%\mp-service\src\config" -config application-synchronizer-local.xml -logger info
