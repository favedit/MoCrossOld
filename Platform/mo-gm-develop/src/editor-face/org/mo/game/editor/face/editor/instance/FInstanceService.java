...
// <T>实体服务。</T>
//============================================================
public class FInstanceService
      extends FAbsXmlObjectService<XInstanceGroup>
      implements
         IInstanceService
{
   // 枚举控制台
   ...
   public void catalog(IWebContext context,
                       ...
                       IWebOutput output){
      // 获得列表
      catalog(_instanceConsole, context, input, output);
      // 设置排序
   ...
   public void list(IWebContext context,
                    IWebInput input,
                    IWebOutput output){
      list(_instanceConsole, context, input, output);
   }
   ...
   public void search(IWebContext context,
      ...
      // 获得容器节点
      for(XInstanceGroup xgroup : _instanceConsole.list()){
   ...
   public void insert(IWebContext context,
                      IWebInput input,
                      IWebOutput output){
      insert(_instanceConsole, context, input, output);
   }
   ...
   public void update(IWebContext context,
                      IWebInput input,
                      IWebOutput output){
      update(_instanceConsole, context, input, output);
   }
   ...
   public void delete(IWebContext context,
                      IWebInput input,
                      IWebOutput output){
      delete(_instanceConsole, context, input, output);
   }
   ...
   public void sort(IWebContext context,
                    IWebInput input,
                    IWebOutput output){
      sort(_instanceConsole, context, input, output);
   }
}
