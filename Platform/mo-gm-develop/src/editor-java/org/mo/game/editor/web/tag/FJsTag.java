 ...
 *
 */
package org.mo.game.editor.web.tag;
      ...
      extends FBaseJsTag
{
   ...
   protected static String _networkCode;

   static{
      //IEnvironmentConsole _environmentConsole = RAop.find(IEnvironmentConsole.class);
      //_networkCode = RString.toLower(_environmentConsole.registers().get("nwtwork"));
   }
   ...
   public int onStart(){
      ...
      if("global".equalsIgnoreCase(type)){
         ...
         _writer.appendLine("RContext.uriIcon = '" + _context.contextTag() + "/ars/icon';");
         _writer.appendLine("RContext.uriPicture = '" + _context.contextTag() + "/ars/pic';");
         _writer.append("</SCRIPT>");
         _writer.flush();
