...
import org.mo.game.editor.core.dataset.common.XDatasetFace;
         ...
         XDatasetFace
{
   ...
   // 数据引擎的名称定义
   public static final String PTY_DATA_ENGINE = "data_engine";

   // 数据分组的名称定义
   public static final String PTY_DATA_GROUP = "data_group";

   // 数据工厂的名称定义
   public static final String PTY_DATA_FACTORY = "data_factory";
   ...
   // 数据来自的名称定义
   public static final String PTY_DATA_FROM = "data_from";

   // 数据条件的名称定义
   public static final String PTY_DATA_WHERE = "data_where";

   // 数据排序的名称定义
   public static final String PTY_DATA_ORDER = "data_order";
   ...
   public String innerGet(String name){
      ...
      }else if(PTY_DATA_ENGINE.equalsIgnoreCase(name)){
         return getDataEngine();
      }else if(PTY_DATA_GROUP.equalsIgnoreCase(name)){
         return getDataGroup();
      }else if(PTY_DATA_FACTORY.equalsIgnoreCase(name)){
      ...
      }else if(PTY_DATA_FROM.equalsIgnoreCase(name)){
         return getDataFrom();
      }else if(PTY_DATA_WHERE.equalsIgnoreCase(name)){
         return getDataWhere();
      }else if(PTY_DATA_ORDER.equalsIgnoreCase(name)){
         return getDataOrder();
      }
      return null;
   }
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("data_engine")){
            setDataEngine(config.get(PTY_DATA_ENGINE));
         }
         if(config.contains("data_group")){
            setDataGroup(config.get(PTY_DATA_GROUP));
         }
         if(config.contains("data_factory")){
            setDataFactory(config.get(PTY_DATA_FACTORY));
         }
         ...
         if(config.contains("data_from")){
            setDataFrom(config.get(PTY_DATA_FROM));
         }
         if(config.contains("data_where")){
            setDataWhere(config.get(PTY_DATA_WHERE));
         }
         if(config.contains("data_order")){
            setDataOrder(config.get(PTY_DATA_ORDER));
         }
         ...
         if(RString.isEmpty(getDataEngine())){
            if(config.contains("data_engine")){
               setDataEngine(config.get(PTY_DATA_ENGINE));
            }
         }
         ...
         if(RString.isEmpty(getDataFactory())){
            if(config.contains("data_factory")){
               setDataFactory(config.get(PTY_DATA_FACTORY));
            }
         }
         ...
         if(RString.isEmpty(getDataFrom())){
            if(config.contains("data_from")){
               setDataFrom(config.get(PTY_DATA_FROM));
            }
         }
         if(RString.isEmpty(getDataWhere())){
            if(config.contains("data_where")){
               setDataWhere(config.get(PTY_DATA_WHERE));
            }
         }
         if(RString.isEmpty(getDataOrder())){
            if(config.contains("data_order")){
               setDataOrder(config.get(PTY_DATA_ORDER));
            }
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getDataEngine())){
            config.set(PTY_DATA_ENGINE, getDataEngine());
         }
         if(RString.isNotEmpty(getDataGroup())){
            config.set(PTY_DATA_GROUP, getDataGroup());
         }
         if(RString.isNotEmpty(getDataFactory())){
            config.set(PTY_DATA_FACTORY, getDataFactory());
         }
         ...
         if(RString.isNotEmpty(getDataFrom())){
            config.set(PTY_DATA_FROM, getDataFrom());
         }
         if(RString.isNotEmpty(getDataWhere())){
            config.set(PTY_DATA_WHERE, getDataWhere());
         }
         if(RString.isNotEmpty(getDataOrder())){
            config.set(PTY_DATA_ORDER, getDataOrder());
         }
      }else if(EXmlConfig.Simple == type){
         if(RString.isNotEmpty(getName())){
            config.set(PTY_NAME, getName());
         ...
         String sDataEngine = getDataEngine();
         if(RString.isNotEmpty(sDataEngine)){
            config.set(PTY_DATA_ENGINE, sDataEngine);
         }
         String sDataGroup = getDataGroup();
         if(RString.isNotEmpty(sDataGroup)){
            config.set(PTY_DATA_GROUP, sDataGroup);
         }
         String sDataFactory = getDataFactory();
         if(RString.isNotEmpty(sDataFactory)){
            config.set(PTY_DATA_FACTORY, sDataFactory);
         }
         ...
         String sDataFrom = getDataFrom();
         if(RString.isNotEmpty(sDataFrom)){
            config.set(PTY_DATA_FROM, sDataFrom);
         }
         String sDataWhere = getDataWhere();
         if(RString.isNotEmpty(sDataWhere)){
            config.set(PTY_DATA_WHERE, sDataWhere);
         }
         String sDataOrder = getDataOrder();
         if(RString.isNotEmpty(sDataOrder)){
            config.set(PTY_DATA_ORDER, sDataOrder);
         }
      }else if(EXmlConfig.Default == type){
         String sDataEngine = getDataEngine();
         if(RString.isNotEmpty(sDataEngine)){
