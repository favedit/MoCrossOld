...
import org.mo.game.editor.core.dataset.common.XFieldFace;

//============================================================
// <T>日期时间字段对象的XML节点基类。</T>
//============================================================
public abstract class XBaseFieldDateTime
      extends FXmlObject
      implements
         XFieldFace
{
   // 名称定义
   public static final String NAME = "FieldDateTime";
