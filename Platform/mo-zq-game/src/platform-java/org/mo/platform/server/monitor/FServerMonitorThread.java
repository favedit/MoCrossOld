...
public class FServerMonitorThread
   ...
   // 日志输出接口
   protected static ILogger _logger = RLogger.find(FServerMonitorThread.class);

   // 服务监视接口
   protected IServerMonitor _monitor;
   
   // 监控处理
   protected FServerMonitorDispose monitorDispose = new FServerMonitorDispose();
   //============================================================
   // <T>构造服务监视线程。</T>
   //============================================================
   ...
   public boolean execute(){
      while(!_stopped){
         ...
         boolean result = monitorDispose.serverInfoProcess();
