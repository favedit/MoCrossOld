...
function changeTitleStatus(ph, ps){
   ...
   if(ps == 2){
      ...
      hTdr.style.backgroundImage = "url(../home/tbe.gif)";
...
function changeButtonStatus(ph, ps){
   ...
   if(ps == 2){
      // Select
      hTdl.style.backgroundImage = "url(../home/bl.gif)";
      hTd.style.color = 'black';
      hTd.bgColor = '#FFFFFF';
      hTd.style.fontWeight = 'bold';
      hTd.style.backgroundImage = "url(../home/bm.gif)";
      hTdr.style.backgroundImage = "url(../home/br.gif)";
   }else if(ps == 1){
      // Hover
...
<!-- 标题部分(中) - 主菜单 - end -->
<TR><TD height='28'>
<TABLE width='100%' height='100%' border='0' cellpadding="0" cellspacing='0' background='../home/bb.gif'>
<TR>
	<TD width='12'>&nbsp;</TD>
	<TD>
