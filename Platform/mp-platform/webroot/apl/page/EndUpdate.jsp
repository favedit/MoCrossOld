...
function _onBack(){
   if(!m_bExecute){
      m_bExecute = true;
      frmConsole.action = '<jh:uri source='&message_form.uri_prior'/>';
      frmConsole.submit();
   }
}
</SCRIPT>
...
<jc:toolbar name='top.frames.frmToolbar.oToolbar' inFrame='frmWork' inForm='frmConsole' target='frmWork' action='refresh'>
   <jh:notEmpty source='&message_form.uri_prior'>
      <jc:tbButton caption='txt|sys|button.back' action='_onBack()' icon='sys.back'/>
   </jh:notEmpty>
</jc:toolbar>

<jh:isTrue source='&catalog_form.caption_refresh'>
<jh:notEmpty source='&catalog_form.node_caption'>
<SCRIPT>
var oNode = top.frames.frmCatalog.oTreeView.focusNode;
if(oNode){oNode.setCaption("<jh:source source='&catalog_form.node_caption' format='N'/>");}
</SCRIPT>
<jh:reset source='&catalog_form.caption_refresh'/>
<jh:reset source='&catalog_form.node_caption'/>
</jh:notEmpty>
</jh:isTrue>

<jh:isTrue source='&catalog_form.node_refresh'>
<SCRIPT>top.frames.frmCatalog.oTreeView.refreshNode(null, false);</SCRIPT>
<jh:reset source='&catalog_form.node_refresh'/>
</jh:isTrue>

<jh:isTrue source='&catalog_form.parent_refresh'>
<SCRIPT>top.frames.frmCatalog.oTreeView.refreshNode(null, true);</SCRIPT>
<jh:reset source='&catalog_form.parent_refresh'/>
</jh:isTrue>
