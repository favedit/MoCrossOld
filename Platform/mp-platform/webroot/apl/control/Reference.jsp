...
<jh:define source='&reference_form.define' alias='define'/>
<jh:define source='&reference_form.dataset' alias='dataset'/>
...
<TABLE id='id_table' bgcolor='#999999' width='100%' cellspacing='1' cellpadding='2' tabindex='2' onfocus='DataRefManager.onTableFocus()' onblur='DataRefManager.onTableBlur()'>
   <TR bgcolor='#CCCCCC'>
   <jh:loop source='&define' alias='field'>
      <TD><jh:source source='&field.label'/></TD>
   </jh:loop>
   </TR>
   <TR id='id_fields' style='display:none'>
   <jh:loop source='&define' alias='field'>
      <TD><jh:source source='&field.data_alias'/></TD>
   </jh:loop>
   </TR>
   <jh:hasChild source='&dataset'>
      <jh:loop source='&dataset' alias='unit'>
      <TR id='id_rows' bgcolor='#FFFFFF' onmouseover='DataRefManager.onRowOver(this)' onmouseout='DataRefManager.onRowOut(this)' onclick='DataRefManager.close(this)' style='cursor:hand'>
         <jh:loop source='&define' alias='field'>
            <TD><jh:source source='&unit.{&field.data_name}'/></TD>
         </jh:loop>
      </TR>
      </jh:loop>
   </jh:hasChild>
