...
function doExecute(){
	...
	fmMain.action = '<jh:context/>/system/template/Template.wa?do=sourceSave';
	fmMain.submit();
}
function _onloadAll(){
	MoJS.connect();
...
<!-- Form begin ---------------------------------------------->
<TEXTAREA name='source' wrap='off' style='border:1 solid #008800; width:100%;height:100%;'><jh:write source='&page.source' format='text'/></TEXTAREA>
<!-- Form end ------------------------------------------------>
</TD></TR>
</TABLE>
</jh:form>
