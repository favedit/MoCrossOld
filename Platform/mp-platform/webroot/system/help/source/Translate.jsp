...
<jc:toolbar name='top.frames.frmToolbar.oToolbar' inFrame='frmWork' inForm='frmConsole' target='frmWork' action='refresh'>
   <jc:tbButton caption='trs:sys|button.update|Update' pageAction='/sys/src/web/TranslateSave.wa' icon='sys.update'/>
</jc:toolbar>
...
<TR><TD>
   <TABLE width='100%' bgcolor='#94B6FF' border='0' cellspacing='1' cellpadding='0'>
      <jh:loop item='&trans_ds' alias='item'>
         <TR bgcolor='#FFFFF4'>
            <TD width='120px'><jh:item item='&item.name'/></TD>
            <TD><jh:edit item='&item.value' size='80' maxlength='200' style='border:0'/></TD>
         </TR>
      </jh:loop>
   </TABLE>
</TD></TR>
