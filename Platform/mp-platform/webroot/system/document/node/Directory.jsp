...
<TR>
   <TD nowrap width='60px'><jh:text value='trs:this|type|Type'/></TD>
   <TD>*</TD>
   <TD nowrap><jh:combo item='&control.type' source='sys|control.type'/></TD>
</TR>
<TR>
   <TD nowrap><jh:text value='trs:this|name|Name'/></TD>
   <TD width='10px'>*</TD>
   <TD nowrap><jh:edit item='&control.name' size='40' maxlength='40'/></TD>
</TR>
<TR>
   <TD nowrap><jh:text value='trs:this|label|Label'/></TD>
   <TD width='10px'>*</TD>
