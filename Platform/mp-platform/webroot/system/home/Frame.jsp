	...
	<TD align='right' valign='bottom'>
		...
		<TD width='1' align='right' valign='bottom' style='filter:progid:DXImageTransform.Microsoft.Gradient(startColorStr=#9b9ab4, endColorStr=#FFFFFF, gradientType=1);'>
			...
			<TR>
				...
				<TD id='_id_page'><js:icon source='tools.logic'/> 平台</TD>
...
<TR>
	...
	<TD>
		...
		<TR id='_id_tools' style='display:none'>
			<TD id='_id_button' onmousedown='btn_onmdownk(this, "/database/connector/Connector.wa?do=catalog")'>链接器</TD>
			<TD id='_id_button' onmousedown='btn_onmdownk(this, "/database/synchronizer/Synchronizer.wa?do=catalog")'>同步器</TD>
			<TD id='_id_button' onmousedown='btn_onmdownk(this, "/database/statistics/Statistics.wa?do=catalog")'>统计器</TD>
			<TD>&nbsp;</TD>
...
<TR>
	<TD id='id_left' width='400'>
		<IFRAME name='frmCatalog' width='100%' height='100%' frameborder='0' src='<jh:context path='/system/home/Catalog.wp'/>' style='background-color:#FFFFFF'></IFRAME>
	</TD>
	<TD width='3' id='id_split' bgcolor='#9e9eba'></TD>
	<TD>
		<IFRAME name='frmMain' width='100%' height='100%' frameborder='0' src='<jh:context path='/system/home/Body.wa'/>' style='background-color:#FFFFFF'></IFRAME>
	</TD>
</TR>
</TABLE>
<!-- 分页部分 - end -->
