...
<jc:toolbar name='top.frames.frmToolbar.oToolbar' inFrame='frmWork' inForm='frmConsole' target='frmWork' action='refresh'>
   <jc:tbButton caption='trs:this|button.save|Save' pageAction='/system/property/FieldInsertSave.wa' icon='sys.save'/>
</jc:toolbar>
...
<TR><TD>
   ...
   <TR>
      <TD>Name:</TD>
      <TD><jh:edit item='&field.name' size='40'/></TD>
   </TR>
   <TR>
      <TD>Label:</TD>
      <TD><jh:edit item='&field.label' size='60'/></TD>
   </TR>
   <TR>
      <TD>Note:</TD>
      <TD><jh:memo item='&field.note' cols='60' rows='4'/></TD>
   </TR>
</TD></TR>
</TABLE>
