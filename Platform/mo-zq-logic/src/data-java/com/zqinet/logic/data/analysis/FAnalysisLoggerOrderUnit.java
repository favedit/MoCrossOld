...
// <T>日志分析订单逻辑单元。</T>
//============================================================
public class FAnalysisLoggerOrderUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段用户代码的定义。
   private String __accountPassport;

   // 字段用户代码的定义。
   protected String _accountPassport;
   ...
   // <T>构造日志分析订单逻辑单元。</T>
   //============================================================
   public FAnalysisLoggerOrderUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isAccountPassportChanged(){
      return !RString.equals(__accountPassport, _accountPassport);
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setAccountPassport(String value){
      _accountPassport = value;
   }
   ...
   public void load(FRow row){
      ...
      _gameId = __gameId;
      __accountPassport = row.get("account_passport");
      _accountPassport = __accountPassport;
