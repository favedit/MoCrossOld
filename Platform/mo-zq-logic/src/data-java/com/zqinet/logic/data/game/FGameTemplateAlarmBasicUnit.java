...
// <T>金钱预警逻辑单元。</T>
//============================================================
public class FGameTemplateAlarmBasicUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段单人存量的定义。
   private int __singleBalance;

   // 字段单人存量的定义。
   protected int _singleBalance;
   ...
   // <T>构造金钱预警逻辑单元。</T>
   //============================================================
   public FGameTemplateAlarmBasicUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isSingleBalanceChanged(){
      return __singleBalance != _singleBalance;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setSingleBalance(int value){
      _singleBalance = value;
   }

   //============================================================
   // <T>判断每10分钟增加次数的数据是否改变。</T>
   //
   // @return 数据内容
   //============================================================
   ...
   public void load(FRow row){
      ...
      _label = __label;
      __singleBalance = row.getInteger("single_balance");
      _singleBalance = __singleBalance;
