...
// <T>角色包裹信息逻辑。</T>
//============================================================
public class FGameRoleBagLogic extends FLogicDataset
{
   // 的定义。
   public final static FLogicTable Table = new FLogicTable("GM_ROLE_BAG");
   ...
   // 字段包裹模板编号的定义。
   public final static FLogicField FieldBagTid = new FLogicField("BAG_TID");

   // 字段插槽个数的定义。
   public final static FLogicField FieldSlotCount = new FLogicField("SLOT_COUNT");

   // 字段包裹类型的定义。
   public final static FLogicField FieldBagTypeCd = new FLogicField("BAG_TYPE_CD");
   ...
   // @param connection 链接
   //============================================================
   public FGameRoleBagLogic(ISqlConnection connection){
   ...
   // @return 数据单元
   //============================================================
   public FGameRoleBagUnit find(long recordId){
      // 检查记录编号
      if(0 == recordId){
         return null;
      }
      ...
      // 获得数据
      FGameRoleBagUnit unit = new FGameRoleBagUnit();
      unit.load(row);
      return unit;
   }
   ...
   // @return 数据单元
   //============================================================
   public FGameRoleBagUnit serach(String whereSql){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      sql.append(" WHERE ");
   ...
   // @return 数据单元集合
   //============================================================
   public FGameRoleBagUnit[] fetch(String whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FGameRoleBagUnit[] fetch(String whereSql, String orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FGameRoleBagUnit[] fetch(String whereSql, String orderSql, int limitCount){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      ...
      // 获得数据
      FGameRoleBagUnit[] units = new FGameRoleBagUnit[count];
   ...
   // @return 数据单元集合
   //============================================================
   public FGameRoleBagUnit[] fetchAll(){
      return fetch(null);
   }
   ...
   // @return 处理结果
   //============================================================
   public boolean doInsert(FGameRoleBagUnit unit){
      // 生成命令
      ...
      sql.append(",`ROLE_ID`");
      sql.append(",`BAG_TID`");
      sql.append(",`SLOT_COUNT`");
      sql.append(",`BAG_TYPE_CD`");
      ...
      sql.append(',');
      sql.append(unit.bagTid());
      sql.append(',');
      sql.append(unit.slotCount());
      sql.append(',');
      sql.append(unit.bagTypeCd());
   ...
   // @return 处理结果
   //============================================================
   public boolean doUpdate(FGameRoleBagUnit unit, long recordId){
      // 检查记录编号
      if(0 == recordId){
      ...
      if(unit.isBagTidChanged()){
         sql.append(",`BAG_TID`=");
         sql.append(unit.bagTid());
      }
      if(unit.isSlotCountChanged()){
         sql.append(",`SLOT_COUNT`=");
         sql.append(unit.slotCount());
      }
      if(unit.isBagTypeCdChanged()){
         sql.append(",`BAG_TYPE_CD`=");
         sql.append(unit.bagTypeCd());
      }
