...
// <T>角色名逻辑单元。</T>
//============================================================
public class FGameRoleNameUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段使用的定义。
   private int __userTypeCd;

   // 字段使用的定义。
   protected int _userTypeCd;
   ...
   public boolean isFullNameChanged(){
      return !RString.equals(__fullName, _fullName);
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isUserTypeCdChanged(){
      return __userTypeCd != _userTypeCd;
   }
   ...
   public void load(FRow row){
      ...
      __fullName = row.get("full_name");
      _fullName = __fullName;
      __userTypeCd = row.getInteger("user_type_cd");
      _userTypeCd = __userTypeCd;
