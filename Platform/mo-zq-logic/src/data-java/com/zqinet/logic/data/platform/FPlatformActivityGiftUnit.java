...
// <T>活动礼包逻辑单元。</T>
//============================================================
public class FPlatformActivityGiftUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段使用者角色ID的定义。
   private long __useRoleid;

   // 字段使用者角色ID的定义。
   protected long _useRoleid;

   // 存储字段使用时间的定义。
   private TDateTime __useTime = new TDateTime();

   // 字段使用时间的定义。
   protected TDateTime _useTime = new TDateTime();
   ...
   // <T>构造活动礼包逻辑单元。</T>
   //============================================================
   public FPlatformActivityGiftUnit(){
   }
   ...
   //============================================================
   // <T>判断使用者角色ID的数据是否改变。</T>
   //
   // @return 数据内容
   //============================================================
   public boolean isUseRoleidChanged(){
      return __useRoleid != _useRoleid;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setUseRoleid(long value){
      _useRoleid = value;
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isUseTimeChanged(){
      return !__useTime.equals(_useTime);
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setUseTime(TDateTime value){
      _useTime = value;
   }
   ...
   public void load(FRow row){
      ...
      __code = row.get("code");
      _code = __code;
      __used = row.getInteger("used");
      _used = __used;
      __useRoleid = RLong.parse(row.get("use_roleid"));
      _useRoleid = __useRoleid;
      __useTime.parse(row.get("use_time"));
      _useTime.assign(__useTime);
