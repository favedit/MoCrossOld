...
// <T>角色神剑信息逻辑。</T>
//============================================================
public class FGameRoleMagicswordLogic extends FLogicDataset
{
   // 的定义。
   public final static FLogicTable Table = new FLogicTable("GM_ROLE_MAGICSWORD");
   ...
   // 字段模板编号的定义。
   public final static FLogicField FieldMagicswordTid = new FLogicField("MAGICSWORD_TID");

   // 字段品级的定义。
   public final static FLogicField FieldGradeLevel = new FLogicField("GRADE_LEVEL");

   // 字段内容打包的定义。
   public final static FLogicField FieldContentPack = new FLogicField("CONTENT_PACK");

   // 字段是否升级中的定义。
   public final static FLogicField FieldIsUpgrade = new FLogicField("IS_UPGRADE");
   ...
   // <T>构造角色神剑信息逻辑单元。</T>
   //============================================================
   public FGameRoleMagicswordLogic(){
   }
   ...
   // @param connection 链接
   //============================================================
   public FGameRoleMagicswordLogic(ISqlConnection connection){
   ...
   // @return 数据单元
   //============================================================
   public FGameRoleMagicswordUnit find(long recordId){
      // 检查记录编号
      if(0 == recordId){
         return null;
      }
      ...
      // 获得数据
      FGameRoleMagicswordUnit unit = new FGameRoleMagicswordUnit();
      unit.load(row);
      return unit;
   }
   ...
   // @return 数据单元
   //============================================================
   public FGameRoleMagicswordUnit serach(String whereSql){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      sql.append(" WHERE ");
   ...
   // @return 数据单元集合
   //============================================================
   public FGameRoleMagicswordUnit[] fetch(String whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FGameRoleMagicswordUnit[] fetch(String whereSql, String orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FGameRoleMagicswordUnit[] fetch(String whereSql, String orderSql, int limitCount){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      ...
      // 获得数据
      FGameRoleMagicswordUnit[] units = new FGameRoleMagicswordUnit[count];
   ...
   // @return 数据单元集合
   //============================================================
   public FGameRoleMagicswordUnit[] fetchAll(){
      return fetch(null);
   }
   ...
   // @return 处理结果
   //============================================================
   public boolean doInsert(FGameRoleMagicswordUnit unit){
      // 生成命令
      ...
      sql.append(",`ROLE_ID`");
      sql.append(",`MAGICSWORD_TID`");
      sql.append(",`GRADE_LEVEL`");
      sql.append(",`CONTENT_PACK`");
      sql.append(",`IS_UPGRADE`");
      ...
      sql.append(',');
      sql.append(unit.magicswordTid());
      sql.append(',');
      sql.append(unit.gradeLevel());
      sql.append(',');
   ...
   // @return 处理结果
   //============================================================
   public boolean doUpdate(FGameRoleMagicswordUnit unit, long recordId){
      // 检查记录编号
      if(0 == recordId){
      ...
      if(unit.isMagicswordTidChanged()){
         sql.append(",`MAGICSWORD_TID`=");
         sql.append(unit.magicswordTid());
      }
      if(unit.isGradeLevelChanged()){
         sql.append(",`GRADE_LEVEL`=");
         sql.append(unit.gradeLevel());
      }
