...
// <T>角色物品信息逻辑单元。</T>
//============================================================
public class FGameRoleBookUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段心法模板编号的定义。
   private int __bookTid;

   // 字段心法模板编号的定义。
   protected int _bookTid;
   ...
   // @return 数据内容
   //============================================================
   public boolean isBookTidChanged(){
      return __bookTid != _bookTid;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setBookTid(int value){
      _bookTid = value;
   }
   ...
   public void load(FRow row){
      ...
      _roleId = __roleId;
      __bookTid = row.getInteger("book_tid");
      _bookTid = __bookTid;
