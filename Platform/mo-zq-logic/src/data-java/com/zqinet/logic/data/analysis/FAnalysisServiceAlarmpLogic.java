...
// <T>日志分析道具预警逻辑。</T>
//============================================================
public class FAnalysisServiceAlarmpLogic extends FLogicDataset
{
   // 的定义。
   public final static FLogicTable Table = new FLogicTable("AS_SVC_ALARMP");
   ...
   // 字段获得数量的定义。
   public final static FLogicField FieldSumCount = new FLogicField("SUM_COUNT");

   // 字段获得次数的定义。
   public final static FLogicField FieldSumNumber = new FLogicField("SUM_NUMBER");
   ...
   // <T>构造日志分析道具预警逻辑单元。</T>
   //============================================================
   public FAnalysisServiceAlarmpLogic(){
   }
   ...
   // @param connection 链接
   //============================================================
   public FAnalysisServiceAlarmpLogic(ISqlConnection connection){
   ...
   // @return 数据单元
   //============================================================
   public FAnalysisServiceAlarmpUnit find(long recordId){
      // 检查记录编号
      if(0 == recordId){
         return null;
      }
      ...
      // 获得数据
      FAnalysisServiceAlarmpUnit unit = new FAnalysisServiceAlarmpUnit();
      unit.load(row);
      return unit;
   }
   ...
   // @return 数据单元
   //============================================================
   public FAnalysisServiceAlarmpUnit serach(String whereSql){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      sql.append(" WHERE ");
   ...
   // @return 数据单元集合
   //============================================================
   public FAnalysisServiceAlarmpUnit[] fetch(String whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FAnalysisServiceAlarmpUnit[] fetch(String whereSql, String orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FAnalysisServiceAlarmpUnit[] fetch(String whereSql, String orderSql, int limitCount){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      ...
      // 获得数据
      FAnalysisServiceAlarmpUnit[] units = new FAnalysisServiceAlarmpUnit[count];
   ...
   // @return 数据单元集合
   //============================================================
   public FAnalysisServiceAlarmpUnit[] fetchAll(){
      return fetch(null);
   }
   ...
   // @return 处理结果
   //============================================================
   public boolean doInsert(FAnalysisServiceAlarmpUnit unit){
      // 生成命令
      ...
      sql.append(",`SUM_COUNT`");
      sql.append(",`SUM_NUMBER`");
      ...
      sql.append(',');
      sql.append(unit.sumCount());
      sql.append(',');
      sql.append(unit.sumNumber());
   ...
   // @return 处理结果
   //============================================================
   public boolean doUpdate(FAnalysisServiceAlarmpUnit unit, long recordId){
      // 检查记录编号
      if(0 == recordId){
      ...
      if(unit.isSumCountChanged()){
         sql.append(",`SUM_COUNT`=");
         sql.append(unit.sumCount());
      }
      if(unit.isSumNumberChanged()){
         sql.append(",`SUM_NUMBER`=");
         sql.append(unit.sumNumber());
      }
