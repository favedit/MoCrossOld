...
// <T>角色奇经八脉信息逻辑单元。</T>
//============================================================
public class FGameRolePracticeUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   public boolean isCurrentLevelChanged(){
      return __currentLevel != _currentLevel;
   }
   ...
   public void load(FRow row){
      ...
      __currentLevel = row.getInteger("current_level");
      _currentLevel = __currentLevel;
