...
// <T>服务器状态逻辑单元。</T>
//============================================================
public class FPlatformServerStatusUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段标识的定义。
   private String __statusKey;

   // 字段标识的定义。
   protected String _statusKey;

   // 存储字段参数的定义。
   private String __param;
   ...
   // <T>构造服务器状态逻辑单元。</T>
   //============================================================
   public FPlatformServerStatusUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isStatusKeyChanged(){
      return !RString.equals(__statusKey, _statusKey);
   }
   ...
   public boolean isParamChanged(){
      return !RString.equals(__param, _param);
   }
   ...
   public boolean isValueChanged(){
      return !RString.equals(__value, _value);
   }
   ...
   public void load(FRow row){
      ...
      __statusKey = row.get("status_key");
      _statusKey = __statusKey;
      __param = row.get("param");
      _param = __param;
      __value = row.get("value");
      _value = __value;
