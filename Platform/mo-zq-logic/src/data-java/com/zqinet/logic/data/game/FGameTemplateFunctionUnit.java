...
// <T>功能消费逻辑单元。</T>
//============================================================
public class FGameTemplateFunctionUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段功能枚举的定义。
   private int __functionTid;

   // 字段功能枚举的定义。
   protected int _functionTid;
   ...
   // <T>构造功能消费逻辑单元。</T>
   //============================================================
   public FGameTemplateFunctionUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isFunctionTidChanged(){
      return __functionTid != _functionTid;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setFunctionTid(int value){
      _functionTid = value;
   }
   ...
   public void load(FRow row){
      ...
      __functionTid = row.getInteger("function_tid");
      _functionTid = __functionTid;
