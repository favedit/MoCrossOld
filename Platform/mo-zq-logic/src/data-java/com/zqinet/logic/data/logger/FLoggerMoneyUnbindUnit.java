...
// <T>元宝变更日志逻辑单元。</T>
//============================================================
public class FLoggerMoneyUnbindUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段改变后的金钱的定义。
   private int __curMoney;

   // 字段改变后的金钱的定义。
   protected int _curMoney;

   // 存储字段改变的货币的定义。
   private int __deltaMoney;

   // 字段改变的货币的定义。
   protected int _deltaMoney;
   ...
   // @return 数据内容
   //============================================================
   public boolean isCurMoneyChanged(){
      return __curMoney != _curMoney;
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isDeltaMoneyChanged(){
      return __deltaMoney != _deltaMoney;
   }
   ...
   public void load(FRow row){
      ...
      __curMoney = row.getInteger("cur_money");
      _curMoney = __curMoney;
      __deltaMoney = row.getInteger("delta_money");
      _deltaMoney = __deltaMoney;
