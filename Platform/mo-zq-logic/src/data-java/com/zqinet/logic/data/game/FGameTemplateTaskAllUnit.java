...
// <T>所有任务逻辑单元。</T>
//============================================================
public class FGameTemplateTaskAllUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段任务类型的定义。
   private int __catalogCd;

   // 字段任务类型的定义。
   protected int _catalogCd;
   ...
   // <T>构造所有任务逻辑单元。</T>
   //============================================================
   public FGameTemplateTaskAllUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isCatalogCdChanged(){
      return __catalogCd != _catalogCd;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setCatalogCd(int value){
      _catalogCd = value;
   }
   ...
   public void load(FRow row){
      ...
      _label = __label;
      __catalogCd = row.getInteger("catalog_cd");
      _catalogCd = __catalogCd;
