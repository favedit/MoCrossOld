...
// <T>角色关系变化逻辑。</T>
//============================================================
public class FLoggerRelationLogic extends FLogicDataset
{
   // 的定义。
   public final static FLogicTable Table = new FLogicTable("LOG_RELATION");
   ...
   // 字段变更类型的定义。
   public final static FLogicField FieldChangeCd = new FLogicField("CHANGE_CD");

   // 字段亲密度变化事件的定义。
   public final static FLogicField FieldChangeEvent = new FLogicField("CHANGE_EVENT");
   ...
   // @param connection 链接
   //============================================================
   public FLoggerRelationLogic(ISqlConnection connection){
   ...
   // @return 数据单元
   //============================================================
   public FLoggerRelationUnit find(long recordId){
      // 检查记录编号
      if(0 == recordId){
         return null;
      }
      ...
      // 获得数据
      FLoggerRelationUnit unit = new FLoggerRelationUnit();
      unit.load(row);
      return unit;
   }
   ...
   // @return 数据单元
   //============================================================
   public FLoggerRelationUnit serach(String whereSql){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      sql.append(" WHERE ");
   ...
   // @return 数据单元集合
   //============================================================
   public FLoggerRelationUnit[] fetch(String whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLoggerRelationUnit[] fetch(String whereSql, String orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLoggerRelationUnit[] fetch(String whereSql, String orderSql, int limitCount){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      ...
      // 获得数据
      FLoggerRelationUnit[] units = new FLoggerRelationUnit[count];
   ...
   // @return 数据单元集合
   //============================================================
   public FLoggerRelationUnit[] fetchAll(){
      return fetch(null);
   }
   ...
   // @return 处理结果
   //============================================================
   public boolean doInsert(FLoggerRelationUnit unit){
      // 生成命令
      ...
      sql.append(",`CHANGE_CD`");
      sql.append(",`CHANGE_EVENT`");
      sql.append(",`VALUE`");
      ...
      sql.append(',');
      sql.append(unit.changeCd());
      sql.append(',');
      sql.append(unit.changeEvent());
      sql.append(',');
   ...
   // @return 处理结果
   //============================================================
   public boolean doUpdate(FLoggerRelationUnit unit, long recordId){
      // 检查记录编号
      if(0 == recordId){
      ...
      if(unit.isChangeCdChanged()){
         sql.append(",`CHANGE_CD`=");
         sql.append(unit.changeCd());
      }
      if(unit.isChangeEventChanged()){
         sql.append(",`CHANGE_EVENT`=");
         sql.append(unit.changeEvent());
      }
