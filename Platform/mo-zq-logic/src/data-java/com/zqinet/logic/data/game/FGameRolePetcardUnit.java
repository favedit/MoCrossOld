...
// <T>角色宠物卡牌信息逻辑单元。</T>
//============================================================
public class FGameRolePetcardUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段模板编号的定义。
   private int __petCardTid;

   // 字段模板编号的定义。
   protected int _petCardTid;
   ...
   // @return 数据内容
   //============================================================
   public boolean isPetCardTidChanged(){
      return __petCardTid != _petCardTid;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setPetCardTid(int value){
      _petCardTid = value;
   }
   ...
   public void load(FRow row){
      ...
      _roleId = __roleId;
      __petCardTid = row.getInteger("pet_card_tid");
      _petCardTid = __petCardTid;
