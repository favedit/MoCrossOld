...
// <T>角色坐骑变更日志逻辑单元。</T>
//============================================================
public class FLoggerRoleRideUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段坐骑编号的定义。
   private long __rideId;

   // 字段坐骑编号的定义。
   protected long _rideId;

   // 存储字段坐骑星级的定义。
   private int __rideStarLevel;

   // 字段坐骑星级的定义。
   protected int _rideStarLevel;
   ...
   // 存储字段道具3编号的定义。
   private int __prop3Tid;

   // 字段道具3编号的定义。
   protected int _prop3Tid;

   // 存储字段道具3数量的定义。
   private int __count3;

   // 字段道具3数量的定义。
   protected int _count3;
   ...
   // @return 数据内容
   //============================================================
   public boolean isRideIdChanged(){
      return __rideId != _rideId;
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isRideStarLevelChanged(){
      return __rideStarLevel != _rideStarLevel;
   }
   ...
   // @return 数据内容
   //============================================================
   public int rideStarLevel(){
      return _rideStarLevel;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setRideStarLevel(int value){
      _rideStarLevel = value;
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isProp3TidChanged(){
      return __prop3Tid != _prop3Tid;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setProp3Tid(int value){
      _prop3Tid = value;
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isCount3Changed(){
      return __count3 != _count3;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setCount3(int value){
      _count3 = value;
   }
   ...
   public void load(FRow row){
      ...
      __rideId = RLong.parse(row.get("ride_id"));
      _rideId = __rideId;
      __rideStarLevel = row.getInteger("ride_star_level");
      _rideStarLevel = __rideStarLevel;
      ...
      _count2 = __count2;
      __prop3Tid = row.getInteger("prop3_tid");
      _prop3Tid = __prop3Tid;
      __count3 = row.getInteger("count3");
      _count3 = __count3;
