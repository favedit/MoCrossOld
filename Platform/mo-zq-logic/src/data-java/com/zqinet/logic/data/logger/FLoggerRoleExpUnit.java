...
// <T>玩家经验改变日志表逻辑单元。</T>
//============================================================
public class FLoggerRoleExpUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段当前经验(改变后的)的定义。
   private int __curExp;

   // 字段当前经验(改变后的)的定义。
   protected int _curExp;

   // 存储字段改变的经验数量的定义。
   private int __deltaExp;

   // 字段改变的经验数量的定义。
   protected int _deltaExp;
   ...
   // @return 数据内容
   //============================================================
   public boolean isExpTypeChanged(){
      return __expType != _expType;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setExpType(int value){
      _expType = value;
   }

   //============================================================
   // <T>判断获取经验的类型的数据是否改变。</T>
   //
   // @return 数据内容
   //============================================================
   ...
   //============================================================
   // <T>判断当前经验(改变后的)的数据是否改变。</T>
   //
   // @return 数据内容
   //============================================================
   public boolean isCurExpChanged(){
      return __curExp != _curExp;
   }

   //============================================================
   // <T>获得当前经验(改变后的)的数据内容。</T>
   //
   // @return 数据内容
   //============================================================
   public int curExp(){
   ...
   //============================================================
   // <T>判断改变的经验数量的数据是否改变。</T>
   //
   // @return 数据内容
   //============================================================
   public boolean isDeltaExpChanged(){
      return __deltaExp != _deltaExp;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setDeltaExp(int value){
      _deltaExp = value;
   }
   ...
   public void load(FRow row){
      ...
      __expType = row.getInteger("exp_type");
      _expType = __expType;
      __opType = row.getInteger("op_type");
      _opType = __opType;
      __curExp = row.getInteger("cur_exp");
      _curExp = __curExp;
      __deltaExp = row.getInteger("delta_exp");
      _deltaExp = __deltaExp;
