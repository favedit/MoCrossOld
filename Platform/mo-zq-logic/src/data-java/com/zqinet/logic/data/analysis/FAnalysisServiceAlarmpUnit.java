...
// <T>日志分析道具预警逻辑单元。</T>
//============================================================
public class FAnalysisServiceAlarmpUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段获得数量的定义。
   private int __sumCount;

   // 字段获得数量的定义。
   protected int _sumCount;

   // 存储字段获得次数的定义。
   private int __sumNumber;

   // 字段获得次数的定义。
   protected int _sumNumber;
   ...
   // <T>构造日志分析道具预警逻辑单元。</T>
   //============================================================
   public FAnalysisServiceAlarmpUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isSumCountChanged(){
      return __sumCount != _sumCount;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setSumCount(int value){
      _sumCount = value;
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isSumNumberChanged(){
      return __sumNumber != _sumNumber;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setSumNumber(int value){
      _sumNumber = value;
   }
   ...
   public void load(FRow row){
      ...
      __sumCount = row.getInteger("sum_count");
      _sumCount = __sumCount;
      __sumNumber = row.getInteger("sum_number");
      _sumNumber = __sumNumber;
