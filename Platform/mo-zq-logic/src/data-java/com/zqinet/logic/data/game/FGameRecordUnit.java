...
// <T>游戏记录逻辑单元。</T>
//============================================================
public class FGameRecordUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段记录类型的定义。
   private int __recordCd;

   // 字段记录类型的定义。
   protected int _recordCd;
   ...
   // @return 数据内容
   //============================================================
   public boolean isRecordCdChanged(){
      return __recordCd != _recordCd;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setRecordCd(int value){
      _recordCd = value;
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isCurrentIdChanged(){
      return __currentId != _currentId;
   }
   ...
   public void load(FRow row){
      ...
      __recordCd = row.getInteger("record_cd");
      _recordCd = __recordCd;
      __recordInterval = row.getInteger("record_interval");
      _recordInterval = __recordInterval;
      __currentId = RLong.parse(row.get("current_id"));
      _currentId = __currentId;
