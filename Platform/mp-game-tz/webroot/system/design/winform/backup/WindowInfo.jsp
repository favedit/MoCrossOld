...
<jc:toolbar name='top.frames.frmToolbar.oToolbar' inFrame='frmWork' inForm='frmConsole' target='frmWork' action='refresh'>
   <jc:tbButton caption='trs:sys|button.node.insert|Node Insert' pageAction='/sys/ctl/win/InsertWindow.wa' icon='sys.tvni'/>
   <jc:tbButton caption='trs:sys|button.node.delete|Node Delete' pageAction='/sys/ctl/win/DeleteWindow.wa' icon='sys.tvnd'/>
</jc:toolbar>
