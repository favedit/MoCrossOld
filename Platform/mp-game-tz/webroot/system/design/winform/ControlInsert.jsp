...
<jc:toolbar name='top.frames.frmToolbar.oToolbar' inFrame='frmWork' inForm='frmConsole' target='frmWork' action='refresh'>
   <jc:tbButton caption='trs:this|button.save|Save' pageAction='/system/window/ControlInsertSave.wa' icon='sys.save'/>
</jc:toolbar>
...
<TR><TD>
   ...
   <TR>
      <TD>Name:</TD>
      <TD><jh:edit item='&control.name' size='40'/></TD>
   </TR>
   <TR>
      <TD>Label:</TD>
      <TD><jh:edit item='&control.label' size='60'/></TD>
   </TR>
   <TR>
      <TD>Note:</TD>
      <TD><jh:memo item='&control.note' cols='60' rows='4'/></TD>
   </TR>
</TD></TR>
</TABLE>
