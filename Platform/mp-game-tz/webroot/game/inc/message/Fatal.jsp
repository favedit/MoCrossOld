...
<TR><TD>
   <TABLE width='100%' border='0' cellspacing='1' cellpadding='4'>
      <TR><TD align='center' valign='middle'>
         <jh:img src='/res/img/sys/msg/lerror.gif' align='absmiddle'/><jh:img src='/res/img/n.gif' width='8'/><jh:text value='trs:sys|message.fatal.title|Fatal'/>
         <BR><BR>
         <FONT color='red'><B><jh:text value='trs:sys|message.fatal.info|Information'/></B></FONT>
      </TD></TR>
   </TABLE>
</TD></TR>
...
<TR bgcolor='#FFFFFF'><TD>
   ...
   <TR>
      ...
      <TD nowrap onclick='displayDetails()' style='cursor:hand'>
         <FONT color='red' id='id_details_head' style='display:block'><jh:write item='txt|sys|message.fatal.details'/></FONT>
