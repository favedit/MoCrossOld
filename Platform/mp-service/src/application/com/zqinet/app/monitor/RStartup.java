package com.zqinet.app.monitor;

import com.zq.logic.monitor.console.IServerMonitorConsole;
...
public class RStartup
{
   ...
   public static void main(String[] args){
      try{
         ...
         // 获得服务监视控制台
         IServerMonitorConsole console = RAop.find(IServerMonitorConsole.class);
         // 启动处理
         console.startup();
         // 释放资源
         RAop.release();
