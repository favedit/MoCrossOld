package com.zqinet.app.monitor.process;

import com.zq.platform.monitor.process.IProcessMonitorConsole;
...
public class RStartup
{
   ...
   public static void main(String[] args){
      try{
         ...
         // 获得服务监视控制台
         IProcessMonitorConsole console = RAop.find(IProcessMonitorConsole.class);
         // 启动处理
         console.startup();
         // 释放资源
         RAop.release();
