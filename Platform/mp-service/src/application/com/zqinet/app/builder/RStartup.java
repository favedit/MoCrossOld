package com.zqinet.app.builder;

import com.zq.platform.builder.IDevelopBuilderConsole;
...
public class RStartup
{
   ...
   public static void main(String[] args){
      try{
         ...
         String configOption = RApplication.findArgement("-config", "application-service-local.xml");
         // 设置日志
         ...
         // 获得同步器控制台
         IDevelopBuilderConsole console = RAop.find(IDevelopBuilderConsole.class);
         // 启动处理
         console.startup();
         // 释放资源
         RAop.release();
