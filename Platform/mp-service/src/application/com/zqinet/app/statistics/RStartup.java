package com.zqinet.app.statistics;
...
public class RStartup
{
   ...
   public static void main(String[] args){
      try{
         ...
         String configOption = RApplication.findArgement("-config", "application-statistics-local.xml");
         // 设置日志
         ...
         // 获得同步器控制台
         IStatisticsConsole console = RAop.find(IStatisticsConsole.class);

         System.out.println(console.processMode());
         // 加载设置
         console.load();
         // 启动处理
         console.startup();
