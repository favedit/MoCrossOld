...
import org.mo.data.dataset.common.XFieldPropertyFace;

//============================================================
// <T>时间段字段(属性)对象的XML节点基类。</T>
//============================================================
public abstract class XBaseFieldTimeSpanProperty
      extends FXmlObject
      implements
         XFieldPropertyFace
{
   // 名称定义
   public static final String NAME = "FieldTimeSpanProperty";
