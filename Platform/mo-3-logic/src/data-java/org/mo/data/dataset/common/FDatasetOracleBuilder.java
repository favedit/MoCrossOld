...
public class FDatasetOracleBuilder
      extends FDatasetBuilder
{
   ...
   public FDatasetOracleBuilder(IDatasetConsole console,
                                IXmlObject xdataset){
      //      _console = console;
      //      _sql.clear();
      //      _xdataset = xdataset;
   ...
   //         type = "VARCHAR2(" + xfield.getDataSize() + ")";
   ...
   public FString parse(){
      //      _sql.appendLine("CREATE TABLE ", _xdataset.getDataName(), "_DS (");
      //      for(int n = 0; n < _xfields.count(); n++){
      //         XDatasetField xfield = (XDatasetField) _xfields.get(n);
      ...
      //         _sql.appendLine(",");
      //      }
      //      _sql.append("   CONSTRAINT COM_ISO_COUNTRY_GROUP_PK PRIMARY KEY ( OUID )");
      //      makeUniqueKey();
      //      makeForeignKey();
      //      _sql.appendLine();
      //      _sql.appendLine(")");
