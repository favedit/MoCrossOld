...
// <T>主域同步历史逻辑。</T>
//============================================================
public class FDomainSynchronizerHistoryLogic extends FLogicDataset
{
   // 的定义。
   public final static FLogicTable Table = new FLogicTable("DM_SYNCHRONIZER_HISTORY");
   ...
   // 字段同步编号的定义。
   public final static FLogicField FieldSynchronizerId = new FLogicField("SYNCHRONIZER_ID");

   // 字段单元编号的定义。
   public final static FLogicField FieldUnitId = new FLogicField("UNIT_ID");

   // 字段记录日期的定义。
   public final static FLogicField FieldRecordDate = new FLogicField("RECORD_DATE");

   // 字段同步记录个数的定义。
   public final static FLogicField FieldRecordCount = new FLogicField("RECORD_COUNT");
   ...
   // <T>构造主域同步历史逻辑单元。</T>
   //============================================================
   public FDomainSynchronizerHistoryLogic(){
   }
   ...
   // @param connection 链接
   //============================================================
   public FDomainSynchronizerHistoryLogic(ISqlConnection connection){
   ...
   // @return 数据单元
   //============================================================
   public FDomainSynchronizerHistoryUnit find(long recordId){
      // 检查记录编号
      if(0 == recordId){
         return null;
      }
      ...
      // 获得数据
      FDomainSynchronizerHistoryUnit unit = new FDomainSynchronizerHistoryUnit();
      unit.load(row);
      return unit;
   }
   ...
   // @return 数据单元
   //============================================================
   public FDomainSynchronizerHistoryUnit serach(String whereSql){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      sql.append(" WHERE ");
   ...
   // @return 数据单元集合
   //============================================================
   public FDomainSynchronizerHistoryUnit[] fetch(String whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FDomainSynchronizerHistoryUnit[] fetch(String whereSql, String orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FDomainSynchronizerHistoryUnit[] fetch(String whereSql, String orderSql, int limitCount){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      ...
      // 获得数据
      FDomainSynchronizerHistoryUnit[] units = new FDomainSynchronizerHistoryUnit[count];
   ...
   // @return 数据单元集合
   //============================================================
   public FDomainSynchronizerHistoryUnit[] fetchAll(){
      return fetch(null);
   }
   ...
   // @return 处理结果
   //============================================================
   public boolean doInsert(FDomainSynchronizerHistoryUnit unit){
      // 生成命令
      ...
      sql.append(',');
      sql.append(unit.synchronizerId());
      sql.append(',');
      sql.append(unit.unitId());
      sql.append(',');
   ...
   // @return 处理结果
   //============================================================
   public boolean doUpdate(FDomainSynchronizerHistoryUnit unit, long recordId){
      // 检查记录编号
      if(0 == recordId){
      ...
      if(unit.isSynchronizerIdChanged()){
         sql.append(",`SYNCHRONIZER_ID`=");
         sql.append(unit.synchronizerId());
      }
      if(unit.isUnitIdChanged()){
         sql.append(",`UNIT_ID`=");
         sql.append(unit.unitId());
      }
