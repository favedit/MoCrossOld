...
// <T>数据库逻辑。</T>
//============================================================
public class FDomainDataDatabaseLogic extends FLogicDataset
{
   // 的定义。
   public final static FLogicTable Table = new FLogicTable("DM_DATA_DATABASE");
   ...
   // 字段主机地址的定义。
   public final static FLogicField FieldHost = new FLogicField("HOST");

   // 字段端口的定义。
   public final static FLogicField FieldPort = new FLogicField("PORT");
   ...
   // 字段数据名称的定义。
   public final static FLogicField FieldDatabaseName = new FLogicField("DATABASE_NAME");
   ...
   // <T>构造数据库逻辑单元。</T>
   //============================================================
   public FDomainDataDatabaseLogic(){
   }
   ...
   // @param connection 链接
   //============================================================
   public FDomainDataDatabaseLogic(ISqlConnection connection){
   ...
   // @return 数据单元
   //============================================================
   public FDomainDataDatabaseUnit find(long recordId){
      // 检查记录编号
      if(0 == recordId){
         return null;
      }
      ...
      // 获得数据
      FDomainDataDatabaseUnit unit = new FDomainDataDatabaseUnit();
      unit.load(row);
      return unit;
   }
   ...
   // @return 数据单元
   //============================================================
   public FDomainDataDatabaseUnit serach(String whereSql){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      sql.append(" WHERE ");
   ...
   // @return 数据单元集合
   //============================================================
   public FDomainDataDatabaseUnit[] fetch(String whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FDomainDataDatabaseUnit[] fetch(String whereSql, String orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FDomainDataDatabaseUnit[] fetch(String whereSql, String orderSql, int limitCount){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      ...
      // 获得数据
      FDomainDataDatabaseUnit[] units = new FDomainDataDatabaseUnit[count];
   ...
   // @return 数据单元集合
   //============================================================
   public FDomainDataDatabaseUnit[] fetchAll(){
      return fetch(null);
   }
   ...
   // @return 处理结果
   //============================================================
   public boolean doInsert(FDomainDataDatabaseUnit unit){
      // 生成命令
      ...
      sql.append(',');
      if(RString.isEmpty(unit.host())){
         sql.append("NULL");
      }else{
         sql.append('\'');
         sql.append(_connection.formatValue(unit.host()));
         sql.append('\'');
      }
      sql.append(',');
      sql.append(unit.port());
      sql.append(',');
      ...
      sql.append(',');
      if(RString.isEmpty(unit.databaseName())){
         sql.append("NULL");
      }else{
         sql.append('\'');
         sql.append(_connection.formatValue(unit.databaseName()));
         sql.append('\'');
      }
   ...
   // @return 处理结果
   //============================================================
   public boolean doUpdate(FDomainDataDatabaseUnit unit, long recordId){
      // 检查记录编号
      if(0 == recordId){
