...
// <T>主域同步历史逻辑单元。</T>
//============================================================
public class FDomainSynchronizerHistoryUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段同步编号的定义。
   private long __synchronizerId;

   // 字段同步编号的定义。
   protected long _synchronizerId;

   // 存储字段单元编号的定义。
   private long __unitId;
   ...
   // <T>构造主域同步历史逻辑单元。</T>
   //============================================================
   public FDomainSynchronizerHistoryUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isSynchronizerIdChanged(){
      return __synchronizerId != _synchronizerId;
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isUnitIdChanged(){
      return __unitId != _unitId;
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isRecordCountChanged(){
      return __recordCount != _recordCount;
   }
   ...
   public void load(FRow row){
      ...
      __synchronizerId = RLong.parse(row.get("synchronizer_id"));
      _synchronizerId = __synchronizerId;
      __unitId = RLong.parse(row.get("unit_id"));
      _unitId = __unitId;
      __recordDate.parse(row.get("record_date"));
      _recordDate.assign(__recordDate);
      __recordCount = row.getInteger("record_count");
      _recordCount = __recordCount;
