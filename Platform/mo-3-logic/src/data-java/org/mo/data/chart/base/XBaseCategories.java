...
// <T>分组集合对象的XML节点基类。</T>
//============================================================
public abstract class XBaseCategories
      extends FXmlObject
      implements
         XObjectFace
{
   ...
   // 字体的名称定义
   public static final String PTY_FONT = "font";

   // 字体大小的名称定义
   public static final String PTY_FONTSIZE = "fontSize";

   // 字体颜色的名称定义
   public static final String PTY_FONTCOLOR = "fontColor";
