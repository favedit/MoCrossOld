         ...
         XObjectFace
{
   ...
   // 系列名称的名称定义
   public static final String PTY_SERIESNAME = "seriesName";
   ...
   public String innerGet(String name){
      if(RString.isEmpty(name)){
         ...
         return getNote();
      }else if(PTY_SERIESNAME.equalsIgnoreCase(name)){
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("seriesname")){
            setSeriesname(config.get(PTY_SERIESNAME));
         }
         ...
         if(RString.isEmpty(getSeriesname())){
            if(config.contains("seriesname")){
               setSeriesname(config.get(PTY_SERIESNAME));
            }
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getSeriesname())){
            config.set(PTY_SERIESNAME, getSeriesname());
         }
         ...
         String sSeriesname = getSeriesname();
         if(RString.isNotEmpty(sSeriesname)){
            config.set(PTY_SERIESNAME, sSeriesname);
         }
