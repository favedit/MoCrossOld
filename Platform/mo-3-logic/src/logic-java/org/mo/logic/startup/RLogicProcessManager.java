 ...
 */
public class RLogicProcessManager
{
   // 日志输出接口
   private static ILogger _logger = RLogger.find(RLogicProcessManager.class);
   ...
   public static void main(String[] arg){
      try{
         ...
         //fileName = "D:/Workspace/eUIS/webroot/WEB-INF/classes/application-develop-process.xml";
         // 启动监听程序
