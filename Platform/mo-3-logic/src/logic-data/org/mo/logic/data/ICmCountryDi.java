...
/**
 * <T>数据库逻辑包(CM_COUNTRY_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ICmCountryDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找国家代码(<C>CODE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 国家代码
    */
   ...
   /**
    * <T>根据记录的编号查找所属洲(<C>CONTINENT_CD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 所属洲
    */
   FSqlFunction getContinentCd(Object objectId);

   /**
    * <T>根据记录的编号查找所属洲(<C>CONTINENT_CD</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 所属洲
    */
   FSqlFunction getContinentLabel(Object objectId);

   /**
    * <T>根据记录的编号查找时区(<C>TIME_ZONE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 时区
    */
   FSqlFunction getTimeZone(Object objectId);

   /**
    * <T>根据记录的编号查找国家人口(<C>POPULATION</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 国家人口
    */
    ...
    * @param params
    */
   FSqlProcedure testCommond(Object logic,
                             Object params);
