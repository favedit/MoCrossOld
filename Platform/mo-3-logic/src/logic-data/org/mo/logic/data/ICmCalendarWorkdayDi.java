...
/**
 * <T>数据库逻辑包(CM_CALENDAR_WORKDAY_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ICmCalendarWorkdayDi
      extends
         ILogicUnit
{
   /**
    ...
    * @return
    */
   FSqlFunction getWorktime(Object objectId);
   ...
   /**
    * <T>根据记录的编号查找工作日历(<C>CALENDAR_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 工作日历
    */
   FSqlFunction getCalendarId(Object objectId);

   /**
    * <T>根据记录的编号查找周工作日(<C>WEEKDAY_CD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 周工作日
    */
   FSqlFunction getWeekdayCd(Object objectId);

   /**
    * <T>根据记录的编号查找周工作日(<C>WEEKDAY_CD</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 周工作日
    */
   FSqlFunction getWeekdayLabel(Object objectId);

   /**
    * <T>根据记录的编号查找开始时间(<C>BEGIN_TIME</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 开始时间
    */
   FSqlFunction getBeginTime(Object objectId);

   /**
    * <T>根据记录的编号查找结束时间(<C>END_TIME</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 结束时间
    */
   FSqlFunction getEndTime(Object objectId);
