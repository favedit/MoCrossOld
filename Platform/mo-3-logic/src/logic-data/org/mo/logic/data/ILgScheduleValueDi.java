...
/**
 * <T>数据库逻辑包(LG_SCHEDULE_VALUE_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ILgScheduleValueDi
      extends
         ILogicUnit
{
   /**
    * <T>根据属性标识和计划标识检索value值</T>
    *
    * @param propertyId 属性标识
    * @param scheduleId 计划标识
    * @return 记录对象
    */
   FSqlFunction getDataValueByIds(Object propertyId,
                                  Object scheduleId);
