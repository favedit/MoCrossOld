...
import org.mo.logic.data.ISyModulePropertyDi;

/**
 * <T>数据库逻辑包(SY_MODULE_PROPERTY_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyModulePropertyImpl
      extends MSqlConnect
      implements
         ISyModulePropertyDi
{
   public final String LOGIC_NAME = "SY_MODULE_PROPERTY_DI";

   public FSyModulePropertyImpl(){
   }

   public FSyModulePropertyImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModulePropertyDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModulePropertyDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModulePropertyDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModulePropertyDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModulePropertyDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
