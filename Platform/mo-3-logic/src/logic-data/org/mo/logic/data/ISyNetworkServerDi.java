...
/**
 * <T>数据库逻辑包(SY_NETWORK_SERVER_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyNetworkServerDi
      extends
         ILogicUnit
{
   /**
    ...
    * @return 服务器标识
    */
   FSqlFunction getDefaultIdByType(Object typeCode);

   /**
    * <T>获得指定网络中，指定类型的服务器标识。</T>
    *
    * @param networkId 网络标识
    * @param typeCode 类型名称
    * @return 服务器标识
    */
   FSqlFunction getNetworkServerIdByType(Object networkId,
                                         Object typeCode);
    ...
    * @return 服务器标识
    */
   FSqlFunction getDefaultDatabaseId();
    ...
    * @return 服务器标识
    */
   FSqlFunction getDefaultProcessId();
   ...
   /**
    * <T>根据记录的编号查找是否默认(<C>IS_DEFAULT</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 是否默认
    */
   ...
   /**
    * <T>根据记录的编号查找主机名称(<C>HOST_NAME</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 主机名称
    */
   FSqlFunction getHostName(Object objectId);

   /**
    * <T>根据记录的编号查找服务地址(<C>IP_ADDRESS</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 服务地址
    */
   FSqlFunction getIpAddress(Object objectId);

   /**
    * <T>根据记录的编号查找服务端口(<C>PORT</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 服务端口
    */
   FSqlFunction getPort(Object objectId);
