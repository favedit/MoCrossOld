...
/**
 * <T>数据库逻辑包(SY_NOTIFY_RECEIVE_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyNotifyReceiveDi
      extends
         ILogicUnit
{
   /**
    ...
    * @return
    */
   FSqlFunction checkIsContains(Object notifyId,
                                Object userId);
   ...
   /**
    * <T>根据记录的编号查找发送者标识(<C>NOTIFY_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 发送者标识
    */
   FSqlFunction getNotifyId(Object objectId);

   /**
    * <T>根据记录的编号查找接受者标识(<C>RECEIVER_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 接受者标识
    */
   ...
   /**
    * <T>根据记录的编号查找消息状态(<C>STATUS_CD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 消息状态
    */
   ...
   /**
    * <T>根据记录的编号查找消息状态(<C>STATUS_CD</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 消息状态
    */
