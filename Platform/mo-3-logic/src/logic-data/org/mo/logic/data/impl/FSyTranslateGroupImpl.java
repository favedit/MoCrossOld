...
import org.mo.logic.data.ISyTranslateGroupDi;

/**
 * <T>数据库逻辑包(SY_TRANSLATE_GROUP_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyTranslateGroupImpl
      extends FAbstractLogicUnit
      implements
         ISyTranslateGroupDi
{
   public final String LOGIC_NAME = "SY_TRANSLATE_GROUP_DI";

   public FSyTranslateGroupImpl(){
   }

   public FSyTranslateGroupImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateGroupDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateGroupDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateGroupDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateGroupDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateGroupDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
