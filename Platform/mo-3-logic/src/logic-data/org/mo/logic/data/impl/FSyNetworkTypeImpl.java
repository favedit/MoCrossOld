...
import org.mo.logic.data.ISyNetworkTypeDi;

/**
 * <T>数据库逻辑包(SY_NETWORK_TYPE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyNetworkTypeImpl
      extends FAbstractLogicUnit
      implements
         ISyNetworkTypeDi
{
   public final String LOGIC_NAME = "SY_NETWORK_TYPE_DI";

   public FSyNetworkTypeImpl(){
   }

   public FSyNetworkTypeImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkTypeDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkTypeDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkTypeDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkTypeDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkTypeDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
