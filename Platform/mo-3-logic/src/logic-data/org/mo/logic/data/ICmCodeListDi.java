...
/**
 * <T>数据库逻辑包(CM_CODE_LIST_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ICmCodeListDi
      extends
         ILogicUnit
{
   /**
    * <T>根据代码列表编号获得代码个数。</T>
    *
    * @param objectUid 代码列表编号
    * @return
    */
   FSqlFunction getCodeCount(Object objectUid);

   /**
    * <T>根据代码列表名称获得所有代码打包字符串。</T>
    *
    * @param codeListName 代码列表名称
    * @return
    */
   FSqlFunction getCodePack(Object codeListName);
   ...
   /**
    * <T>根据记录的编号查找默认值(<C>DATA_DEFAULT</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 默认值
    */
   FSqlFunction getDataDefault(Object objectId);
    ...
    * @param name 代码列表名称
    */
   FSqlProcedure doSyncCodeListBegin(Object logic,
                                     Object name);
    ...
    * @param name 代码列表名称
    */
   FSqlProcedure doSyncCodeListEnd(Object logic,
                                   Object name);

   /**
    * <T>将打包字符串的内容解包后按照名称和一个指定的记录对象进行合并操作实现和前台同步的作用。</T>
    * <P>打包字符串的格式：
    * <L value='name'>代码列表的名称</L>
    * <L value='label'>代码列表的标签</L>
    * <L value='note'>代码列表的备注信息</L>
    * </P>
    *
    * @param logic 业务逻辑
    * @param params 打包字符串
    */
   FSqlProcedure doSyncCodeList(Object logic,
                                Object params);
