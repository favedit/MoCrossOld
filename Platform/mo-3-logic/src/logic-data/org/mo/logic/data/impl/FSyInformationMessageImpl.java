/*
 * @(#)FSyInformationMessageImpl.java
 *
...
import org.mo.logic.data.ISyInformationMessageDi;

/**
 * <T>数据库逻辑包(SY_INFORMATION_MESSAGE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyInformationMessageImpl
      extends FAbstractLogicUnit
      implements
         ISyInformationMessageDi
{
   public final String LOGIC_NAME = "SY_INFORMATION_MESSAGE_DI";

   public FSyInformationMessageImpl(){
   }

   public FSyInformationMessageImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyInformationMessageDi()
    */
   @Override
   public FSqlFunction getInformation(){
      FSqlFunction function = new FSqlFunction("Get_Information");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyInformationMessageDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyInformationMessageDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getContentDate(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Content_Date");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyInformationMessageDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyInformationMessageDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
