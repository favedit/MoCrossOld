...
/**
 * <T>数据库逻辑包(SY_TRANSLATE_CONTENT_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyTranslateContentDi
      extends
         ILogicUnit
{
   /**
    ...
    * <T>查询当前数据集中是否含有指定的编号。</T>
    *
    * @param translateId 翻译标识
    * @param languageId 语言标识
    * @return 是否含有指定编号
   @return 对象标识
    */
   FSqlFunction containsIdByLink(Object translateId,
                                 Object languageId);
    ...
    * @return 对象标识
    */
   FSqlFunction getIdByLink(Object translateId,
                            Object languageId);
    ...
    * @return 对象标识
    */
   FSqlFunction findIdByLink(Object translateId,
                             Object languageId,
                             Object exists);
   ...
   /**
    * <T>根据记录的编号查找翻译标识(<C>TRANSLATE_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 翻译标识
    */
   FSqlFunction getTranslateId(Object objectId);
   ...
   /**
    * <T>根据记录的编号查找数据内容(<C>CONTENT</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 数据内容
    */
