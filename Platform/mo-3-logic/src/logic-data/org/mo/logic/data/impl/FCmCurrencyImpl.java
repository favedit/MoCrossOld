...
import org.mo.logic.data.ICmCurrencyDi;

/**
 * <T>数据库逻辑包(CM_CURRENCY_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmCurrencyImpl
      extends FAbstractLogicUnit
      implements
         ICmCurrencyDi
{
   public final String LOGIC_NAME = "CM_CURRENCY_DI";

   public FCmCurrencyImpl(){
   }

   public FCmCurrencyImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCurrencyDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCurrencyDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCurrencyDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getExchangeRate(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Exchange_Rate");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCurrencyDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCurrencyDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
