...
/**
 * <T>数据库逻辑包(LG_SUBSCRIBE_DEPLOY_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ILgSubscribeDeployDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找订阅标识(<C>SUBSCRIBE_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 订阅标识
    */
   FSqlFunction getSubscribeId(Object objectId);
   ...
   /**
    * <T>根据记录的编号查找订阅事件标识(<C>TYPE_EVENT_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 订阅事件标识
    */
   FSqlFunction getTypeEventId(Object objectId);

   /**
    * <T>根据记录的编号查找发布者标识(<C>SENDER_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 发布者标识
    */
   FSqlFunction getSenderId(Object objectId);

   /**
    * <T>根据记录的编号查找接收者标识(<C>RECEIVER_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 接收者标识
    */
   FSqlFunction getReceiverId(Object objectId);

   /**
    * <T>根据记录的编号查找事件标识(<C>EVENT_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 事件标识
    */
