/*
 * @(#)FSyTranslateParameterImpl.java
 *
...
import org.mo.logic.data.ISyTranslateParameterDi;

/**
 * <T>数据库逻辑包(SY_TRANSLATE_PARAMETER_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyTranslateParameterImpl
      extends FAbstractLogicUnit
      implements
         ISyTranslateParameterDi
{
   public final String LOGIC_NAME = "SY_TRANSLATE_PARAMETER_DI";

   public FSyTranslateParameterImpl(){
   }

   public FSyTranslateParameterImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateParameterDi()
    */
   @Override
   public FSqlFunction toRecord2(){
      FSqlFunction function = new FSqlFunction("To_Record2");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateParameterDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateParameterDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction containsIdByLink(Object translateId,
                                        Object name){
      FSqlFunction function = new FSqlFunction("Contains_Id_By_Link");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("translate_id_", translateId, ESqlDataType.Integer, ESqlDataDirection.In);
    ...
    */
   @Override
   public FSqlFunction getIdByLink(Object translateId,
                                   Object name){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateParameterDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction findIdByLink(Object translateId,
                                    Object name,
                                    Object exists){
    ...
    */
   @Override
   public FSqlFunction getTranslateId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Translate_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateParameterDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
