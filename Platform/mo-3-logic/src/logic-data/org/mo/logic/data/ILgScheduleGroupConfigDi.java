...
/**
 * <T>数据库逻辑包(LG_SCHEDULE_GROUP_CONFIG_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ILgScheduleGroupConfigDi
      extends
         ILogicUnit
{
   /**
    ...
    * @param params 打包字符串
    */
   FSqlProcedure doSyncGroupConfig(Object logic,
                                   Object params);
