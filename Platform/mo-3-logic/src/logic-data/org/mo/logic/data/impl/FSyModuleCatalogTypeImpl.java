...
import org.mo.logic.data.ISyModuleCatalogTypeDi;

/**
 * <T>数据库逻辑包(SY_MODULE_CATALOG_TYPE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyModuleCatalogTypeImpl
      extends FAbstractLogicUnit
      implements
         ISyModuleCatalogTypeDi
{
   public final String LOGIC_NAME = "SY_MODULE_CATALOG_TYPE_DI";

   public FSyModuleCatalogTypeImpl(){
   }

   public FSyModuleCatalogTypeImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleCatalogTypeDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleCatalogTypeDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleCatalogTypeDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleCatalogTypeDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleCatalogTypeDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
