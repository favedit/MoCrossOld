...
/**
 * <T>数据库逻辑包(CM_LANGUAGE_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ICmLanguageDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找语言代码(<C>CODE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 语言代码
    */
