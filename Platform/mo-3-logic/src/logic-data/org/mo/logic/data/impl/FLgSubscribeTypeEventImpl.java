/*
 * @(#)FLgSubscribeTypeEventImpl.java
 *
...
import org.mo.logic.data.ILgSubscribeTypeEventDi;

/**
 * <T>数据库逻辑包(LG_SUBSCRIBE_TYPE_EVENT_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgSubscribeTypeEventImpl
      extends FAbstractLogicUnit
      implements
         ILgSubscribeTypeEventDi
{
   public final String LOGIC_NAME = "LG_SUBSCRIBE_TYPE_EVENT_DI";

   public FLgSubscribeTypeEventImpl(){
   }

   public FLgSubscribeTypeEventImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeTypeEventDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeTypeEventDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeTypeEventDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeTypeEventDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeTypeEventDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
