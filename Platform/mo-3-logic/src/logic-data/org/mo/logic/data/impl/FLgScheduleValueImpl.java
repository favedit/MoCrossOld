...
import org.mo.logic.data.ILgScheduleValueDi;

/**
 * <T>数据库逻辑包(LG_SCHEDULE_VALUE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgScheduleValueImpl
      extends FAbstractLogicUnit
      implements
         ILgScheduleValueDi
{
   public final String LOGIC_NAME = "LG_SCHEDULE_VALUE_DI";

   public FLgScheduleValueImpl(){
   }

   public FLgScheduleValueImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleValueDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction getDataValueByIds(Object propertyId,
                                         Object scheduleId){
      FSqlFunction function = new FSqlFunction("Get_Data_Value_By_Ids");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("property_id_", propertyId, ESqlDataType.Integer, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleValueDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleValueDi()
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getPropertyId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Property_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getDataValue(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Data_Value");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleValueDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleValueDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
