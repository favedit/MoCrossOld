...
import org.mo.logic.data.ISyCatalogTypeDi;

/**
 * <T>数据库逻辑包(SY_CATALOG_TYPE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyCatalogTypeImpl
      extends FAbstractLogicUnit
      implements
         ISyCatalogTypeDi
{
   public final String LOGIC_NAME = "SY_CATALOG_TYPE_DI";

   public FSyCatalogTypeImpl(){
   }

   public FSyCatalogTypeImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyCatalogTypeDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyCatalogTypeDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyCatalogTypeDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyCatalogTypeDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyCatalogTypeDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
