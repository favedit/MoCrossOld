...
/**
 * <T>数据库逻辑包(SY_MODULE_CATALOG_ROLE_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyModuleCatalogRoleDi
      extends
         ILogicUnit
{
   /**
    ...
    * @return 有效性
    */
   FSqlFunction getIsValid(Object catalogId,
                           Object roleId);
   ...
   @return 对象标识
    */
   FSqlFunction containsIdByLink(Object catalogId,
                                 Object roleId);
    ...
    * @return 对象标识
    */
   FSqlFunction getIdByLink(Object catalogId,
                            Object roleId);
    ...
    * @return 对象标识
    */
   FSqlFunction findIdByLink(Object catalogId,
                             Object roleId,
                             Object exists);
   ...
   /**
    * <T>根据记录的编号查找目录标识(<C>CATALOG_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 目录标识
    */
   ...
   /**
    * <T>根据记录的编号查找是否有效(<C>IS_VALID</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 是否有效
    */
   FSqlFunction getIsValidLabel(Object objectId);
