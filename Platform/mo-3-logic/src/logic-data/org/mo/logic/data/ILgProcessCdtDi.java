...
/**
 * <T>数据库逻辑包(LG_PROCESS_CDT_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ILgProcessCdtDi
      extends
         ILogicUnit
{
   /**
   ...
   @return 对象标识
    */
   FSqlFunction containsIdByLink(Object typeId,
                                 Object name);
    ...
    * @return 对象标识
    */
   FSqlFunction getIdByLink(Object typeId,
                            Object name);
    ...
    * @return 对象标识
    */
   FSqlFunction findIdByLink(Object typeId,
                             Object name,
                             Object exists);
   ...
   /**
    * <T>根据记录的编号查找流程类型标识(<C>TYPE_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 流程类型标识
    */
   ...
   /**
    * <T>根据记录的编号查找条件类型(<C>TYPE_CD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 条件类型
    */
   ...
   /**
    * <T>根据记录的编号查找条件类型(<C>TYPE_CD</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 条件类型
    */
   ...
   /**
    * <T>根据记录的编号查找处理检查(<C>PROCESS_CHECK</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 处理检查
    */
   FSqlFunction getProcessCheck(Object objectId);
    ...
    * @param params 打包字符串
    */
   FSqlProcedure doSyncProcessCondition(Object logic,
                                        Object params);
