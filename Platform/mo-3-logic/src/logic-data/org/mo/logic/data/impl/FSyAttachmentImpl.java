...
/**
 * <T>数据库逻辑包(SY_ATTACHMENT_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyAttachmentImpl
      extends FAbstractLogicUnit
      implements
         ISyAttachmentDi
{
   public final String LOGIC_NAME = "SY_ATTACHMENT_DI";

   public FSyAttachmentImpl(){
   }

   public FSyAttachmentImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyAttachmentDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction getFilePack(Object recordTypeName,
                                   Object recordGuid,
                                   Object recordName){
      FSqlFunction function = new FSqlFunction("Get_File_Pack");
      ...
      function.createParameter("record_guid_", recordGuid, ESqlDataType.String, ESqlDataDirection.In);
      function.createParameter("record_name_", recordName, ESqlDataType.String, ESqlDataDirection.In);
    ...
    */
   @Override
   public FSqlFunction getPreparePack(Object recordTypeName,
                                      Object recordGuid,
                                      Object recordName){
      FSqlFunction function = new FSqlFunction("Get_Prepare_Pack");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("record_type_name_", recordTypeName, ESqlDataType.String, ESqlDataDirection.In);
      function.createParameter("record_guid_", recordGuid, ESqlDataType.String, ESqlDataDirection.In);
      function.createParameter("record_name_", recordName, ESqlDataType.String, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyAttachmentDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction getFilesPack(Object recordTypeName,
                                    Object recordGuid){
      FSqlFunction function = new FSqlFunction("Get_Files_Pack");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("record_type_name_", recordTypeName, ESqlDataType.String, ESqlDataDirection.In);
      function.createParameter("record_guid_", recordGuid, ESqlDataType.String, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyAttachmentDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyAttachmentDi()
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getRecordTypeId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Record_Type_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getRecordId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Record_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getRecordGuid(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Record_Guid");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getIsExists(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Is_Exists");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getPath(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Path");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getDataDate(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Data_Date");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
    ...
    */
   @Override
   public FSqlProcedure doInsertFile(Object logic,
                                     Object params,
                                     Object result){
      FSqlProcedure procedure = new FSqlProcedure("Do_Insert_File");
    ...
    */
   @Override
   public FSqlProcedure doDeleteFile(Object logic,
                                     Object params,
                                     Object result){
      FSqlProcedure procedure = new FSqlProcedure("Do_Delete_File");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("params_", params, ESqlDataType.String, ESqlDataDirection.In);
      procedure.createParameter("result_", result, ESqlDataType.String, ESqlDataDirection.InOut);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyAttachmentDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
