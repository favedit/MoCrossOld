...
import org.mo.logic.data.ICmPictureDi;

/**
 * <T>数据库逻辑包(CM_PICTURE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmPictureImpl
      extends FAbstractLogicUnit
      implements
         ICmPictureDi
{
   public final String LOGIC_NAME = "CM_PICTURE_DI";

   public FCmPictureImpl(){
   }

   public FCmPictureImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmPictureDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmPictureDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmPictureDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getMimeId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Mime_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getDataSize(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Data_Size");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getDispWidth(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Disp_Width");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getDispHeight(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Disp_Height");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmPictureDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmPictureDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
