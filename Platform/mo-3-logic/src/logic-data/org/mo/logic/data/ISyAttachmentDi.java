...
/**
 * <T>数据库逻辑包(SY_ATTACHMENT_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyAttachmentDi
      extends
         ILogicUnit
{
   /**
    ...
    * @return
    */
   FSqlFunction getFilePack(Object recordTypeName,
                            Object recordGuid,
                            Object recordName);
    ...
    * @return
    */
   FSqlFunction getPreparePack(Object recordTypeName,
                               Object recordGuid,
                               Object recordName);
    ...
    * @return
    */
   FSqlFunction getFilesPack(Object recordTypeName,
                             Object recordGuid);
   ...
   /**
    * <T>根据记录的编号查找类型标识(<C>RECORD_TYPE_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 类型标识
    */
   FSqlFunction getRecordTypeId(Object objectId);

   /**
    * <T>根据记录的编号查找记录标识(<C>RECORD_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 记录标识
    */
   FSqlFunction getRecordId(Object objectId);

   /**
    * <T>根据记录的编号查找记录唯一标识(<C>RECORD_GUID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 记录唯一标识
    */
   FSqlFunction getRecordGuid(Object objectId);
   ...
   /**
    * <T>根据记录的编号查找存在性(<C>IS_EXISTS</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 存在性
    */
   FSqlFunction getIsExists(Object objectId);
   ...
   /**
    * <T>根据记录的编号查找文件路径(<C>PATH</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 文件路径
    */
   FSqlFunction getPath(Object objectId);
   ...
   /**
    * <T>根据记录的编号查找服务器标识(<C>SERVER_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 服务器标识
    */
   ...
   /**
    * <T>根据记录的编号查找类型标识(<C>MIME_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 类型标识
    */
   FSqlFunction getMimeId(Object objectId);

   /**
    * <T>根据记录的编号查找数据大小(<C>DATA_SIZE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 数据大小
    */
   FSqlFunction getDataSize(Object objectId);

   /**
    * <T>根据记录的编号查找数据时间(<C>DATA_DATE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 数据时间
    */
   FSqlFunction getDataDate(Object objectId);
    ...
    * @param result
    */
   FSqlProcedure doInsertFile(Object logic,
                              Object params,
                              Object result);
    ...
    * @param result
    */
   FSqlProcedure doDeleteFile(Object logic,
                              Object params,
                              Object result);
