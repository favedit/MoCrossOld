/*
 * @(#)FLgScheduleTypeEvtCfgImpl.java
 *
...
import org.mo.logic.data.ILgScheduleTypeEvtCfgDi;

/**
 * <T>数据库逻辑包(LG_SCHEDULE_TYPE_EVT_CFG_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgScheduleTypeEvtCfgImpl
      extends FAbstractLogicUnit
      implements
         ILgScheduleTypeEvtCfgDi
{
   public final String LOGIC_NAME = "LG_SCHEDULE_TYPE_EVT_CFG_DI";

   public FLgScheduleTypeEvtCfgImpl(){
   }

   public FLgScheduleTypeEvtCfgImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTypeEvtCfgDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTypeEvtCfgDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTypeEvtCfgDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTypeEvtCfgDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTypeEvtCfgDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
