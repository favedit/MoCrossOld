...
/**
 * <T>数据库逻辑包(CM_CODE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmCodeImpl
      extends FAbstractLogicUnit
      implements
         ICmCodeDi
{
   public final String LOGIC_NAME = "CM_CODE_DI";

   public FCmCodeImpl(){
   }

   public FCmCodeImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCodeDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction findLabel(Object codeListName,
                                 Object code){
      FSqlFunction function = new FSqlFunction("Find_Label");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCodeDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCodeDi()
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction containsIdByValue(Object listId,
                                         Object dataValue){
      FSqlFunction function = new FSqlFunction("Contains_Id_By_Value");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("list_id_", listId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.createParameter("data_value_", dataValue, ESqlDataType.String, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Boolean);
      activeConnection().execute(function);
      return function;
   }
    ...
    */
   @Override
   public FSqlFunction getIdByValue(Object listId,
                                    Object dataValue){
      FSqlFunction function = new FSqlFunction("Get_Id_By_Value");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("list_id_", listId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.createParameter("data_value_", dataValue, ESqlDataType.String, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCodeDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction findIdByValue(Object listId,
                                     Object dataValue,
                                     Object exists){
      FSqlFunction function = new FSqlFunction("Find_Id_By_Value");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("list_id_", listId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.createParameter("data_value_", dataValue, ESqlDataType.String, ESqlDataDirection.In);
      function.createParameter("exists_", exists, ESqlDataType.Boolean, ESqlDataDirection.InOut);
    ...
    */
   @Override
   public FSqlProcedure checkCode(Object codeList,
                                  Object code){
      FSqlProcedure procedure = new FSqlProcedure("Check_Code");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("code_list_", codeList, ESqlDataType.String, ESqlDataDirection.In);
    ...
    */
   @Override
   public FSqlProcedure doSyncCode(Object logic,
                                   Object params){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Code");
      procedure.setLogicName(LOGIC_NAME);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCodeDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
