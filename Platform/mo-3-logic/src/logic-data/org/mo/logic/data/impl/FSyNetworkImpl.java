...
import org.mo.logic.data.ISyNetworkDi;

/**
 * <T>数据库逻辑包(SY_NETWORK_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyNetworkImpl
      extends FAbstractLogicUnit
      implements
         ISyNetworkDi
{
   public final String LOGIC_NAME = "SY_NETWORK_DI";

   public FSyNetworkImpl(){
   }

   public FSyNetworkImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkDi()
    */
   @Override
   public FSqlFunction getDefaultId(){
      FSqlFunction function = new FSqlFunction("Get_Default_Id");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
