...
import org.mo.logic.data.ILgTaskStatusEi;

/**
 * <T>数据库逻辑包(LG_TASK_STATUS_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgTaskStatusEiImpl
      extends MSqlConnect
      implements
         ILgTaskStatusEi
{
   public final String LOGIC_NAME = "LG_TASK_STATUS_EI";

   public FLgTaskStatusEiImpl(){
   }

   public FLgTaskStatusEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskStatusEi(java.lang.Object)
    */
   @Override
