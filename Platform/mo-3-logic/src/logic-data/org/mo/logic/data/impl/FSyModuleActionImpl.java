...
import org.mo.logic.data.ISyModuleActionDi;

/**
 * <T>数据库逻辑包(SY_MODULE_ACTION_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyModuleActionImpl
      extends FAbstractLogicUnit
      implements
         ISyModuleActionDi
{
   public final String LOGIC_NAME = "SY_MODULE_ACTION_DI";

   public FSyModuleActionImpl(){
   }

   public FSyModuleActionImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleActionDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction getModuleActionIdByName(Object actionName,
                                               Object actionTypeId){
      FSqlFunction function = new FSqlFunction("Get_Module_Action_Id_By_Name");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("action_name_", actionName, ESqlDataType.String, ESqlDataDirection.In);
      function.createParameter("action_type_id_", actionTypeId, ESqlDataType.Integer, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleActionDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleActionDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleActionDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getIsAble(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Is_Able");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleActionDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
