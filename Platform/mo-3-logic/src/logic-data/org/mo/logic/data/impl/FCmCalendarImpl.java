...
import org.mo.logic.data.ICmCalendarDi;

/**
 * <T>数据库逻辑包(CM_CALENDAR_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmCalendarImpl
      extends FAbstractLogicUnit
      implements
         ICmCalendarDi
{
   public final String LOGIC_NAME = "CM_CALENDAR_DI";

   public FCmCalendarImpl(){
   }

   public FCmCalendarImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction checkTimeScale(Object calendarId,
                                      Object beginTime,
                                      Object endTime){
      FSqlFunction function = new FSqlFunction("Check_Time_Scale");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("calendar_id_", calendarId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.createParameter("begin_time_", beginTime, ESqlDataType.Date, ESqlDataDirection.In);
      function.createParameter("end_time_", endTime, ESqlDataType.Date, ESqlDataDirection.In);
    ...
    */
   @Override
   public FSqlFunction getRestMinuteLength(Object calendarId,
                                           Object beginDate,
                                           Object endDate){
      FSqlFunction function = new FSqlFunction("Get_Rest_Minute_Length");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("calendar_id_", calendarId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.createParameter("begin_date_", beginDate, ESqlDataType.Date, ESqlDataDirection.In);
      function.createParameter("end_date_", endDate, ESqlDataType.Date, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarDi(java.lang.Object)
    */
   @Override
   public FSqlFunction getWorkDays(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Work_days");
      function.setLogicName(LOGIC_NAME);
    ...
    */
   @Override
   public FSqlFunction getWeekendDays(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Weekend_days");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getHolidayDays(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Holiday_days");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction isWeekend(Object objectId,
                                 Object value){
      FSqlFunction function = new FSqlFunction("Is_Weekend");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
    ...
    */
   @Override
   public FSqlFunction isHoliday(Object calendarId,
                                 Object beginTime,
                                 Object endTime){
      FSqlFunction function = new FSqlFunction("Is_Holiday");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("calendar_id_", calendarId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.createParameter("begin_time_", beginTime, ESqlDataType.DateTime, ESqlDataDirection.In);
      function.createParameter("end_time_", endTime, ESqlDataType.DateTime, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Boolean);
      activeConnection().execute(function);
      return function;
   }
    ...
    */
   @Override
   public FSqlFunction getDayHours(Object calendarId){
      FSqlFunction function = new FSqlFunction("Get_Day_Hours");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("calendar_id_", calendarId, ESqlDataType.Integer, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarDi()
    */
   @Override
   public FSqlFunction getDefaultCalendar(){
      FSqlFunction function = new FSqlFunction("Get_Default_Calendar");
      function.setLogicName(LOGIC_NAME);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
      return function;
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlProcedure doInsertTimespan(Object logic,
                                         Object calendarId,
                                         Object date,
                                         Object beginTime,
                                         Object endTime){
      FSqlProcedure procedure = new FSqlProcedure("Do_Insert_Timespan");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("calendar_id_", calendarId, ESqlDataType.Integer, ESqlDataDirection.In);
      procedure.createParameter("date_", date, ESqlDataType.Date, ESqlDataDirection.In);
      procedure.createParameter("begin_time_", beginTime, ESqlDataType.DateTime, ESqlDataDirection.In);
      procedure.createParameter("end_time_", endTime, ESqlDataType.DateTime, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
