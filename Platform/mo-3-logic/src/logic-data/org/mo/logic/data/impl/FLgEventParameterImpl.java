...
import org.mo.logic.data.ILgEventParameterDi;

/**
 * <T>数据库逻辑包(LG_EVENT_PARAMETER_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgEventParameterImpl
      extends FAbstractLogicUnit
      implements
         ILgEventParameterDi
{
   public final String LOGIC_NAME = "LG_EVENT_PARAMETER_DI";

   public FLgEventParameterImpl(){
   }

   public FLgEventParameterImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventParameterDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventParameterDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventParameterDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getLineNumber(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Line_Number");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventParameterDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventParameterDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
