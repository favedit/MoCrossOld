...
import org.mo.logic.data.ISyNotifyGroupDi;

/**
 * <T>数据库逻辑包(SY_NOTIFY_GROUP_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyNotifyGroupImpl
      extends FAbstractLogicUnit
      implements
         ISyNotifyGroupDi
{
   public final String LOGIC_NAME = "SY_NOTIFY_GROUP_DI";

   public FSyNotifyGroupImpl(){
   }

   public FSyNotifyGroupImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyGroupDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyGroupDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyGroupDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyGroupDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyGroupDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
