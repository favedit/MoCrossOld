...
/**
 * <T>数据库逻辑包(SY_INFORMATION_MESSAGE_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyInformationMessageDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找内容时间(<C>CONTENT_DATE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 内容时间
    */
   FSqlFunction getContentDate(Object objectId);

   /**
    * <T>根据记录的编号查找消息内容(<C>CONTENT</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 消息内容
    */
