/*
 * @(#)FLgScheduleTypeConfigImpl.java
 *
...
/**
 * <T>数据库逻辑包(LG_SCHEDULE_TYPE_CONFIG_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgScheduleTypeConfigImpl
      extends FAbstractLogicUnit
      implements
         ILgScheduleTypeConfigDi
{
   public final String LOGIC_NAME = "LG_SCHEDULE_TYPE_CONFIG_DI";

   public FLgScheduleTypeConfigImpl(){
   }

   public FLgScheduleTypeConfigImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTypeConfigDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTypeConfigDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTypeConfigDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlProcedure doSyncTypeConfig(Object logic,
                                         Object params){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Type_Config");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTypeConfigDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTypeConfigDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
