...
/**
 * <T>数据库逻辑包(SY_SESSION_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISySessionDi
      extends
         ILogicUnit
{
   /**
   ...
   @return 对象标识
    */
   FSqlFunction containsIdByUserId(Object userId);
   ...
   /**
    * <T>根据用户标识(<C>USER_ID</C>)获得当前记录的编号</T>
    * <UL>
    * <L>若存在则返回被查询的记录对象的唯一标识。</L>
    * <L>如果记录不存在，则产生记录不存在的例外。</L>
    * </UL>
    ...
    * @return 对象标识
    */
   FSqlFunction getIdByUserId(Object userId);
   ...
   /**
    * <T>根据用户标识(<C>USER_ID</C>)查找当前记录的编号</T>
    *
    * @param userId 用户标识
    * @param exists 存在标志
    * @return 对象标识
    */
   FSqlFunction findIdByUserId(Object userId,
                               Object exists);
   ...
   /**
    * <T>根据记录的编号查找线程状态(<C>STATUS_CD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 线程状态
    */
   ...
   /**
    * <T>根据记录的编号查找线程状态(<C>STATUS_CD</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 线程状态
    */
   ...
   /**
    * <T>根据记录的编号查找语言标识(<C>LANGUAGE_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 语言标识
    */
   FSqlFunction getLanguageId(Object objectId);

   /**
    * <T>根据记录的编号查找目录视角标识(<C>CATALOG_VIEW_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 目录视角标识
    */
   FSqlFunction getCatalogViewId(Object objectId);

   /**
    * <T>根据记录的编号查找用户角色集合(<C>ROLE_IDS</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 用户角色集合
    */
   FSqlFunction getRoleIds(Object objectId);

   /**
    * <T>根据记录的编号查找角色的名称集合(<C>ROLE_CODES</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 角色的名称集合
    */
   FSqlFunction getRoleCodes(Object objectId);

   /**
    * <T>根据记录的编号查找用户组织集合(<C>ORGANIZATION_IDS</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 用户组织集合
    */
   FSqlFunction getOrganizationIds(Object objectId);

   /**
    * <T>根据记录的编号查找组织的名称集合(<C>ORGANIZATION_CODES</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 组织的名称集合
    */
   FSqlFunction getOrganizationCodes(Object objectId);
   ...
   /**
    * <T>根据记录的编号查找激活日期(<C>ACTIVE_DATE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 激活日期
    */
   FSqlFunction getActiveDate(Object objectId);

   /**
    * <T>根据记录的编号查找参数列表(<C>PARAMETERS</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 参数列表
    */
