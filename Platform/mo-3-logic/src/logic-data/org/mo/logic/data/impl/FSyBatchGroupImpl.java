...
import org.mo.logic.data.ISyBatchGroupDi;

/**
 * <T>数据库逻辑包(SY_BATCH_GROUP_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyBatchGroupImpl
      extends FAbstractLogicUnit
      implements
         ISyBatchGroupDi
{
   public final String LOGIC_NAME = "SY_BATCH_GROUP_DI";

   public FSyBatchGroupImpl(){
   }

   public FSyBatchGroupImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBatchGroupDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBatchGroupDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBatchGroupDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBatchGroupDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBatchGroupDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
