...
import org.mo.logic.data.ISyModuleValueDi;

/**
 * <T>数据库逻辑包(SY_MODULE_VALUE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyModuleValueImpl
      extends FAbstractLogicUnit
      implements
         ISyModuleValueDi
{
   public final String LOGIC_NAME = "SY_MODULE_VALUE_DI";

   public FSyModuleValueImpl(){
   }

   public FSyModuleValueImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleValueDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleValueDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleValueDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction containsIdByName(Object moduleId,
                                        Object name){
      FSqlFunction function = new FSqlFunction("Contains_Id_By_Name");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("module_id_", moduleId, ESqlDataType.Integer, ESqlDataDirection.In);
    ...
    */
   @Override
   public FSqlFunction getIdByName(Object moduleId,
                                   Object name){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleValueDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction findIdByName(Object moduleId,
                                    Object name,
                                    Object exists){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleValueDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
