...
import org.mo.logic.data.ILgScheduleCdtTypeDi;

/**
 * <T>数据库逻辑包(LG_SCHEDULE_CDT_TYPE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgScheduleCdtTypeImpl
      extends FAbstractLogicUnit
      implements
         ILgScheduleCdtTypeDi
{
   public final String LOGIC_NAME = "LG_SCHEDULE_CDT_TYPE_DI";

   public FLgScheduleCdtTypeImpl(){
   }

   public FLgScheduleCdtTypeImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleCdtTypeDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleCdtTypeDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleCdtTypeDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleCdtTypeDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleCdtTypeDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
