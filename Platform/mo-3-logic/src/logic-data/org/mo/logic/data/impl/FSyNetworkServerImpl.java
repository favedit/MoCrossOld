...
import org.mo.logic.data.ISyNetworkServerDi;

/**
 * <T>数据库逻辑包(SY_NETWORK_SERVER_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyNetworkServerImpl
      extends FAbstractLogicUnit
      implements
         ISyNetworkServerDi
{
   public final String LOGIC_NAME = "SY_NETWORK_SERVER_DI";

   public FSyNetworkServerImpl(){
   }

   public FSyNetworkServerImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkServerDi(java.lang.Object)
    */
   @Override
   public FSqlFunction getDefaultIdByType(Object typeCode){
      FSqlFunction function = new FSqlFunction("Get_Default_Id_By_Type");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("type_code_", typeCode, ESqlDataType.String, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkServerDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction getNetworkServerIdByType(Object networkId,
                                                Object typeCode){
      FSqlFunction function = new FSqlFunction("Get_Network_Server_Id_By_Type");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("network_id_", networkId, ESqlDataType.String, ESqlDataDirection.In);
      function.createParameter("type_code_", typeCode, ESqlDataType.String, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
      return function;
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkServerDi()
    */
   @Override
   public FSqlFunction getDefaultDatabaseId(){
      FSqlFunction function = new FSqlFunction("Get_Default_Database_Id");
      function.setLogicName(LOGIC_NAME);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
      return function;
    ...
    */
   @Override
   public FSqlFunction getDefaultWebId(){
      FSqlFunction function = new FSqlFunction("Get_Default_Web_Id");
      function.setLogicName(LOGIC_NAME);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
      return function;
    ...
    */
   @Override
   public FSqlFunction getDefaultProcessId(){
      FSqlFunction function = new FSqlFunction("Get_Default_Process_Id");
      function.setLogicName(LOGIC_NAME);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
      return function;
    ...
    */
   @Override
   public FSqlFunction getNetworkId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Network_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getHostName(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Host_Name");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getIpAddress(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Ip_Address");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getPort(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Port");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkServerDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkServerDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
