...
/**
 * <T>数据库逻辑包(LG_TASK_LINK_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ILgTaskLinkDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找流程标识(<C>PROCESS_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 流程标识
    */
   ...
   /**
    * <T>根据记录的编号查找前置任务(<C>PRIOR_TASK_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 前置任务
    */
   FSqlFunction getPriorTaskId(Object objectId);

   /**
    * <T>根据记录的编号查找任务标识(<C>TASK_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 任务标识
    */
   FSqlFunction getTaskId(Object objectId);

   /**
    * <T>根据记录的编号查找后置任务(<C>NEXT_TASK_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 后置任务
    */
   FSqlFunction getNextTaskId(Object objectId);
