...
import org.mo.logic.data.ICmCityLevelEi;

/**
 * <T>数据库逻辑包(CM_CITY_LEVEL_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmCityLevelEiImpl
      extends MSqlConnect
      implements
         ICmCityLevelEi
{
   public final String LOGIC_NAME = "CM_CITY_LEVEL_EI";

   public FCmCityLevelEiImpl(){
   }

   public FCmCityLevelEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCityLevelEi(java.lang.Object)
    */
   @Override
