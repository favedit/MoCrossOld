...
/**
 * <T>数据库逻辑包(CM_POSTCODE_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ICmPostcodeDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找邮政编号(<C>CODE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 邮政编号
    */
   ...
   /**
    * <T>根据记录的编号查找中文名称(<C>LABLE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 中文名称
    */
   FSqlFunction getLable(Object objectId);
