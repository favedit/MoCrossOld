/*
 * @(#)FSyInformationMessageTypeImpl.java
 *
...
import org.mo.logic.data.ISyInformationMessageTypeDi;

/**
 * <T>数据库逻辑包(SY_INFORMATION_MESSAGE_TYPE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyInformationMessageTypeImpl
      extends FAbstractLogicUnit
      implements
         ISyInformationMessageTypeDi
{
   public final String LOGIC_NAME = "SY_INFORMATION_MESSAGE_TYPE_DI";

   public FSyInformationMessageTypeImpl(){
   }

   public FSyInformationMessageTypeImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyInformationMessageTypeDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyInformationMessageTypeDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyInformationMessageTypeDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyInformationMessageTypeDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyInformationMessageTypeDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
