...
/**
 * <T>数据库逻辑包(LG_SCHEDULE_TYPE_EVENT_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ILgScheduleTypeEventDi
      extends
         ILogicUnit
{
   /**
    ...
    * @return
    */
   FSqlFunction getIsValid(Object typeId,
                           Object eventId);
   ...
   @return 对象标识
    */
   FSqlFunction containsIdByCode(Object typeId,
                                 Object code);
    ...
    * @return 对象标识
    */
   FSqlFunction getIdByCode(Object typeId,
                            Object code);
    ...
    * @return 对象标识
    */
   FSqlFunction findIdByCode(Object typeId,
                             Object code,
                             Object exists);
   ...
   /**
    * <T>根据记录的编号查找事件组标识(<C>EVENT_GROUP_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 事件组标识
    */
    ...
    * @param params 打包字符串
    */
   FSqlProcedure doSyncTypeEvent(Object logic,
                                 Object params);
