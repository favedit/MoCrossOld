...
import org.mo.logic.data.ILgScheduleStatusEi;

/**
 * <T>数据库逻辑包(LG_SCHEDULE_STATUS_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgScheduleStatusEiImpl
      extends MSqlConnect
      implements
         ILgScheduleStatusEi
{
   public final String LOGIC_NAME = "LG_SCHEDULE_STATUS_EI";

   public FLgScheduleStatusEiImpl(){
   }

   public FLgScheduleStatusEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleStatusEi(java.lang.Object)
    */
   @Override
