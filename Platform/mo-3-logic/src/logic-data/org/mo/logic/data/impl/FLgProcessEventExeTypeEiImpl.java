/*
 * @(#)FLgProcessEventExeTypeEiImpl.java
 *
...
import org.mo.logic.data.ILgProcessEventExeTypeEi;

/**
 * <T>数据库逻辑包(LG_PROCESS_EVENT_EXE_TYPE_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgProcessEventExeTypeEiImpl
      extends MSqlConnect
      implements
         ILgProcessEventExeTypeEi
{
   public final String LOGIC_NAME = "LG_PROCESS_EVENT_EXE_TYPE_EI";

   public FLgProcessEventExeTypeEiImpl(){
   }

   public FLgProcessEventExeTypeEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessEventExeTypeEi(java.lang.Object)
    */
   @Override
