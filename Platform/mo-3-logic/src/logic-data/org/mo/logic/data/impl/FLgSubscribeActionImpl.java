...
import org.mo.logic.data.ILgSubscribeActionDi;

/**
 * <T>数据库逻辑包(LG_SUBSCRIBE_ACTION_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgSubscribeActionImpl
      extends FAbstractLogicUnit
      implements
         ILgSubscribeActionDi
{
   public final String LOGIC_NAME = "LG_SUBSCRIBE_ACTION_DI";

   public FLgSubscribeActionImpl(){
   }

   public FLgSubscribeActionImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeActionDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeActionDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeActionDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction containsIdByAction(Object subscribeId,
                                          Object actionId){
      FSqlFunction function = new FSqlFunction("Contains_Id_By_Action");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("subscribe_id_", subscribeId, ESqlDataType.Integer, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeActionDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getIdByAction(Object subscribeId,
                                     Object actionId){
      FSqlFunction function = new FSqlFunction("Get_Id_By_Action");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("subscribe_id_", subscribeId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.createParameter("action_id_", actionId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeActionDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction findIdByAction(Object subscribeId,
                                      Object actionId,
                                      Object exists){
      FSqlFunction function = new FSqlFunction("Find_Id_By_Action");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("subscribe_id_", subscribeId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.createParameter("action_id_", actionId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.createParameter("exists_", exists, ESqlDataType.Boolean, ESqlDataDirection.InOut);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeActionDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getSubscribeId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Subscribe_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
