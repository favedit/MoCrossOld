...
import org.mo.logic.data.ISyEnvironmentDi;

/**
 * <T>数据库逻辑包(SY_ENVIRONMENT_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyEnvironmentImpl
      extends FAbstractLogicUnit
      implements
         ISyEnvironmentDi
{
   public final String LOGIC_NAME = "SY_ENVIRONMENT_DI";

   public FSyEnvironmentImpl(){
   }

   public FSyEnvironmentImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyEnvironmentDi(java.lang.Object)
    */
   @Override
   public FSqlFunction getValue(Object name){
      FSqlFunction function = new FSqlFunction("Get_Value");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyEnvironmentDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyEnvironmentDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyEnvironmentDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlProcedure setValue(Object logic,
                                 Object name,
                                 Object value,
                                 Object dataType){
      FSqlProcedure procedure = new FSqlProcedure("Set_Value");
      ...
      procedure.createParameter("data_type_", dataType, ESqlDataType.String, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyEnvironmentDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
