...
/**
 * <T>数据库逻辑包(LG_TASK_EVENT_CONFIG_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgTaskEventConfigImpl
      extends FAbstractLogicUnit
      implements
         ILgTaskEventConfigDi
{
   public final String LOGIC_NAME = "LG_TASK_EVENT_CONFIG_DI";

   public FLgTaskEventConfigImpl(){
   }

   public FLgTaskEventConfigImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskEventConfigDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskEventConfigDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskEventConfigDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskEventConfigDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskEventConfigDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
