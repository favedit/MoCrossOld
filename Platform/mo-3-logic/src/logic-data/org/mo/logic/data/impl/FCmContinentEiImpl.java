...
import org.mo.logic.data.ICmContinentEi;

/**
 * <T>数据库逻辑包(CM_CONTINENT_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmContinentEiImpl
      extends MSqlConnect
      implements
         ICmContinentEi
{
   public final String LOGIC_NAME = "CM_CONTINENT_EI";

   public FCmContinentEiImpl(){
   }

   public FCmContinentEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmContinentEi(java.lang.Object)
    */
   @Override
