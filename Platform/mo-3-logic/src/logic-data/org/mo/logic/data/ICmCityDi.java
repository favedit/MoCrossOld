...
/**
 * <T>数据库逻辑包(CM_CITY_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ICmCityDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找城市级别(<C>LEVEL_CD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 城市级别
    */
   ...
   /**
    * <T>根据记录的编号查找城市级别(<C>LEVEL_CD</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 城市级别
    */
   ...
   /**
    * <T>根据记录的编号查找城市编号(<C>CODE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 城市编号
    */
   ...
   /**
    * <T>根据记录的编号查找城市人口(<C>POPULATION</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 城市人口
    */
