...
import org.mo.logic.data.ICmCalendarDayDi;

/**
 * <T>数据库逻辑包(CM_CALENDAR_DAY_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmCalendarDayImpl
      extends FAbstractLogicUnit
      implements
         ICmCalendarDayDi
{
   public final String LOGIC_NAME = "CM_CALENDAR_DAY_DI";

   public FCmCalendarDayImpl(){
   }

   public FCmCalendarDayImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarDayDi(java.lang.Object)
    */
   @Override
   public FSqlFunction getWeekday(Object value){
      FSqlFunction function = new FSqlFunction("Get_WeekDay");
   ...
   public FSqlFunction getWorkTime(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Work_Time");
      function.setLogicName(LOGIC_NAME);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarDayDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarDayDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getWorkDate(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Work_Date");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarDayDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarDayDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
