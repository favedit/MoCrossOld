...
import org.mo.logic.data.ILgTaskDi;

/**
 * <T>数据库逻辑包(LG_TASK_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgTaskImpl
      extends FAbstractLogicUnit
      implements
         ILgTaskDi
{
   public final String LOGIC_NAME = "LG_TASK_DI";

   public FLgTaskImpl(){
   }

   public FLgTaskImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction findValuePack(Object taskId,
                                     Object eventId){
      FSqlFunction function = new FSqlFunction("Find_Value_Pack");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("task_id_", taskId, ESqlDataType.Integer, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlProcedure doDeployEvent(Object logic,
      ...
      procedure.createParameter("task_id_", taskId, ESqlDataType.Integer, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlProcedure cbStart(Object logic,
                                Object params){
      FSqlProcedure procedure = new FSqlProcedure("Cb_Start");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
    ...
    */
   @Override
   public FSqlProcedure cbConfirm(Object logic,
                                  Object params){
      FSqlProcedure procedure = new FSqlProcedure("Cb_Confirm");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("params_", params, ESqlDataType.String, ESqlDataDirection.InOut);
      activeConnection().execute(procedure);
    ...
    */
   @Override
   public FSqlProcedure doConfirm(Object logic,
                                  Object params){
      FSqlProcedure procedure = new FSqlProcedure("Do_Confirm");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("params_", params, ESqlDataType.String, ESqlDataDirection.InOut);
      activeConnection().execute(procedure);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlProcedure cbStopDeploy(Object logic,
                                     Object beginDatetime,
                                     Object endDatetime,
                                     Object executeDatetime,
                                     Object params){
      FSqlProcedure procedure = new FSqlProcedure("Cb_Stop_Deploy");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("begin_dateTime_", beginDatetime, ESqlDataType.DateTime, ESqlDataDirection.In);
      procedure.createParameter("end_dateTime_", endDatetime, ESqlDataType.DateTime, ESqlDataDirection.In);
    ...
    */
   @Override
   public FSqlProcedure doCancel(Object logic,
                                 Object params){
      FSqlProcedure procedure = new FSqlProcedure("Do_Cancel");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("params_", params, ESqlDataType.String, ESqlDataDirection.InOut);
      activeConnection().execute(procedure);
