...
/**
 * <T>数据库逻辑包(SY_CATALOG_VALUE_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyCatalogValueDi
{
   /**
   ...
   /**
    * <T>根据记录的编号查找模块标识(<C>CATALOG_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 模块标识
    */
   ...
   /**
    * <T>根据记录的编号查找属性标识(<C>PROPERTY_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 属性标识
    */
   FSqlFunction getPropertyId(Object objectId);
