...
/**
 * <T>数据库逻辑包(LG_SUBSCRIBE_EVENT_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ILgSubscribeEventDi
      extends
         ILogicUnit
{
   /**
    ...
    * <T>查询当前数据集中是否含有指定的编号。</T>
    *
    * @param subscribeActionId 订阅动作标识
    * @param eventId 类型动作事件标识
    * @return 是否含有指定编号
   @return 对象标识
    */
   FSqlFunction containsIdByEvent(Object subscribeActionId,
                                  Object eventId);
    ...
    * @return 对象标识
    */
   FSqlFunction getIdByEvent(Object subscribeActionId,
                             Object eventId);
    ...
    * @return 对象标识
    */
   FSqlFunction findIdByEvent(Object subscribeActionId,
                              Object eventId,
                              Object exists);
   ...
   /**
    * <T>根据记录的编号查找订阅动作标识(<C>SUBSCRIBE_ACTION_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 订阅动作标识
    */
   FSqlFunction getSubscribeActionId(Object objectId);
   ...
   /**
    * <T>根据记录的编号查找订阅动作标识(<C>ACTION_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 订阅动作标识
    */
   FSqlFunction getActionId(Object objectId);

   /**
    * <T>根据记录的编号查找类型动作事件标识(<C>EVENT_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 类型动作事件标识
    */
   FSqlFunction getEventId(Object objectId);
