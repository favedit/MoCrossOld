...
import org.mo.logic.data.ILgTaskConditionEi;

/**
 * <T>数据库逻辑包(LG_TASK_CONDITION_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgTaskConditionEiImpl
      extends MSqlConnect
      implements
         ILgTaskConditionEi
{
   public final String LOGIC_NAME = "LG_TASK_CONDITION_EI";

   public FLgTaskConditionEiImpl(){
   }

   public FLgTaskConditionEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskConditionEi(java.lang.Object)
    */
   @Override
