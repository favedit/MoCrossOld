...
import org.mo.logic.data.ISyServerValueDi;

/**
 * <T>数据库逻辑包(SY_SERVER_VALUE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyServerValueImpl
      extends MSqlConnect
      implements
         ISyServerValueDi
{
   public final String LOGIC_NAME = "SY_SERVER_VALUE_DI";

   public FSyServerValueImpl(){
   }

   public FSyServerValueImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyServerValueDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyServerValueDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyServerValueDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyServerValueDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyServerValueDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
