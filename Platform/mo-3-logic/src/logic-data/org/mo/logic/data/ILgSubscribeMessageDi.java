...
/**
 * <T>数据库逻辑包(LG_SUBSCRIBE_MESSAGE_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ILgSubscribeMessageDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找触发者标识(<C>USER_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 触发者标识
    */
   ...
   /**
    * <T>根据记录的编号查找类型动作标识(<C>ACTION_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 类型动作标识
    */
