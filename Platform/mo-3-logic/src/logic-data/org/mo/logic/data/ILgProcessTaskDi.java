...
/**
 * <T>数据库逻辑包(LG_PROCESS_TASK_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ILgProcessTaskDi
{
   /**
   ...
   /**
    * <T>根据记录的编号查找前置任务标识(<C>PREVIEW_TASK_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 前置任务标识
    */
   FSqlFunction getPreviewTaskId(Object objectId);
