...
import org.mo.logic.data.ILgTaskLinkDi;

/**
 * <T>数据库逻辑包(LG_TASK_LINK_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgTaskLinkImpl
      extends FAbstractLogicUnit
      implements
         ILgTaskLinkDi
{
   public final String LOGIC_NAME = "LG_TASK_LINK_DI";

   public FLgTaskLinkImpl(){
   }

   public FLgTaskLinkImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskLinkDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskLinkDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskLinkDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getProcessId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Process_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getPriorTaskId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Prior_Task_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getTaskId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Task_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getNextTaskId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Next_Task_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskLinkDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskLinkDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
