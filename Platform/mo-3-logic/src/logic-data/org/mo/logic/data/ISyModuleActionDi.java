...
/**
 * <T>数据库逻辑包(SY_MODULE_ACTION_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyModuleActionDi
      extends
         ILogicUnit
{
   /**
    ...
    * @param actionTypeId 命令类型标识
    * @return 类型标识
    */
   FSqlFunction getModuleActionIdByName(Object actionName,
                                        Object actionTypeId);
   ...
   /**
    * <T>根据记录的编号查找模块类型标识(<C>TYPE_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 模块类型标识
    */
   ...
   /**
    * <T>根据记录的编号查找可编辑(<C>IS_ABLE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 可编辑
    */
   FSqlFunction getIsAble(Object objectId);
