...
/**
 * <T>数据库逻辑包(SY_SERVER_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyServerDi
{
   /**
   ...
   /**
    * <T>根据记录的编号查找发送方式(<C>DELIVERY</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 发送方式
    */
   FSqlFunction getDelivery(Object objectId);

   /**
    * <T>根据记录的编号查找发送方式(<C>DELIVERY</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 发送方式
    */
   FSqlFunction getDeliveryLabel(Object objectId);

   /**
    * <T>根据记录的编号查找接收方式(<C>RECEIVE_WAY</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 接收方式
    */
   FSqlFunction getReceiveWay(Object objectId);

   /**
    * <T>根据记录的编号查找接收方式(<C>RECEIVE_WAY</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 接收方式
    */
   FSqlFunction getReceiveWayLabel(Object objectId);
   ...
   /**
    * <T>根据记录的编号查找处理端口(<C>PROCESS_HOST</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 处理端口
    */
   FSqlFunction getProcessHost(Object objectId);
