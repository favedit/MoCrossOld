...
import org.mo.logic.data.ISyTranslateListDi;

/**
 * <T>数据库逻辑包(SY_TRANSLATE_LIST_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyTranslateListImpl
      extends FAbstractLogicUnit
      implements
         ISyTranslateListDi
{
   public final String LOGIC_NAME = "SY_TRANSLATE_LIST_DI";

   public FSyTranslateListImpl(){
   }

   public FSyTranslateListImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateListDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateListDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateListDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction containsIdByLink(Object groupId,
                                        Object name){
      FSqlFunction function = new FSqlFunction("Contains_Id_By_Link");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("group_id_", groupId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.createParameter("name_", name, ESqlDataType.String, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Boolean);
      activeConnection().execute(function);
      return function;
    ...
    */
   @Override
   public FSqlFunction getIdByLink(Object groupId,
                                   Object name){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateListDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction findIdByLink(Object groupId,
                                    Object name,
                                    Object exists){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateListDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
