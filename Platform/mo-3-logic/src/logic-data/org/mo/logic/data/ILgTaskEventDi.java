...
/**
 * <T>数据库逻辑包(LG_TASK_EVENT_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ILgTaskEventDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找任务类型标志(<C>TASK_TYPE_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 任务类型标志
    */
   FSqlFunction getTaskTypeId(Object objectId);
    ...
    * @param params 打包字符串
    */
   FSqlProcedure doSyncTaskEvent(Object logic,
                                 Object params);
