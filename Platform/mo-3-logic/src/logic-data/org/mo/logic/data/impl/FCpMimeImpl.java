...
import org.mo.logic.data.ICpMime;

/**
 * <T>数据库逻辑包(CP_MIME)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCpMimeImpl
      extends MSqlConnect
      implements
         ICpMime
{
   public final String LOGIC_NAME = "CP_MIME";

   public FCpMimeImpl(){
   }

   public FCpMimeImpl(ISqlConnect connect){
      super(connect);
   }
