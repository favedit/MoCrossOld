...
/**
 * <T>数据库逻辑包(LG_EVENT_GROUP_CONFIG_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgEventGroupConfigImpl
      extends FAbstractLogicUnit
      implements
         ILgEventGroupConfigDi
{
   public final String LOGIC_NAME = "LG_EVENT_GROUP_CONFIG_DI";

   public FLgEventGroupConfigImpl(){
   }

   public FLgEventGroupConfigImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventGroupConfigDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventGroupConfigDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventGroupConfigDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventGroupConfigDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventGroupConfigDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
