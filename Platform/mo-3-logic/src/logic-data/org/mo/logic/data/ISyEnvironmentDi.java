...
/**
 * <T>数据库逻辑包(SY_ENVIRONMENT_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyEnvironmentDi
      extends
         ILogicUnit
{
   /**
    ...
    * @return 记录对象
    */
   FSqlFunction getValue(Object name);
    ...
    * @param dataType
    */
   FSqlProcedure setValue(Object logic,
                          Object name,
                          Object value,
                          Object dataType);
