...
import org.mo.logic.data.ICmAreaProvinceDi;

/**
 * <T>数据库逻辑包(CM_AREA_PROVINCE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmAreaProvinceImpl
      extends FAbstractLogicUnit
      implements
         ICmAreaProvinceDi
{
   public final String LOGIC_NAME = "CM_AREA_PROVINCE_DI";

   public FCmAreaProvinceImpl(){
   }

   public FCmAreaProvinceImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmAreaProvinceDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmAreaProvinceDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmAreaProvinceDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction containsIdByLink(Object areaId,
                                        Object provinceId){
      FSqlFunction function = new FSqlFunction("Contains_Id_By_Link");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("area_id_", areaId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.createParameter("province_id_", provinceId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Boolean);
      activeConnection().execute(function);
      return function;
   }
    ...
    */
   @Override
   public FSqlFunction getIdByLink(Object areaId,
                                   Object provinceId){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmAreaProvinceDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction findIdByLink(Object areaId,
                                    Object provinceId,
                                    Object exists){
    ...
    */
   @Override
   public FSqlFunction getAreaId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Area_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmAreaProvinceDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
