...
import org.mo.logic.data.ICmLanguageDi;

/**
 * <T>数据库逻辑包(CM_LANGUAGE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmLanguageImpl
      extends FAbstractLogicUnit
      implements
         ICmLanguageDi
{
   public final String LOGIC_NAME = "CM_LANGUAGE_DI";

   public FCmLanguageImpl(){
   }

   public FCmLanguageImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmLanguageDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmLanguageDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmLanguageDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmLanguageDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmLanguageDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
