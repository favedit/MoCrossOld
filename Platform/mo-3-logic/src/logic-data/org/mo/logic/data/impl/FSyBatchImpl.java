...
import org.mo.logic.data.ISyBatchDi;

/**
 * <T>数据库逻辑包(SY_BATCH_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyBatchImpl
      extends FAbstractLogicUnit
      implements
         ISyBatchDi
{
   public final String LOGIC_NAME = "SY_BATCH_DI";

   public FSyBatchImpl(){
   }

   public FSyBatchImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBatchDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBatchDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBatchDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlProcedure doProcess(Object logic,
                                  Object code){
      FSqlProcedure procedure = new FSqlProcedure("Do_Process");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBatchDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBatchDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
