...
/**
 * <T>数据库逻辑包(CM_NATIONALITY_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ICmNationalityDi
      extends
         ILogicUnit
{
   /**
    ...
    * @return 记录对象
    */
   FSqlFunction getIdByFullLabel(Object fullLabel);
   ...
   /**
    * <T>根据中文简称(<C>LABEL</C>)获得当前记录的编号</T>
    * <UL>
    * <L>若存在则返回被查询的记录对象的唯一标识。</L>
    * <L>如果记录不存在，则产生记录不存在的例外。</L>
    * </UL>
   ...
   /**
    * <T>根据中文简称(<C>LABEL</C>)查找当前记录的编号</T>
    *
    * @param label 中文简称
    * @param exists 存在标志
    * @return 对象标识
   ...
   /**
    * <T>根据记录的编号查找名族人口(<C>POPULATION</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 名族人口
    */
