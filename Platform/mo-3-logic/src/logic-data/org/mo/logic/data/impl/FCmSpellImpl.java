...
import org.mo.logic.data.ICmSpellDi;

/**
 * <T>数据库逻辑包(CM_SPELL_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmSpellImpl
      extends FAbstractLogicUnit
      implements
         ICmSpellDi
{
   public final String LOGIC_NAME = "CM_SPELL_DI";

   public FCmSpellImpl(){
   }

   public FCmSpellImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmSpellDi(java.lang.Object)
    */
   @Override
   public FSqlFunction findSimpleSpell(Object label){
      FSqlFunction function = new FSqlFunction("Find_Simple_Spell");
    ...
    */
   @Override
   public FSqlFunction findFullSpell(Object label){
      FSqlFunction function = new FSqlFunction("Find_Full_Spell");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("label_", label, ESqlDataType.String, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmSpellDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmSpellDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getSpell(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Spell");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmSpellDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmSpellDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
