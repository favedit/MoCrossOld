...
/**
 * <T>数据库逻辑包(LG_SCHEDULE_GROUP_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ILgScheduleGroupDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>计划配置同步开始时的处理，主要功能是把所有的记录都设置为无效状态。</T>
    *
    * @param logic 业务逻辑
    * @param code
    */
   FSqlProcedure doSyncGroupBegin(Object logic,
                                  Object code);
   ...
   /**
    * <T>计划配置同步结束时的处理，主要功能是把所有无效的记录都删除。</T>
    *
    * @param logic 业务逻辑
    * @param code
    */
   FSqlProcedure doSyncGroupEnd(Object logic,
                                Object code);
