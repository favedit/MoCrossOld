...
/**
 * <T>数据库逻辑包(LG_TASK_CDT_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgTaskCdtImpl
      extends FAbstractLogicUnit
      implements
         ILgTaskCdtDi
{
   public final String LOGIC_NAME = "LG_TASK_CDT_DI";

   public FLgTaskCdtImpl(){
   }

   public FLgTaskCdtImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskCdtDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskCdtDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskCdtDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskCdtDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskCdtDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
