...
import org.mo.logic.data.ISyModuleTypeDi;

/**
 * <T>数据库逻辑包(SY_MODULE_TYPE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyModuleTypeImpl
      extends FAbstractLogicUnit
      implements
         ISyModuleTypeDi
{
   public final String LOGIC_NAME = "SY_MODULE_TYPE_DI";

   public FSyModuleTypeImpl(){
   }

   public FSyModuleTypeImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleTypeDi()
    */
   @Override
   public FSqlFunction getDefaultTypeId(){
      FSqlFunction function = new FSqlFunction("Get_Default_Type_Id");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleTypeDi(java.lang.Object)
    */
   @Override
   public FSqlFunction getActionsLabel(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Actions_Label");
      function.setLogicName(LOGIC_NAME);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleTypeDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getIsTop(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Is_Top");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleTypeDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleTypeDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
