...
import org.mo.logic.data.ICpConstants;

/**
 * <T>数据库逻辑包(CP_CONSTANTS)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCpConstantsImpl
      extends MSqlConnect
      implements
         ICpConstants
{
   public final String LOGIC_NAME = "CP_CONSTANTS";

   public FCpConstantsImpl(){
   }

   public FCpConstantsImpl(ISqlConnect connect){
      super(connect);
   }
