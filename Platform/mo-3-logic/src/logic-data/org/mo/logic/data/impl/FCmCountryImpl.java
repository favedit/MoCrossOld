...
import org.mo.logic.data.ICmCountryDi;

/**
 * <T>数据库逻辑包(CM_COUNTRY_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmCountryImpl
      extends FAbstractLogicUnit
      implements
         ICmCountryDi
{
   public final String LOGIC_NAME = "CM_COUNTRY_DI";

   public FCmCountryImpl(){
   }

   public FCmCountryImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCountryDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCountryDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCountryDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getContinentCd(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Continent_Cd");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getContinentLabel(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Continent_Label");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getTimeZone(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Time_Zone");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlProcedure testCommond(Object logic,
                                    Object params){
      FSqlProcedure procedure = new FSqlProcedure("Test_Commond");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCountryDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCountryDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
