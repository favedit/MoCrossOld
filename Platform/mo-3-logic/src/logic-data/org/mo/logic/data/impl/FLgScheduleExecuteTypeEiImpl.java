/*
 * @(#)FLgScheduleExecuteTypeEiImpl.java
 *
...
import org.mo.logic.data.ILgScheduleExecuteTypeEi;

/**
 * <T>数据库逻辑包(LG_SCHEDULE_EXECUTE_TYPE_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgScheduleExecuteTypeEiImpl
      extends MSqlConnect
      implements
         ILgScheduleExecuteTypeEi
{
   public final String LOGIC_NAME = "LG_SCHEDULE_EXECUTE_TYPE_EI";

   public FLgScheduleExecuteTypeEiImpl(){
   }

   public FLgScheduleExecuteTypeEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleExecuteTypeEi(java.lang.Object)
    */
   @Override
