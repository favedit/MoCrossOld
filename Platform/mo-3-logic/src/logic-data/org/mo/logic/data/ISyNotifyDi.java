...
/**
 * <T>数据库逻辑包(SY_NOTIFY_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyNotifyDi
      extends
         ILogicUnit
{
   /**
    * <T>作为分派获取消息函数的中转器函数</T>
    *
    * @param userId
    * @param groupId
    * @param count
    * @return 记录对象
    */
   FSqlFunction getNotifyGroupPack(Object userId,
                                   Object groupId,
                                   Object count);
    ...
    * @return 打包字符串
    */
   FSqlFunction getNotifyPack(Object userId);
   ...
   /**
    * <T>根据记录的编号查找发送者标识(<C>SENDER_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 发送者标识
    */
   ...
   /**
    * <T>根据记录的编号查找发送时间(<C>CREATE_DATE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 发送时间
    */
   ...
   /**
    * <T>根据记录的编号查找消息内容(<C>PARAMETERS</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 消息内容
    */
