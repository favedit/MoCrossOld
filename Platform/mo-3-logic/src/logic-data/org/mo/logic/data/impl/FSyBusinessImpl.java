...
import org.mo.logic.data.ISyBusinessDi;

/**
 * <T>数据库逻辑包(SY_BUSINESS_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyBusinessImpl
      extends FAbstractLogicUnit
      implements
         ISyBusinessDi
{
   public final String LOGIC_NAME = "SY_BUSINESS_DI";

   public FSyBusinessImpl(){
   }

   public FSyBusinessImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBusinessDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBusinessDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBusinessDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBusinessDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBusinessDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
