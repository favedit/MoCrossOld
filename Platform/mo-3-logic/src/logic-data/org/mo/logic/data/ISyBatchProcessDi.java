...
/**
 * <T>数据库逻辑包(SY_BATCH_PROCESS_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyBatchProcessDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找批处理标识(<C>BATCH_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 批处理标识
    */
   FSqlFunction getBatchId(Object objectId);
   ...
   /**
    * <T>根据记录的编号查找结束类型(<C>RESULT_CD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 结束类型
    */
   ...
   /**
    * <T>根据记录的编号查找结束类型(<C>RESULT_CD</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 结束类型
    */
   ...
   /**
    * <T>根据记录的编号查找错误代码(<C>ERROR_CODE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 错误代码
    */
   FSqlFunction getErrorCode(Object objectId);

   /**
    * <T>根据记录的编号查找错误消息(<C>ERROR_MESSAGE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 错误消息
    */
   FSqlFunction getErrorMessage(Object objectId);
