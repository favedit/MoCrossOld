...
import org.mo.logic.data.ISyNetworkServerTypeDi;

/**
 * <T>数据库逻辑包(SY_NETWORK_SERVER_TYPE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyNetworkServerTypeImpl
      extends FAbstractLogicUnit
      implements
         ISyNetworkServerTypeDi
{
   public final String LOGIC_NAME = "SY_NETWORK_SERVER_TYPE_DI";

   public FSyNetworkServerTypeImpl(){
   }

   public FSyNetworkServerTypeImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkServerTypeDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkServerTypeDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkServerTypeDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getDisplayOrder(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Display_Order");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkServerTypeDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNetworkServerTypeDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
