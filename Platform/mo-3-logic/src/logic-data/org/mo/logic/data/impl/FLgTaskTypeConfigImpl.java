...
/**
 * <T>数据库逻辑包(LG_TASK_TYPE_CONFIG_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgTaskTypeConfigImpl
      extends FAbstractLogicUnit
      implements
         ILgTaskTypeConfigDi
{
   public final String LOGIC_NAME = "LG_TASK_TYPE_CONFIG_DI";

   public FLgTaskTypeConfigImpl(){
   }

   public FLgTaskTypeConfigImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskTypeConfigDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskTypeConfigDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskTypeConfigDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskTypeConfigDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskTypeConfigDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
