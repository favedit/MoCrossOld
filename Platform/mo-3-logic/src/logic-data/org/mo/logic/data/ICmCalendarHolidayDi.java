...
/**
 * <T>数据库逻辑包(CM_CALENDAR_HOLIDAY_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ICmCalendarHolidayDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找假日类型(<C>TYPE_CD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 假日类型
    */
   ...
   /**
    * <T>根据记录的编号查找假日类型(<C>TYPE_CD</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 假日类型
    */
   ...
   /**
    * <T>根据记录的编号查找描述(<C>NOTE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 描述
    */
