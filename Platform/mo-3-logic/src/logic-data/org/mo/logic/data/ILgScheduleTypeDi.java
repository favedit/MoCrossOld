...
/**
 * <T>数据库逻辑包(LG_SCHEDULE_TYPE_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ILgScheduleTypeDi
      extends
         ILogicUnit
{
   /**
    ...
    * @return 打包字符串
    */
   FSqlFunction findProperties(Object typeId);
   ...
   @return 对象标识
    */
   FSqlFunction containsIdByCode(Object groupId,
                                 Object code);
    ...
    * @return 对象标识
    */
   FSqlFunction getIdByCode(Object groupId,
                            Object code);
    ...
    * @return 对象标识
    */
   FSqlFunction findIdByCode(Object groupId,
                             Object code,
                             Object exists);
