...
/**
 * <T>数据库逻辑包(SY_MODULE_VALUE_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyModuleValueDi
      extends
         ILogicUnit
{
   /**
   ...
   @return 对象标识
    */
   FSqlFunction containsIdByName(Object moduleId,
                                 Object name);
    ...
    * @return 对象标识
    */
   FSqlFunction getIdByName(Object moduleId,
                            Object name);
    ...
    * @return 对象标识
    */
   FSqlFunction findIdByName(Object moduleId,
                             Object name,
                             Object exists);
   ...
   /**
    * <T>根据记录的编号查找模块标识(<C>MODULE_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 模块标识
    */
   ...
   /**
    * <T>根据记录的编号查找属性名称(<C>NAME</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 属性名称
    */
   ...
   /**
    * <T>根据记录的编号查找属性内容(<C>DATA_VALUE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 属性内容
    */
