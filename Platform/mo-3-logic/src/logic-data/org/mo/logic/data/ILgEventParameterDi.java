...
/**
 * <T>数据库逻辑包(LG_EVENT_PARAMETER_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ILgEventParameterDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找参数名称(<C>NAME</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 参数名称
    */
   ...
   /**
    * <T>根据记录的编号查找数据类型(<C>TYPE_CD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 数据类型
    */
   ...
   /**
    * <T>根据记录的编号查找数据类型(<C>TYPE_CD</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 数据类型
    */
   ...
   /**
    * <T>根据记录的编号查找行数(<C>LINE_NUMBER</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 行数
    */
   FSqlFunction getLineNumber(Object objectId);
