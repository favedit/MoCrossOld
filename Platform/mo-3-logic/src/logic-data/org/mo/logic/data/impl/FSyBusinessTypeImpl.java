...
import org.mo.logic.data.ISyBusinessTypeDi;

/**
 * <T>数据库逻辑包(SY_BUSINESS_TYPE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyBusinessTypeImpl
      extends FAbstractLogicUnit
      implements
         ISyBusinessTypeDi
{
   public final String LOGIC_NAME = "SY_BUSINESS_TYPE_DI";

   public FSyBusinessTypeImpl(){
   }

   public FSyBusinessTypeImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBusinessTypeDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBusinessTypeDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBusinessTypeDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBusinessTypeDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyBusinessTypeDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
