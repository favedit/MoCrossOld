...
/**
 * <T>数据库逻辑包(CM_SPELL_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ICmSpellDi
      extends
         ILogicUnit
{
   /**
    ...
    * @return
    */
   FSqlFunction findSimpleSpell(Object label);
    ...
    * @return
    */
   FSqlFunction findFullSpell(Object label);
   ...
   @return 对象标识
    */
   FSqlFunction containsIdByLabel(Object label);
   ...
   /**
    * <T>根据中文名称(<C>LABEL</C>)获得当前记录的编号</T>
    * <UL>
    * <L>若存在则返回被查询的记录对象的唯一标识。</L>
    * <L>如果记录不存在，则产生记录不存在的例外。</L>
    * </UL>
    ...
    * @return 对象标识
    */
   FSqlFunction getIdByLabel(Object label);
   ...
   /**
    * <T>根据中文名称(<C>LABEL</C>)查找当前记录的编号</T>
    *
    * @param label 中文名称
    * @param exists 存在标志
    * @return 对象标识
    */
   FSqlFunction findIdByLabel(Object label,
                              Object exists);
   ...
   /**
    * <T>根据记录的编号查找拼写类型(<C>TYPE_CD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 拼写类型
    */
   ...
   /**
    * <T>根据记录的编号查找编号(<C>CODE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 编号
    */
   ...
   /**
    * <T>根据记录的编号查找拼写(<C>SPELL</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 拼写
    */
   FSqlFunction getSpell(Object objectId);
