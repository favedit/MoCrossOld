/*
 * @(#)FSyInformationFeedbackImpl.java
 *
...
import org.mo.logic.data.ISyInformationFeedbackDi;

/**
 * <T>数据库逻辑包(SY_INFORMATION_FEEDBACK_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyInformationFeedbackImpl
      extends FAbstractLogicUnit
      implements
         ISyInformationFeedbackDi
{
   public final String LOGIC_NAME = "SY_INFORMATION_FEEDBACK_DI";

   public FSyInformationFeedbackImpl(){
   }

   public FSyInformationFeedbackImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyInformationFeedbackDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyInformationFeedbackDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyInformationFeedbackDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getTitle(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Title");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getStatus(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Status");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyInformationFeedbackDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyInformationFeedbackDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
