...
import org.mo.logic.data.ICmCalendarWorkdayDi;

/**
 * <T>数据库逻辑包(CM_CALENDAR_WORKDAY_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmCalendarWorkdayImpl
      extends FAbstractLogicUnit
      implements
         ICmCalendarWorkdayDi
{
   public final String LOGIC_NAME = "CM_CALENDAR_WORKDAY_DI";

   public FCmCalendarWorkdayImpl(){
   }

   public FCmCalendarWorkdayImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarWorkdayDi(java.lang.Object)
    */
   @Override
   public FSqlFunction getWorktime(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_WorkTime");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarWorkdayDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarWorkdayDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getCalendarId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Calendar_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getWeekdayCd(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Weekday_Cd");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getWeekdayLabel(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Weekday_Label");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getBeginTime(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Begin_Time");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
    ...
    */
   @Override
   public FSqlFunction getEndTime(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_End_Time");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.DateTime);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarWorkdayDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarWorkdayDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
