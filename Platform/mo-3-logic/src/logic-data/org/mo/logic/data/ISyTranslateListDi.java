...
/**
 * <T>数据库逻辑包(SY_TRANSLATE_LIST_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyTranslateListDi
      extends
         ILogicUnit
{
   /**
   ...
   @return 对象标识
    */
   FSqlFunction containsIdByLink(Object groupId,
                                 Object name);
    ...
    * @return 对象标识
    */
   FSqlFunction getIdByLink(Object groupId,
                            Object name);
    ...
    * @return 对象标识
    */
   FSqlFunction findIdByLink(Object groupId,
                             Object name,
                             Object exists);
