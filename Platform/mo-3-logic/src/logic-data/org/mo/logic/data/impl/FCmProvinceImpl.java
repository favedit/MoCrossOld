...
import org.mo.logic.data.ICmProvinceDi;

/**
 * <T>数据库逻辑包(CM_PROVINCE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmProvinceImpl
      extends FAbstractLogicUnit
      implements
         ICmProvinceDi
{
   public final String LOGIC_NAME = "CM_PROVINCE_DI";

   public FCmProvinceImpl(){
   }

   public FCmProvinceImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmProvinceDi(java.lang.Object)
    */
   @Override
   public FSqlFunction getCityCount(Object objectUid){
      FSqlFunction function = new FSqlFunction("Get_City_Count");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmProvinceDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmProvinceDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction containsIdByName(Object countryId,
                                        Object name){
      FSqlFunction function = new FSqlFunction("Contains_Id_By_Name");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("country_id_", countryId, ESqlDataType.Integer, ESqlDataDirection.In);
    ...
    */
   @Override
   public FSqlFunction getIdByName(Object countryId,
                                   Object name){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmProvinceDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction findIdByName(Object countryId,
                                    Object name,
                                    Object exists){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmProvinceDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
