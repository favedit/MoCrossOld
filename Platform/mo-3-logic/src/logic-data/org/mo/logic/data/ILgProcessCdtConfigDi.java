...
/**
 * <T>数据库逻辑包(LG_PROCESS_CDT_CONFIG_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ILgProcessCdtConfigDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找类型标识(<C>CONDITION_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 类型标识
    */
    ...
    * @param params 打包字符串
    */
   FSqlProcedure doSyncConditionConfig(Object logic,
                                       Object params);
