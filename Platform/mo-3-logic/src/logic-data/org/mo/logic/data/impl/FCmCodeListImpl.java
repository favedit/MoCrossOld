...
/**
 * <T>数据库逻辑包(CM_CODE_LIST_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmCodeListImpl
      extends FAbstractLogicUnit
      implements
         ICmCodeListDi
{
   public final String LOGIC_NAME = "CM_CODE_LIST_DI";

   public FCmCodeListImpl(){
   }

   public FCmCodeListImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCodeListDi(java.lang.Object)
    */
   @Override
   public FSqlFunction getCodeCount(Object objectUid){
      FSqlFunction function = new FSqlFunction("Get_Code_Count");
    ...
    */
   @Override
   public FSqlFunction getCodePack(Object codeListName){
      FSqlFunction function = new FSqlFunction("Get_Code_Pack");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("code_list_name_", codeListName, ESqlDataType.String, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCodeListDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCodeListDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlProcedure doSyncCodeListBegin(Object logic,
                                            Object name){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Code_List_Begin");
    ...
    */
   @Override
   public FSqlProcedure doSyncCodeListEnd(Object logic,
                                          Object name){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Code_List_End");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("name_", name, ESqlDataType.String, ESqlDataDirection.In);
      activeConnection().execute(procedure);
    ...
    */
   @Override
   public FSqlProcedure doSyncCodeList(Object logic,
                                       Object params){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Code_List");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCodeListDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCodeListDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
