...
/**
 * <T>数据库逻辑包(LG_SUBSCRIBE_ACTION_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ILgSubscribeActionDi
      extends
         ILogicUnit
{
   /**
    ...
    * <T>查询当前数据集中是否含有指定的编号。</T>
    *
    * @param subscribeId 订阅标识
    * @param actionId 订阅动作标识
    * @return 是否含有指定编号
   @return 对象标识
    */
   FSqlFunction containsIdByAction(Object subscribeId,
                                   Object actionId);
    ...
    * @return 对象标识
    */
   FSqlFunction getIdByAction(Object subscribeId,
                              Object actionId);
    ...
    * @return 对象标识
    */
   FSqlFunction findIdByAction(Object subscribeId,
                               Object actionId,
                               Object exists);
