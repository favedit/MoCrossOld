...
import org.mo.logic.data.ISyPropertyGroupHi;

/**
 * <T>数据库逻辑包(SY_PROPERTY_GROUP_HI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyPropertyGroupHiImpl
      extends MSqlConnect
      implements
         ISyPropertyGroupHi
{
   public final String LOGIC_NAME = "SY_PROPERTY_GROUP_HI";

   public FSyPropertyGroupHiImpl(){
   }

   public FSyPropertyGroupHiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyPropertyGroupHi()
    */
   @Override
