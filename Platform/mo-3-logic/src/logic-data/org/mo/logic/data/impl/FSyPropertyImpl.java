...
/**
 * <T>数据库逻辑包(SY_PROPERTY_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyPropertyImpl
      extends FAbstractLogicUnit
      implements
         ISyPropertyDi
{
   public final String LOGIC_NAME = "SY_PROPERTY_DI";

   public FSyPropertyImpl(){
   }

   public FSyPropertyImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyPropertyDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyPropertyDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyPropertyDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction containsIdByName(Object groupId,
                                        Object typeId,
                                        Object name){
    ...
    */
   @Override
   public FSqlFunction getIdByName(Object groupId,
                                   Object typeId,
                                   Object name){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyPropertyDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyPropertyDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction findIdByName(Object groupId,
                                    Object typeId,
                                    Object name,
                                    Object exists){
    ...
    */
   @Override
   public FSqlFunction getDataRequire(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Data_Require");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlProcedure doSyncProperty(Object logic,
                                       Object parameters){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Property");
