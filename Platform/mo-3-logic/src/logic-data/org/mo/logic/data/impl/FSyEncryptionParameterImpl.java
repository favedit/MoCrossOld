/*
 * @(#)FSyEncryptionParameterImpl.java
 *
...
/**
 * <T>数据库逻辑包(SY_ENCRYPTION_PARAMETER_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyEncryptionParameterImpl
      extends FAbstractLogicUnit
      implements
         ISyEncryptionParameterDi
{
   public final String LOGIC_NAME = "SY_ENCRYPTION_PARAMETER_DI";

   public FSyEncryptionParameterImpl(){
   }

   public FSyEncryptionParameterImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyEncryptionParameterDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction encode(Object logic,
                              Object params){
      FSqlFunction function = new FSqlFunction("Encode");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyEncryptionParameterDi(java.lang.Object)
    */
   @Override
   public FSqlFunction findParametersPack(Object key){
      FSqlFunction function = new FSqlFunction("Find_Parameters_Pack");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("key_", key, ESqlDataType.String, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
      return function;
   }
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyEncryptionParameterDi()
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction containsIdByEncryptionKey(Object encryptionKey){
      FSqlFunction function = new FSqlFunction("Contains_Id_By_Encryption_Key");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("encryption_key_", encryptionKey, ESqlDataType.String, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Boolean);
      activeConnection().execute(function);
      return function;
   }
    ...
    */
   @Override
   public FSqlFunction getIdByEncryptionKey(Object encryptionKey){
      FSqlFunction function = new FSqlFunction("Get_Id_By_Encryption_Key");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("encryption_key_", encryptionKey, ESqlDataType.String, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction findIdByEncryptionKey(Object encryptionKey,
                                             Object exists){
      FSqlFunction function = new FSqlFunction("Find_Id_By_Encryption_Key");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("encryption_key_", encryptionKey, ESqlDataType.String, ESqlDataDirection.In);
      function.createParameter("exists_", exists, ESqlDataType.Boolean, ESqlDataDirection.InOut);
      function.setReturnType(ESqlDataType.Integer);
    ...
    */
   @Override
   public FSqlFunction getEncryptionKey(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Encryption_Key");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getOverdueCount(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Overdue_Count");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getOverdueDate(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Overdue_Date");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
    ...
    */
   @Override
   public FSqlFunction getVisiteCount(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Visite_Count");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getVisiteDate(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Visite_Date");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.DateTime);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyEncryptionParameterDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlProcedure register(Object logic,
                                 Object key,
                                 Object params){
      FSqlProcedure procedure = new FSqlProcedure("Register");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("key_", key, ESqlDataType.String, ESqlDataDirection.Out);
    ...
    */
   @Override
   public FSqlProcedure unregister(Object logic,
                                   Object key){
      FSqlProcedure procedure = new FSqlProcedure("Unregister");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyEncryptionParameterDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
