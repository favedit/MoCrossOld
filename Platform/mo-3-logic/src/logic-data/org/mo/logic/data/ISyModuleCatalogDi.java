...
/**
 * <T>数据库逻辑包(SY_MODULE_CATALOG_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyModuleCatalogDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找节点类型(<C>NODE_TYPE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 节点类型
    */
   FSqlFunction getNodeType(Object objectId);
   ...
   /**
    * <T>根据记录的编号查找名称路径(<C>NAME_PATH</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 名称路径
    */
   ...
   /**
    * <T>根据记录的编号查找含有子(<C>HAS_CHILD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 含有子
    */
   ...
   /**
    * <T>根据记录的编号查找参数内容(<C>parameters</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 参数内容
    */
   ...
   /**
    * <T>根据记录的编号查找显示图标(<C>DISP_ICON</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 显示图标
    */
   FSqlFunction getDispIcon(Object objectId);
    ...
    */
   FSqlProcedure doSyncModule(Object logic,
                              Object parameters);
