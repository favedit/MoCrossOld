...
import org.mo.logic.data.ICmItemTypeEi;

/**
 * <T>数据库逻辑包(CM_ITEM_TYPE_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmItemTypeEiImpl
      extends MSqlConnect
      implements
         ICmItemTypeEi
{
   public final String LOGIC_NAME = "CM_ITEM_TYPE_EI";

   public FCmItemTypeEiImpl(){
   }

   public FCmItemTypeEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmItemTypeEi(java.lang.Object)
    */
   @Override
