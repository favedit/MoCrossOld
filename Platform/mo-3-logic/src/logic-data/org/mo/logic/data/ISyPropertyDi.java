...
/**
 * <T>数据库逻辑包(SY_PROPERTY_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyPropertyDi
      extends
         ILogicUnit
{
   /**
   ...
   @return 对象标识
    */
   FSqlFunction containsIdByName(Object groupId,
                                 Object typeId,
                                 Object name);
    ...
    * @return 对象标识
    */
   FSqlFunction getIdByName(Object groupId,
                            Object typeId,
                            Object name);
    ...
    * @return 对象标识
    */
   FSqlFunction findIdByName(Object groupId,
                             Object typeId,
                             Object name,
                             Object exists);
   ...
   /**
    * <T>根据记录的编号查找数据必须(<C>DATA_REQUIRE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 数据必须
    */
   FSqlFunction getDataRequire(Object objectId);
    ...
    * @param parameters
    */
   FSqlProcedure doSyncProperty(Object logic,
                                Object parameters);
