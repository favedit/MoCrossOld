...
import org.mo.logic.data.ILgSubscribeMessageDi;

/**
 * <T>数据库逻辑包(LG_SUBSCRIBE_MESSAGE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgSubscribeMessageImpl
      extends FAbstractLogicUnit
      implements
         ILgSubscribeMessageDi
{
   public final String LOGIC_NAME = "LG_SUBSCRIBE_MESSAGE_DI";

   public FLgSubscribeMessageImpl(){
   }

   public FLgSubscribeMessageImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeMessageDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeMessageDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeMessageDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeMessageDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeMessageDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
