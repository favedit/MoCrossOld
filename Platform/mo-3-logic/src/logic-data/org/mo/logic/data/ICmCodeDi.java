...
/**
 * <T>数据库逻辑包(CM_CODE_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ICmCodeDi
      extends
         ILogicUnit
{
   /**
    * <T>根据代码列表名称和代码数据内容，查找代码的名称。</T>
    *
    * @param codeListName 代码列表名称
    * @param code 代码
    * @return 代码的名称
    */
   FSqlFunction findLabel(Object codeListName,
                          Object code);
   ...
   @return 对象标识
    */
   FSqlFunction containsIdByValue(Object listId,
                                  Object dataValue);
    ...
    * @return 对象标识
    */
   FSqlFunction getIdByValue(Object listId,
                             Object dataValue);
    ...
    * @return 对象标识
    */
   FSqlFunction findIdByValue(Object listId,
                              Object dataValue,
                              Object exists);
   ...
   /**
    * <T>根据记录的编号查找列表标识(<C>LIST_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 列表标识
    */
   FSqlFunction getListId(Object objectId);
   ...
   /**
    * <T>根据记录的编号查找项目类型(<C>TYPE_CD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 项目类型
    */
   ...
   /**
    * <T>根据记录的编号查找项目类型(<C>TYPE_CD</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 项目类型
    */
   ...
   /**
    * <T>根据记录的编号查找数据类型(<C>DATA_TYPE_CD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 数据类型
    */
   FSqlFunction getDataTypeCd(Object objectId);

   /**
    * <T>根据记录的编号查找数据类型(<C>DATA_TYPE_CD</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 数据类型
    */
   FSqlFunction getDataTypeLabel(Object objectId);
    ...
    * @param code 元素内容
    */
   FSqlProcedure checkCode(Object codeList,
                           Object code);

   /**
    * <T>将打包字符串的内容解包后按照名称和一个指定的记录对象进行合并操作实现和前台同步的作用。</T>
    * <P>打包字符串的格式：
    * <L value='label'>代码的标签</L>
    * <L value='data_name'>代码的名称</L>
    * <L value='data_value'>代码的数据内容</L>
    * <L value='note'>代码的备注信息</L>
    * </P>
    *
    * @param logic 业务逻辑
    * @param params 打包字符串
    */
   FSqlProcedure doSyncCode(Object logic,
                            Object params);
