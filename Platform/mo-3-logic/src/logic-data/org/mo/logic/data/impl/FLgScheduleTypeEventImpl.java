...
/**
 * <T>数据库逻辑包(LG_SCHEDULE_TYPE_EVENT_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgScheduleTypeEventImpl
      extends FAbstractLogicUnit
      implements
         ILgScheduleTypeEventDi
{
   public final String LOGIC_NAME = "LG_SCHEDULE_TYPE_EVENT_DI";

   public FLgScheduleTypeEventImpl(){
   }

   public FLgScheduleTypeEventImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTypeEventDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction getIsValid(Object typeId,
                                  Object eventId){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTypeEventDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTypeEventDi()
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction containsIdByCode(Object typeId,
                                        Object code){
    ...
    */
   @Override
   public FSqlFunction getIdByCode(Object typeId,
                                   Object code){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTypeEventDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction findIdByCode(Object typeId,
                                    Object code,
                                    Object exists){
    ...
    */
   @Override
   public FSqlFunction getPriorityCd(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Priority_Cd");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getPriorityLabel(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Priority_Label");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlProcedure doSyncTypeEvent(Object logic,
                                        Object params){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Type_Event");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTypeEventDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
