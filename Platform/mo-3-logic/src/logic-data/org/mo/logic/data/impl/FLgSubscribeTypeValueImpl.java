/*
 * @(#)FLgSubscribeTypeValueImpl.java
 *
...
import org.mo.logic.data.ILgSubscribeTypeValueDi;

/**
 * <T>数据库逻辑包(LG_SUBSCRIBE_TYPE_VALUE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgSubscribeTypeValueImpl
      extends FAbstractLogicUnit
      implements
         ILgSubscribeTypeValueDi
{
   public final String LOGIC_NAME = "LG_SUBSCRIBE_TYPE_VALUE_DI";

   public FLgSubscribeTypeValueImpl(){
   }

   public FLgSubscribeTypeValueImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeTypeValueDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeTypeValueDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeTypeValueDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeTypeValueDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeTypeValueDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
