...
import org.mo.logic.data.ICmDataTypeEi;

/**
 * <T>数据库逻辑包(CM_DATA_TYPE_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmDataTypeEiImpl
      extends MSqlConnect
      implements
         ICmDataTypeEi
{
   public final String LOGIC_NAME = "CM_DATA_TYPE_EI";

   public FCmDataTypeEiImpl(){
   }

   public FCmDataTypeEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmDataTypeEi(java.lang.Object)
    */
   @Override
