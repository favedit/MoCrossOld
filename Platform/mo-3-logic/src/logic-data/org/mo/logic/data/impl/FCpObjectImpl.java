...
import org.mo.logic.data.ICpObject;

/**
 * <T>数据库逻辑包(CP_OBJECT)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCpObjectImpl
      extends MSqlConnect
      implements
         ICpObject
{
   public final String LOGIC_NAME = "CP_OBJECT";

   public FCpObjectImpl(){
   }

   public FCpObjectImpl(ISqlConnect connect){
      super(connect);
   }
