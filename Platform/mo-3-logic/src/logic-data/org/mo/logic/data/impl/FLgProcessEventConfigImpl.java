/*
 * @(#)FLgProcessEventConfigImpl.java
 *
...
/**
 * <T>数据库逻辑包(LG_PROCESS_EVENT_CONFIG_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgProcessEventConfigImpl
      extends FAbstractLogicUnit
      implements
         ILgProcessEventConfigDi
{
   public final String LOGIC_NAME = "LG_PROCESS_EVENT_CONFIG_DI";

   public FLgProcessEventConfigImpl(){
   }

   public FLgProcessEventConfigImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessEventConfigDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessEventConfigDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessEventConfigDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlProcedure doSyncEventConfig(Object logic,
                                          Object params){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Event_Config");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessEventConfigDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessEventConfigDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
