...
/**
 * <T>数据库逻辑包(SY_CATALOG_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyCatalogImpl
      extends FAbstractLogicUnit
      implements
         ISyCatalogDi
{
   public final String LOGIC_NAME = "SY_CATALOG_DI";

   public FSyCatalogImpl(){
   }

   public FSyCatalogImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyCatalogDi(java.lang.Object)
    */
   @Override
   public FSqlFunction getChildCount(Object catalogId){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyCatalogDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction getMenuPack(Object userId,
                                   Object catalogId){
      FSqlFunction function = new FSqlFunction("Get_Menu_Pack");
      function.setLogicName(LOGIC_NAME);
    ...
    */
   @Override
   public FSqlFunction hasPermission(Object userId,
                                     Object catalogCode){
      FSqlFunction function = new FSqlFunction("Has_Permission");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("user_id_", userId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.createParameter("catalog_code_", catalogCode, ESqlDataType.String, ESqlDataDirection.In);
    ...
    */
   @Override
   public FSqlFunction getPermissionPack(Object userId,
                                         Object catalogCode){
      FSqlFunction function = new FSqlFunction("Get_Permission_Pack");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("user_id_", userId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.createParameter("catalog_code_", catalogCode, ESqlDataType.String, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyCatalogDi()
    */
   @Override
    ...
    */
   @Override
   public FSqlProcedure doSyncCatalogBefore(Object logic,
                                            Object parameters){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Catalog_Before");
    ...
    */
   @Override
   public FSqlProcedure doSyncCatalog(Object logic,
                                      Object parameters){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Catalog");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("parameters_", parameters, ESqlDataType.String, ESqlDataDirection.InOut);
      activeConnection().execute(procedure);
    ...
    */
   @Override
   public FSqlProcedure doSyncCatalogAfter(Object logic,
                                           Object parameters){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Catalog_After");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("parameters_", parameters, ESqlDataType.String, ESqlDataDirection.InOut);
      activeConnection().execute(procedure);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyCatalogDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyCatalogDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
