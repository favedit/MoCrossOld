...
/**
 * <T>数据库逻辑包(SY_INFORMATION_FEEDBACK_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyInformationFeedbackDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找标题(<C>TITLE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 标题
    */
   FSqlFunction getTitle(Object objectId);

   /**
    * <T>根据记录的编号查找反馈内容(<C>CONTENT</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 反馈内容
    */
   ...
   /**
    * <T>根据记录的编号查找状态(<C>STATUS</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 状态
    */
   FSqlFunction getStatus(Object objectId);
