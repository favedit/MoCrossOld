...
/**
 * <T>数据库逻辑包(LG_PROCESS_CDT_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgProcessCdtImpl
      extends FAbstractLogicUnit
      implements
         ILgProcessCdtDi
{
   public final String LOGIC_NAME = "LG_PROCESS_CDT_DI";

   public FLgProcessCdtImpl(){
   }

   public FLgProcessCdtImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessCdtDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessCdtDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessCdtDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction containsIdByLink(Object typeId,
                                        Object name){
    ...
    */
   @Override
   public FSqlFunction getIdByLink(Object typeId,
                                   Object name){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessCdtDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction findIdByLink(Object typeId,
                                    Object name,
                                    Object exists){
    ...
    */
   @Override
   public FSqlFunction getProcessCheck(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Process_Check");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlProcedure doSyncProcessCondition(Object logic,
                                               Object params){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Process_Condition");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessCdtDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
