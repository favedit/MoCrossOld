...
import org.mo.logic.data.ILgProcessStatusEi;

/**
 * <T>数据库逻辑包(LG_PROCESS_STATUS_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgProcessStatusEiImpl
      extends MSqlConnect
      implements
         ILgProcessStatusEi
{
   public final String LOGIC_NAME = "LG_PROCESS_STATUS_EI";

   public FLgProcessStatusEiImpl(){
   }

   public FLgProcessStatusEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessStatusEi(java.lang.Object)
    */
   @Override
