...
import org.mo.logic.data.ILgTaskValueDi;

/**
 * <T>数据库逻辑包(LG_TASK_VALUE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgTaskValueImpl
      extends FAbstractLogicUnit
      implements
         ILgTaskValueDi
{
   public final String LOGIC_NAME = "LG_TASK_VALUE_DI";

   public FLgTaskValueImpl(){
   }

   public FLgTaskValueImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskValueDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskValueDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskValueDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskValueDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgTaskValueDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
