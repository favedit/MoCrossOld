/*
 * @(#)FSystemNotifyStatusEiImpl.java
 *
...
import org.mo.logic.data.ISystemNotifyStatusEi;

/**
 * <T>数据库逻辑包(SYSTEM_NOTIFY_STATUS_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSystemNotifyStatusEiImpl
      extends MSqlConnect
      implements
         ISystemNotifyStatusEi
{
   public final String LOGIC_NAME = "SYSTEM_NOTIFY_STATUS_EI";

   public FSystemNotifyStatusEiImpl(){
   }

   public FSystemNotifyStatusEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISystemNotifyStatusEi(java.lang.Object)
    */
   @Override
