...
/**
 * <T>数据库逻辑包(SY_NETWORK_SERVER_TYPE_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyNetworkServerTypeDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找图片标识(<C>ICON_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 图片标识
    */
   ...
   /**
    * <T>根据记录的编号查找显示顺序(<C>DISPLAY_ORDER</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 显示顺序
    */
   FSqlFunction getDisplayOrder(Object objectId);
