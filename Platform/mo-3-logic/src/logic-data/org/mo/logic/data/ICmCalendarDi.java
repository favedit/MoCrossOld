...
/**
 * <T>数据库逻辑包(CM_CALENDAR_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ICmCalendarDi
      extends
         ILogicUnit
{
   /**
    ...
    * @return
    */
   FSqlFunction checkTimeScale(Object calendarId,
                               Object beginTime,
                               Object endTime);
    ...
    * @return
    */
   FSqlFunction getRestMinuteLength(Object calendarId,
                                    Object beginDate,
                                    Object endDate);
    ...
    * <T>获得该日历下的工作天数</T>
    *
    * @param objectId 日历的编号
    * @return
    */
   FSqlFunction getWorkDays(Object objectId);
    ...
    * @return
    */
   FSqlFunction getWeekendDays(Object objectId);
    ...
    * @return
    */
   FSqlFunction getHolidayDays(Object objectId);
    ...
    * @return
    */
   FSqlFunction isWeekend(Object objectId,
                          Object value);
    ...
    * @return
    */
   FSqlFunction isHoliday(Object calendarId,
                          Object beginTime,
                          Object endTime);

   /**
    * <T>得到指定日历下的平均每天工作时间。</T>
    *
    * @param calendarId
    * @return
    */
   FSqlFunction getDayHours(Object calendarId);
    ...
    * @return
    */
   FSqlFunction getDefaultCalendar();
   ...
   /**
    * <T>根据记录的编号查找默认(<C>IS_DEFAULT</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 默认
    */
   ...
   /**
    * <T>根据记录的编号查找开始日期(<C>BEGIN_DATE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 开始日期
    */
   ...
   /**
    * <T>根据记录的编号查找结束日期(<C>END_DATE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 结束日期
    */
    ...
    * @param endTime
    */
   FSqlProcedure doInsertTimespan(Object logic,
                                  Object calendarId,
                                  Object date,
                                  Object beginTime,
                                  Object endTime);
