...
/**
 * <T>数据库逻辑包(SY_PROPERTY_GROUP_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyPropertyGroupImpl
      extends FAbstractLogicUnit
      implements
         ISyPropertyGroupDi
{
   public final String LOGIC_NAME = "SY_PROPERTY_GROUP_DI";

   public FSyPropertyGroupImpl(){
   }

   public FSyPropertyGroupImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyPropertyGroupDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyPropertyGroupDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyPropertyGroupDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyPropertyGroupDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyPropertyGroupDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
