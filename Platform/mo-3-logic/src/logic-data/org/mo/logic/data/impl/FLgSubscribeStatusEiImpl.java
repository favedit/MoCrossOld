...
import org.mo.logic.data.ILgSubscribeStatusEi;

/**
 * <T>数据库逻辑包(LG_SUBSCRIBE_STATUS_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgSubscribeStatusEiImpl
      extends MSqlConnect
      implements
         ILgSubscribeStatusEi
{
   public final String LOGIC_NAME = "LG_SUBSCRIBE_STATUS_EI";

   public FLgSubscribeStatusEiImpl(){
   }

   public FLgSubscribeStatusEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeStatusEi(java.lang.Object)
    */
   @Override
