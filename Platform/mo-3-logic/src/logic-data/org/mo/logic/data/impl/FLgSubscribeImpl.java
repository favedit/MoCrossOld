...
/**
 * <T>数据库逻辑包(LG_SUBSCRIBE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgSubscribeImpl
      extends FAbstractLogicUnit
      implements
         ILgSubscribeDi
{
   public final String LOGIC_NAME = "LG_SUBSCRIBE_DI";

   public FLgSubscribeImpl(){
   }

   public FLgSubscribeImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlProcedure doSubscribe(Object logic,
                                    Object userId,
                                    Object typeId,
                                    Object linkId,
                                    Object pack){
      FSqlProcedure procedure = new FSqlProcedure("Do_Subscribe");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("user_id_", userId, ESqlDataType.Integer, ESqlDataDirection.In);
      procedure.createParameter("type_id_", typeId, ESqlDataType.Integer, ESqlDataDirection.In);
      procedure.createParameter("link_id_", linkId, ESqlDataType.Integer, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlProcedure doSubscribe(Object logic,
                                    Object userId,
      ...
      procedure.createParameter("type_id_", typeId, ESqlDataType.Integer, ESqlDataDirection.In);
      procedure.createParameter("link_id_", linkId, ESqlDataType.Integer, ESqlDataDirection.In);
      procedure.createParameter("action_id_", actionId, ESqlDataType.Integer, ESqlDataDirection.In);
      procedure.createParameter("pack_", pack, ESqlDataType.String, ESqlDataDirection.In);
      activeConnection().execute(procedure);
      return procedure;
   }
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlProcedure doSubscribe(Object logic,
                                    Object userId,
      ...
      procedure.createParameter("link_id_", linkId, ESqlDataType.Integer, ESqlDataDirection.In);
      procedure.createParameter("action_id_", actionId, ESqlDataType.Integer, ESqlDataDirection.In);
      procedure.createParameter("action_event_id_", actionEventId, ESqlDataType.Integer, ESqlDataDirection.In);
    ...
    */
   @Override
   public FSqlProcedure doPublish(Object logic,
                                  Object userId,
                                  Object typeName,
                                  Object actionName,
                                  Object linkId,
                                  Object parameters){
      FSqlProcedure procedure = new FSqlProcedure("Do_Publish");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("user_id_", userId, ESqlDataType.Integer, ESqlDataDirection.In);
      procedure.createParameter("type_name_", typeName, ESqlDataType.String, ESqlDataDirection.In);
      procedure.createParameter("action_name_", actionName, ESqlDataType.String, ESqlDataDirection.In);
      procedure.createParameter("link_id_", linkId, ESqlDataType.Integer, ESqlDataDirection.In);
      procedure.createParameter("parameters_", parameters, ESqlDataType.String, ESqlDataDirection.In);
      activeConnection().execute(procedure);
      return procedure;
