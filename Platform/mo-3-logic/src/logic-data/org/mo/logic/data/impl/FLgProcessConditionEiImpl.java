/*
 * @(#)FLgProcessConditionEiImpl.java
 *
...
import org.mo.logic.data.ILgProcessConditionEi;

/**
 * <T>数据库逻辑包(LG_PROCESS_CONDITION_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgProcessConditionEiImpl
      extends MSqlConnect
      implements
         ILgProcessConditionEi
{
   public final String LOGIC_NAME = "LG_PROCESS_CONDITION_EI";

   public FLgProcessConditionEiImpl(){
   }

   public FLgProcessConditionEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessConditionEi(java.lang.Object)
    */
   @Override
