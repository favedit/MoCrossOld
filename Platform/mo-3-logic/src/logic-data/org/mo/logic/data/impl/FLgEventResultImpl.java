...
import org.mo.logic.data.ILgEventResultDi;

/**
 * <T>数据库逻辑包(LG_EVENT_RESULT_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgEventResultImpl
      extends FAbstractLogicUnit
      implements
         ILgEventResultDi
{
   public final String LOGIC_NAME = "LG_EVENT_RESULT_DI";

   public FLgEventResultImpl(){
   }

   public FLgEventResultImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventResultDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventResultDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventResultDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventResultDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlProcedure doInsertResult(Object logic,
                                       Object eventId,
                                       Object parameters,
                                       Object typeCd){
      FSqlProcedure procedure = new FSqlProcedure("Do_Insert_Result");
      ...
      procedure.createParameter("type_cd_", typeCd, ESqlDataType.String, ESqlDataDirection.Out);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventResultDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
