...
/**
 * <T>数据库逻辑包(LG_SCHEDULE_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ILgScheduleDi
      extends
         ILogicUnit
{
   /**
    ...
    * @return 打包字符串
    */
   FSqlFunction findProperties(Object scheduleId);
   ...
   @return 对象标识
    */
   FSqlFunction containsIdByName(Object typeId,
                                 Object name);
    ...
    * @return 对象标识
    */
   FSqlFunction getIdByName(Object typeId,
                            Object name);
    ...
    * @return 对象标识
    */
   FSqlFunction findIdByName(Object typeId,
                             Object name,
                             Object exists);
   ...
   /**
    * <T>根据记录的编号查找计划状态(<C>STATUS_CD</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 计划状态
    */
   ...
   /**
    * <T>根据记录的编号查找计划开始时间(<C>BEGIN_DATE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 计划开始时间
    */
   ...
   /**
    * <T>根据记录的编号查找计划结束时间(<C>END_DATE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 计划结束时间
    */
   ...
   /**
    * <T>根据记录的编号查找用户标识(<C>CREATE_USER_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 用户标识
    */
    ...
    * @param params 打包字符串
    */
   FSqlProcedure doSyncSchedule(Object logic,
                                Object params);
    ...
    */
   FSqlProcedure doPublishOnce(Object logic,
                               Object typeCode,
    ...
    *
    * @param logic 业务逻辑
    * @param typeName 计划类型名称
    * @param parameters 打包字符串
    */
   FSqlProcedure doPublishMore(Object logic,
                               Object typeName,
                               Object parameters);

   /**
    * <T>新建一条记录的时候并对数据对象进行初始化</T>
    *
    * @param logic 业务逻辑
    * @param scheduleId
    * @param eventIds
