...
import org.mo.logic.data.ILgEventStatusEi;

/**
 * <T>数据库逻辑包(LG_EVENT_STATUS_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgEventStatusEiImpl
      extends MSqlConnect
      implements
         ILgEventStatusEi
{
   public final String LOGIC_NAME = "LG_EVENT_STATUS_EI";

   public FLgEventStatusEiImpl(){
   }

   public FLgEventStatusEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventStatusEi(java.lang.Object)
    */
   @Override
