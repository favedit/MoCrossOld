...
import org.mo.logic.data.ISyNotifyStatusEi;

/**
 * <T>数据库逻辑包(SY_NOTIFY_STATUS_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyNotifyStatusEiImpl
      extends MSqlConnect
      implements
         ISyNotifyStatusEi
{
   public final String LOGIC_NAME = "SY_NOTIFY_STATUS_EI";

   public FSyNotifyStatusEiImpl(){
   }

   public FSyNotifyStatusEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyStatusEi(java.lang.Object)
    */
   @Override
