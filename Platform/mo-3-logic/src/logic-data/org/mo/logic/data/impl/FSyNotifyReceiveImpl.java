...
import org.mo.logic.data.ISyNotifyReceiveDi;

/**
 * <T>数据库逻辑包(SY_NOTIFY_RECEIVE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyNotifyReceiveImpl
      extends FAbstractLogicUnit
      implements
         ISyNotifyReceiveDi
{
   public final String LOGIC_NAME = "SY_NOTIFY_RECEIVE_DI";

   public FSyNotifyReceiveImpl(){
   }

   public FSyNotifyReceiveImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyReceiveDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction checkIsContains(Object notifyId,
                                       Object userId){
      FSqlFunction function = new FSqlFunction("Check_Is_Contains");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("notify_id_", notifyId, ESqlDataType.Integer, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyReceiveDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyReceiveDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyReceiveDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyReceiveDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
