...
/**
 * <T>数据库逻辑包(CM_CALENDAR_DAY_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ICmCalendarDayDi
      extends
         ILogicUnit
{
   /**
    ...
    * @return 记录对象
    */
   FSqlFunction getWeekday(Object value);
   ...
   /**
    * <T>根据记录的编号查找日历标识(<C>CALENDAR_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 日历标识
    */
   ...
   /**
    * <T>根据记录的编号查找工作日(<C>WORK_DATE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 工作日
    */
   FSqlFunction getWorkDate(Object objectId);
   ...
   /**
    * <T>根据记录的编号查找注释(<C>NOTE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 注释
    */
