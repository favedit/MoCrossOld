...
/**
 * <T>数据库逻辑包(SY_TRANSLATE_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyTranslateDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找代码编号(<C>CODE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 代码编号
    */
   ...
   /**
    * <T>根据记录的编号查找代码类型(<C>TYPE_CD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 代码类型
    */
   ...
   /**
    * <T>根据记录的编号查找代码类型(<C>TYPE_CD</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 代码类型
    */
   ...
   /**
    * <T>根据记录的编号查找翻译状态(<C>STATUS_CD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 翻译状态
    */
   ...
   /**
    * <T>根据记录的编号查找翻译状态(<C>STATUS_CD</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 翻译状态
    */
   ...
   /**
    * <T>根据记录的编号查找内容(<C>CONTENT</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 内容
    */
   FSqlFunction getContent(Object objectId);
    ...
    * @param params 打包字符串
    */
   FSqlProcedure doSyncAll(Object logic,
                           Object params);
    ...
    * @param params 打包字符串
    */
   FSqlProcedure doSyncGroup(Object logic,
                             Object params);
    ...
    * @param params 打包字符串
    */
   FSqlProcedure doSyncList(Object logic,
                            Object params);
    ...
    * @param params 打包字符串
    */
   FSqlProcedure doSyncTranslate(Object logic,
                                 Object params);
    ...
    * @param params 打包字符串
    */
   FSqlProcedure doSyncContent(Object logic,
                               Object params);
    ...
    * @param params 打包字符串
    */
   FSqlProcedure doSyncParameter(Object logic,
                                 Object params);
