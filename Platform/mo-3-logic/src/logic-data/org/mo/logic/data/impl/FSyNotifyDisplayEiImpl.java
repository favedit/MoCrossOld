...
import org.mo.logic.data.ISyNotifyDisplayEi;

/**
 * <T>数据库逻辑包(SY_NOTIFY_DISPLAY_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyNotifyDisplayEiImpl
      extends MSqlConnect
      implements
         ISyNotifyDisplayEi
{
   public final String LOGIC_NAME = "SY_NOTIFY_DISPLAY_EI";

   public FSyNotifyDisplayEiImpl(){
   }

   public FSyNotifyDisplayEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyDisplayEi(java.lang.Object)
    */
   @Override
