...
/**
 * <T>数据库逻辑包(SY_MODULE_TYPE_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyModuleTypeDi
      extends
         ILogicUnit
{
   /**
    ...
    * @return 命令集合内容
    */
   FSqlFunction getActionsLabel(Object objectId);
   ...
   /**
    * <T>根据记录的编号查找是根类型(<C>IS_TOP</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 是根类型
    */
   FSqlFunction getIsTop(Object objectId);

   /**
    * <T>根据记录的编号查找有子类型(<C>HAS_CHILD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 有子类型
    */
