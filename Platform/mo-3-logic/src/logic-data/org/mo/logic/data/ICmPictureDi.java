...
/**
 * <T>数据库逻辑包(CM_PICTURE_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ICmPictureDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找标签(<C>LABEL</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 标签
    */
   ...
   /**
    * <T>根据记录的编号查找存储类型(<C>MIME_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 存储类型
    */
   ...
   /**
    * <T>根据记录的编号查找宽度(<C>DISP_WIDTH</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 宽度
    */
   FSqlFunction getDispWidth(Object objectId);

   /**
    * <T>根据记录的编号查找高度(<C>DISP_HEIGHT</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 高度
    */
   FSqlFunction getDispHeight(Object objectId);
