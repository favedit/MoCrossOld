...
import org.mo.logic.data.ICmCalendarHolidayDi;

/**
 * <T>数据库逻辑包(CM_CALENDAR_HOLIDAY_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmCalendarHolidayImpl
      extends FAbstractLogicUnit
      implements
         ICmCalendarHolidayDi
{
   public final String LOGIC_NAME = "CM_CALENDAR_HOLIDAY_DI";

   public FCmCalendarHolidayImpl(){
   }

   public FCmCalendarHolidayImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarHolidayDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarHolidayDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarHolidayDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarHolidayDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmCalendarHolidayDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
