...
import org.mo.logic.data.ILgProcessTaskDi;

/**
 * <T>数据库逻辑包(LG_PROCESS_TASK_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgProcessTaskImpl
      extends MSqlConnect
      implements
         ILgProcessTaskDi
{
   public final String LOGIC_NAME = "LG_PROCESS_TASK_DI";

   public FLgProcessTaskImpl(){
   }

   public FLgProcessTaskImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessTaskDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessTaskDi()
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getPreviewTaskId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Preview_Task_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessTaskDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessTaskDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgProcessTaskDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
