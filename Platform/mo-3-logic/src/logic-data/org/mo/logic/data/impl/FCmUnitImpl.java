...
import org.mo.logic.data.ICmUnitDi;

/**
 * <T>数据库逻辑包(CM_UNIT_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmUnitImpl
      extends FAbstractLogicUnit
      implements
         ICmUnitDi
{
   public final String LOGIC_NAME = "CM_UNIT_DI";

   public FCmUnitImpl(){
   }

   public FCmUnitImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmUnitDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmUnitDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmUnitDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmUnitDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmUnitDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
