...
import org.mo.logic.data.ILgEventPropertyDi;

/**
 * <T>数据库逻辑包(LG_EVENT_PROPERTY_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgEventPropertyImpl
      extends MSqlConnect
      implements
         ILgEventPropertyDi
{
   public final String LOGIC_NAME = "LG_EVENT_PROPERTY_DI";

   public FLgEventPropertyImpl(){
   }

   public FLgEventPropertyImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventPropertyDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction getIdByParams(Object typeId,
                                     Object name){
      FSqlFunction function = new FSqlFunction("Get_Id_By_Params");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventPropertyDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventPropertyDi()
    */
   @Override
    ...
    */
   @Override
   public FSqlProcedure syncProperty(Object logic,
                                     Object params){
      FSqlProcedure procedure = new FSqlProcedure("Sync_Property");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventPropertyDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventPropertyDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
