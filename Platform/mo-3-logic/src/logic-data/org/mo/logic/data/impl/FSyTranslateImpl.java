...
/**
 * <T>数据库逻辑包(SY_TRANSLATE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyTranslateImpl
      extends FAbstractLogicUnit
      implements
         ISyTranslateDi
{
   public final String LOGIC_NAME = "SY_TRANSLATE_DI";

   public FSyTranslateImpl(){
   }

   public FSyTranslateImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getListId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_List_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getContent(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Content");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlProcedure doSyncAll(Object logic,
                                  Object params){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_All");
    ...
    */
   @Override
   public FSqlProcedure doSyncGroup(Object logic,
                                    Object params){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Group");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("params_", params, ESqlDataType.String, ESqlDataDirection.InOut);
      activeConnection().execute(procedure);
    ...
    */
   @Override
   public FSqlProcedure doSyncList(Object logic,
                                   Object params){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_List");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("params_", params, ESqlDataType.String, ESqlDataDirection.InOut);
      activeConnection().execute(procedure);
    ...
    */
   @Override
   public FSqlProcedure doSyncTranslate(Object logic,
                                        Object params){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Translate");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("params_", params, ESqlDataType.String, ESqlDataDirection.InOut);
      activeConnection().execute(procedure);
    ...
    */
   @Override
   public FSqlProcedure doSyncContent(Object logic,
                                      Object params){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Content");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("params_", params, ESqlDataType.String, ESqlDataDirection.InOut);
      activeConnection().execute(procedure);
    ...
    */
   @Override
   public FSqlProcedure doSyncParameter(Object logic,
                                        Object params){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Parameter");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("params_", params, ESqlDataType.String, ESqlDataDirection.InOut);
      activeConnection().execute(procedure);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
