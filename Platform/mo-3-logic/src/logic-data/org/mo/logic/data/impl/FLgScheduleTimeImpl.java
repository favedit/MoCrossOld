...
/**
 * <T>数据库逻辑包(LG_SCHEDULE_TIME_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgScheduleTimeImpl
      extends FAbstractLogicUnit
      implements
         ILgScheduleTimeDi
{
   public final String LOGIC_NAME = "LG_SCHEDULE_TIME_DI";

   public FLgScheduleTimeImpl(){
   }

   public FLgScheduleTimeImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTimeDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTimeDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTimeDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction containsIdByCode(Object scheduleId,
                                        Object code){
    ...
    */
   @Override
   public FSqlFunction getIdByCode(Object scheduleId,
                                   Object code){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTimeDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction findIdByCode(Object scheduleId,
                                    Object code,
                                    Object exists){
    ...
    */
   @Override
   public FSqlFunction getScheduleId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Schedule_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getExecuteTime(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Execute_Time");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
    ...
    */
   @Override
   public FSqlFunction getTypeCd(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Type_Cd");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getTypeLabel(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Type_Label");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getInterval(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Interval");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getDayFlag(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Day_Flag");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getWeekFlag(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Week_Flag");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getMonthFlag(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Month_Flag");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlProcedure doSyncTime(Object logic,
                                   Object params){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Time");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgScheduleTimeDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
