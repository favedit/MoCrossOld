...
/**
 * <T>数据库逻辑包(SY_BATCH_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyBatchDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找组标识(<C>GROUP_ID</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 组标识
    */
   ...
   /**
    * <T>根据记录的编号查找执行调度(<C>DO_INVOKE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 执行调度
    */
   ...
   /**
    * <T>根据记录的编号查找最后处理参数(<C>PARAMETERS</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 最后处理参数
    */
   ...
   /**
    * <T>根据记录的编号查找结束时间(<C>END_DATE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 结束时间
    */
    ...
    * @param code 代码
    */
   FSqlProcedure doProcess(Object logic,
                           Object code);

   /**
    * <T>部署指定代码的一个批处理到事件队列。</T>
    *
    * @param logic 业务逻辑
    * @param params 参数打包字符串
    */
