...
import org.mo.logic.data.ICpEnv;

/**
 * <T>数据库逻辑包(CP_ENV)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCpEnvImpl
      extends MSqlConnect
      implements
         ICpEnv
{
   public final String LOGIC_NAME = "CP_ENV";

   public FCpEnvImpl(){
   }

   public FCpEnvImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICpEnv()
    */
   @Override
