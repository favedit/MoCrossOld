...
import org.mo.logic.data.ILgEventResultEi;

/**
 * <T>数据库逻辑包(LG_EVENT_RESULT_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgEventResultEiImpl
      extends MSqlConnect
      implements
         ILgEventResultEi
{
   public final String LOGIC_NAME = "LG_EVENT_RESULT_EI";

   public FLgEventResultEiImpl(){
   }

   public FLgEventResultEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventResultEi(java.lang.Object)
    */
   @Override
