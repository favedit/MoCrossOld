...
import org.mo.logic.data.ISyTranslateCodeEi;

/**
 * <T>数据库逻辑包(SY_TRANSLATE_CODE_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyTranslateCodeEiImpl
      extends MSqlConnect
      implements
         ISyTranslateCodeEi
{
   public final String LOGIC_NAME = "SY_TRANSLATE_CODE_EI";

   public FSyTranslateCodeEiImpl(){
   }

   public FSyTranslateCodeEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyTranslateCodeEi(java.lang.Object)
    */
   @Override
