...
import org.mo.logic.data.ISyCatalogRoleDi;

/**
 * <T>数据库逻辑包(SY_CATALOG_ROLE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyCatalogRoleImpl
      extends FAbstractLogicUnit
      implements
         ISyCatalogRoleDi
{
   public final String LOGIC_NAME = "SY_CATALOG_ROLE_DI";

   public FSyCatalogRoleImpl(){
   }

   public FSyCatalogRoleImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyCatalogRoleDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction getIsValid(Object nodeId,
                                  Object roleId){
      ...
      function.createParameter("role_id_", roleId, ESqlDataType.Integer, ESqlDataDirection.In);
    ...
    */
   @Override
   public FSqlFunction getIsGrant(Object nodeId,
                                  Object roleId){
      FSqlFunction function = new FSqlFunction("Get_Is_Grant");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("node_id_", nodeId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.createParameter("role_id_", roleId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
    ...
    */
   @Override
   public FSqlFunction getIsGrantAble(Object nodeId,
                                      Object userId){
      FSqlFunction function = new FSqlFunction("Get_Is_Grant_Able");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("node_id_", nodeId, ESqlDataType.Integer, ESqlDataDirection.In);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyCatalogRoleDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyCatalogRoleDi()
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction containsIdByLink(Object nodeId,
                                        Object roleId){
    ...
    */
   @Override
   public FSqlFunction getIdByLink(Object nodeId,
                                   Object roleId){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyCatalogRoleDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction findIdByLink(Object nodeId,
                                    Object roleId,
                                    Object exists){
    ...
    */
   @Override
   public FSqlFunction getNodeId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Node_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getRoleId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Role_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getIsGrant(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Is_Grant");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyCatalogRoleDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlProcedure doStoreLink(Object logic,
                                    Object params,
                                    Object objectId,
                                    Object check){
      FSqlProcedure procedure = new FSqlProcedure("Do_Store_Link");
