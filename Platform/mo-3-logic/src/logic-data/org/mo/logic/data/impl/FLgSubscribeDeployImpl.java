...
import org.mo.logic.data.ILgSubscribeDeployDi;

/**
 * <T>数据库逻辑包(LG_SUBSCRIBE_DEPLOY_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgSubscribeDeployImpl
      extends FAbstractLogicUnit
      implements
         ILgSubscribeDeployDi
{
   public final String LOGIC_NAME = "LG_SUBSCRIBE_DEPLOY_DI";

   public FLgSubscribeDeployImpl(){
   }

   public FLgSubscribeDeployImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeDeployDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeDeployDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeDeployDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getTypeEventId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Type_Event_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getSenderId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Sender_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getReceiverId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Receiver_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeDeployDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgSubscribeDeployDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
