...
/**
 * <T>数据库逻辑包(SY_NOTIFY_RECEIVER_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ISyNotifyReceiverDi
{
   /**
   ...
   /**
    * <T>根据记录的编号查找消息类型(<C>TYPE_CD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 消息类型
    */
   ...
   /**
    * <T>根据记录的编号查找消息类型(<C>TYPE_CD</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 消息类型
    */
