...
import org.mo.logic.data.ICmProvinceLevelEi;

/**
 * <T>数据库逻辑包(CM_PROVINCE_LEVEL_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmProvinceLevelEiImpl
      extends MSqlConnect
      implements
         ICmProvinceLevelEi
{
   public final String LOGIC_NAME = "CM_PROVINCE_LEVEL_EI";

   public FCmProvinceLevelEiImpl(){
   }

   public FCmProvinceLevelEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmProvinceLevelEi(java.lang.Object)
    */
   @Override
