...
import org.mo.logic.data.ISyNotifyReceiverDi;

/**
 * <T>数据库逻辑包(SY_NOTIFY_RECEIVER_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyNotifyReceiverImpl
      extends MSqlConnect
      implements
         ISyNotifyReceiverDi
{
   public final String LOGIC_NAME = "SY_NOTIFY_RECEIVER_DI";

   public FSyNotifyReceiverImpl(){
   }

   public FSyNotifyReceiverImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyReceiverDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyReceiverDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyReceiverDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getNotifyId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Notify_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyReceiverDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyReceiverDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
