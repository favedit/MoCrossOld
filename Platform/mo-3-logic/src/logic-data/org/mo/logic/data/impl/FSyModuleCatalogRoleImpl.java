...
import org.mo.logic.data.ISyModuleCatalogRoleDi;

/**
 * <T>数据库逻辑包(SY_MODULE_CATALOG_ROLE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyModuleCatalogRoleImpl
      extends FAbstractLogicUnit
      implements
         ISyModuleCatalogRoleDi
{
   public final String LOGIC_NAME = "SY_MODULE_CATALOG_ROLE_DI";

   public FSyModuleCatalogRoleImpl(){
   }

   public FSyModuleCatalogRoleImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleCatalogRoleDi(java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction getIsValid(Object catalogId,
                                  Object roleId){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleCatalogRoleDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleCatalogRoleDi()
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction containsIdByLink(Object catalogId,
                                        Object roleId){
    ...
    */
   @Override
   public FSqlFunction getIdByLink(Object catalogId,
                                   Object roleId){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleCatalogRoleDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction findIdByLink(Object catalogId,
                                    Object roleId,
                                    Object exists){
    ...
    */
   @Override
   public FSqlFunction getIsValidLabel(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Is_Valid_Label");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyModuleCatalogRoleDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
