...
import org.mo.logic.data.ISyNotifyReceiverEi;

/**
 * <T>数据库逻辑包(SY_NOTIFY_RECEIVER_EI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyNotifyReceiverEiImpl
      extends MSqlConnect
      implements
         ISyNotifyReceiverEi
{
   public final String LOGIC_NAME = "SY_NOTIFY_RECEIVER_EI";

   public FSyNotifyReceiverEiImpl(){
   }

   public FSyNotifyReceiverEiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyReceiverEi(java.lang.Object)
    */
   @Override
