...
import org.mo.logic.data.ISyNotifyDi;

/**
 * <T>数据库逻辑包(SY_NOTIFY_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyNotifyImpl
      extends FAbstractLogicUnit
      implements
         ISyNotifyDi
{
   public final String LOGIC_NAME = "SY_NOTIFY_DI";

   public FSyNotifyImpl(){
   }

   public FSyNotifyImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   public FSqlFunction getNotifyGroupPack(Object userId,
                                          Object groupId,
                                          Object count){
      FSqlFunction function = new FSqlFunction("Get_Notify_Group_Pack");
      ...
      function.createParameter("count_", count, ESqlDataType.Integer, ESqlDataDirection.InOut);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyDi(java.lang.Object)
    */
   @Override
   public FSqlFunction getNotifyPack(Object userId){
      FSqlFunction function = new FSqlFunction("Get_Notify_Pack");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("user_id_", userId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyNotifyDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
