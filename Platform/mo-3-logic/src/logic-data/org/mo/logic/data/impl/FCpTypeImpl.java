...
import org.mo.logic.data.ICpType;

/**
 * <T>数据库逻辑包(CP_TYPE)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCpTypeImpl
      extends MSqlConnect
      implements
         ICpType
{
   public final String LOGIC_NAME = "CP_TYPE";

   public FCpTypeImpl(){
   }

   public FCpTypeImpl(ISqlConnect connect){
      super(connect);
   }
