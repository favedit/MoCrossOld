...
/**
 * <T>数据库逻辑包(LG_EVENT_RESULT_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ILgEventResultDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找结果类型(<C>TYPE_CD</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 结果类型
    */
   ...
   /**
    * <T>根据记录的编号查找结果类型(<C>TYPE_CD</C>)的显示内容</T>
    *
    * @param objectId 记录的编号
    * @return 结果类型
    */
   ...
   /**
    * <T>根据记录的编号查找返回编号(<C>CODE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 返回编号
    */
   ...
   /**
    * <T>根据记录的编号查找返回参数(<C>PARAMETERS</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 返回参数
    */
    ...
    * @param typeCd
    */
   FSqlProcedure doInsertResult(Object logic,
                                Object eventId,
                                Object parameters,
                                Object typeCd);
