...
/**
 * <T>数据库逻辑包(CM_CURRENCY_DI)的代理对象接口</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public interface ICmCurrencyDi
      extends
         ILogicUnit
{
   /**
   ...
   /**
    * <T>根据记录的编号查找标准符号(<C>CODE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 标准符号
    */
   ...
   /**
    * <T>根据记录的编号查找汇率(<C>EXCHANGE_RATE</C>)的数据内容</T>
    *
    * @param objectId 记录的编号
    * @return 汇率
    */
   FSqlFunction getExchangeRate(Object objectId);
