...
import org.mo.logic.data.ISyPropertyHi;

/**
 * <T>数据库逻辑包(SY_PROPERTY_HI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FSyPropertyHiImpl
      extends MSqlConnect
      implements
         ISyPropertyHi
{
   public final String LOGIC_NAME = "SY_PROPERTY_HI";

   public FSyPropertyHiImpl(){
   }

   public FSyPropertyHiImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ISyPropertyHi()
    */
   @Override
