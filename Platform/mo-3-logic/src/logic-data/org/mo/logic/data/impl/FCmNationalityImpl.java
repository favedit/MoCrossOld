...
import org.mo.logic.data.ICmNationalityDi;

/**
 * <T>数据库逻辑包(CM_NATIONALITY_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmNationalityImpl
      extends FAbstractLogicUnit
      implements
         ICmNationalityDi
{
   public final String LOGIC_NAME = "CM_NATIONALITY_DI";

   public FCmNationalityImpl(){
   }

   public FCmNationalityImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmNationalityDi(java.lang.Object)
    */
   @Override
   public FSqlFunction getIdByFullLabel(Object fullLabel){
      FSqlFunction function = new FSqlFunction("Get_Id_By_Full_Label");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("full_label_", fullLabel, ESqlDataType.String, ESqlDataDirection.In);
    ...
    */
   @Override
   public FSqlFunction findExist(Object objectId){
      FSqlFunction function = new FSqlFunction("Find_Exist_");
      function.setLogicName(LOGIC_NAME);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmNationalityDi()
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction containsIdByLabel(Object label){
      FSqlFunction function = new FSqlFunction("Contains_Id_By_Label");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("label_", label, ESqlDataType.String, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Boolean);
      activeConnection().execute(function);
      return function;
   }
    ...
    */
   @Override
   public FSqlFunction getIdByLabel(Object label){
      FSqlFunction function = new FSqlFunction("Get_Id_By_Label");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("label_", label, ESqlDataType.String, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmNationalityDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction findIdByLabel(Object label,
                                     Object exists){
      FSqlFunction function = new FSqlFunction("Find_Id_By_Label");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("label_", label, ESqlDataType.String, ESqlDataDirection.In);
      function.createParameter("exists_", exists, ESqlDataType.Boolean, ESqlDataDirection.InOut);
      function.setReturnType(ESqlDataType.Integer);
    ...
    */
   @Override
   public FSqlFunction getCountryId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Country_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getFullLabel(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Full_Label");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmNationalityDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmNationalityDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
