...
/**
 * <T>数据库逻辑包(LG_EVENT_GROUP_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgEventGroupImpl
      extends FAbstractLogicUnit
      implements
         ILgEventGroupDi
{
   public final String LOGIC_NAME = "LG_EVENT_GROUP_DI";

   public FLgEventGroupImpl(){
   }

   public FLgEventGroupImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventGroupDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventGroupDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventGroupDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlProcedure doSyncGroupBegin(Object logic,
                                         Object name){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Group_Begin");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
    ...
    */
   @Override
   public FSqlProcedure doSyncGroupEnd(Object logic,
                                       Object name){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Group_End");
      procedure.setLogicName(LOGIC_NAME);
      procedure.createParameter("logic_", logic, ESqlDataType.String, ESqlDataDirection.InOut);
      procedure.createParameter("name_", name, ESqlDataType.String, ESqlDataDirection.In);
      activeConnection().execute(procedure);
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventGroupDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventGroupDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
