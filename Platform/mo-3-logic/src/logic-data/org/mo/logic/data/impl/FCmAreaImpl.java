...
import org.mo.logic.data.ICmAreaDi;

/**
 * <T>数据库逻辑包(CM_AREA_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FCmAreaImpl
      extends FAbstractLogicUnit
      implements
         ICmAreaDi
{
   public final String LOGIC_NAME = "CM_AREA_DI";

   public FCmAreaImpl(){
   }

   public FCmAreaImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmAreaDi(java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmAreaDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmAreaDi(java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmAreaDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ICmAreaDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
