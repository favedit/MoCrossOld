...
/**
 * <T>数据库逻辑包(LG_EVENT_TYPE_DI)的代理对象</T>
 *
 * @author MAOCY
 * @version 1.0.1
 */
public class FLgEventTypeImpl
      extends FAbstractLogicUnit
      implements
         ILgEventTypeDi
{
   public final String LOGIC_NAME = "LG_EVENT_TYPE_DI";

   public FLgEventTypeImpl(){
   }

   public FLgEventTypeImpl(ISqlConnect connect){
      super(connect);
   }

   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventTypeDi(java.lang.Object)
    */
   @Override
   public FSqlFunction getByCode(Object code){
      FSqlFunction function = new FSqlFunction("Get_By_Code");
    ...
    */
   @Override
   public FSqlFunction findConfigPack(Object objectId){
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventTypeDi()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventTypeDi(java.lang.Object, java.lang.Object)
    */
   @Override
    ...
    */
   @Override
   public FSqlFunction getServerId(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Server_Id");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.Integer);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getProcessCd(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Process_Cd");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getProcessLabel(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Process_Label");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlFunction getProcessInvoke(Object objectId){
      FSqlFunction function = new FSqlFunction("Get_Process_Invoke");
      function.setLogicName(LOGIC_NAME);
      function.createParameter("object_id_", objectId, ESqlDataType.Integer, ESqlDataDirection.In);
      function.setReturnType(ESqlDataType.String);
      activeConnection().execute(function);
    ...
    */
   @Override
   public FSqlProcedure doSyncType(Object logic,
                                   Object params){
      FSqlProcedure procedure = new FSqlProcedure("Do_Sync_Type");
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventTypeDi(java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.mo.logic.data.ILgEventTypeDi(java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object)
    */
   @Override
