...
// <T>参数对象。</T>
//============================================================
public class FAsParameter
      extends FAsObject
{
   protected FAsFunction _function;
   ...
   // @param function 函数
   //============================================================
   public void setFunction(FAsFunction function){
      _function = function;
   }
   ...
   // <T>构造参数对象。</T>
   //============================================================
   public void parse(FAsParserContent content, String line){
      ...
      FAsClass clazz = _function.ownerClass();
