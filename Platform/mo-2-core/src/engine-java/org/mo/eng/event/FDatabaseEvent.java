 ...
 */
public abstract class FDatabaseEvent
{
   //   /**
   //    * <p>执行业务的逻辑</p>
   ...
   //         throws FException{
   //      FDBConnection oConnection = FDatabaseManager.getInstance().allocateConnection("Event");
   //      if(oConnection == null){
   //         throw new FFatalException(this, "Allocate connection failed in event " + this);
   //      }
   ...
   //         oSessionUser.setValue("session_user", -1);
