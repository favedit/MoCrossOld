...
public class FSyntaxPlSqlMaker
      extends FAbstractSyntaxMaker
      implements
         ISyntaxMaker
{
   private static ILogger _logger = RLogger.find(FSyntaxPlSqlMaker.class);

   public FSyntaxPlSqlMaker(){
   }
   ...
   public FString format(FString value){
      ...
      if(_logger.debugAble()){
         _logger.debug(this, "format", "Format source in {1} ms", System.currentTimeMillis() - startTime);
      }
      return html;
   }
}
