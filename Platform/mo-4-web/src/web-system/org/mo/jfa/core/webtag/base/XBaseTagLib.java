...
/**
 * <p>taglib对象的XML节点基类</p>
 *
 * @author system
 */
public abstract class XBaseTagLib
      extends FXmlObject
      implements
         XObjectFace
{
   public static final String NAME = "taglib";
    ...
    * 短名称的名称定义
    */
   public static final String PTY_SHORT_NAME = "short_name";
   ...
   public void loadConfig(FXmlNode config,
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("short_name")){
            setShortName(config.get(PTY_SHORT_NAME));
         }
         ...
         if(RString.isEmpty(getShortName())){
            if(config.contains("short_name")){
               setShortName(config.get(PTY_SHORT_NAME));
            }
         }
   ...
   public void saveConfig(FXmlNode config,
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getShortName())){
            config.set(PTY_SHORT_NAME, getShortName());
         }
      }else if(EXmlConfig.Simple == type){
         if(RString.isNotEmpty(getName())){
            config.set(PTY_NAME, getName());
         ...
         String sShortName = getShortName();
         if(RString.isNotEmpty(sShortName)){
            config.set(PTY_SHORT_NAME, sShortName);
         }
      }else if(EXmlConfig.Default == type){
         String s_type = get_type();
         if(RString.isNotEmpty(s_type)){
   ...
   public String innerGet(String name){
      if(RString.isEmpty(name)){
         ...
         return getIsValid();
      }else if(PTY_SHORT_NAME.equalsIgnoreCase(name)){
         return getShortName();
      }
      return null;
   }
