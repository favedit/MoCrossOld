 ...
 */
public abstract class FBaseCheckTag
      extends FAbstractHtmlTag
{
   ...
   public void appendHtml(){
      ...
      /// 如果状态不空，则添加该属性
      if(null != _status){
         _writer.appendAttribute("status", _status, true);
      }
      /// 如果显示不空，则添加该属性
      if(null != _display){
      ...
      /// 如果为真不空，则添加该属性
      if(null != _true){
         _writer.appendAttribute("true", _true, true);
      }
      /// 如果为假不空，则添加该属性
      if(null != _false){
         _writer.appendAttribute("false", _false, true);
      }
      /// 如果默认值不空，则添加该属性
      if(null != _default){
