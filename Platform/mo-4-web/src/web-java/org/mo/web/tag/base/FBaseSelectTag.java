 ...
 */
public abstract class FBaseSelectTag
      extends FAbstractHtmlTag
{
   ...
   public void appendHtml(){
      ...
      /// 如果链接不空，则添加该属性
      if(null != _link){
         _writer.appendAttribute("link", _link, true);
      }
      /// 如果枚举值不空，则添加该属性
      if(null != _enum){
         _writer.appendAttribute("enum", _enum, true);
      }
      /// 如果显示中文名称不空，则添加该属性
      if(null != _label){
         _writer.appendAttribute("label", _label, true);
      }
      /// 如果大小不空，则添加该属性
      if(null != _size){
      ...
      /// 如果控件状态不空，则添加该属性
      if(null != _disabled){
         _writer.appendAttribute("disabled", _disabled, true);
      }
      /// 如果默认值不空，则添加该属性
      if(null != _default){
