         ...
         XEditControlFace
{
   ...
   // 控件类型的名称定义
   public static final String PTY_ITEM_TYPE = "item_type";

   // 每行控件数量的名称定义
   public static final String PTY_ROW_ITEM_COUNT = "row_item_count";

   // 控件宽度的名称定义
   public static final String PTY_ITEM_CONTROL_WIDTH = "item_control_width";

   // 控件标签宽度的名称定义
   public static final String PTY_ITEM_LABEL_WIDTH = "item_label_width";
   ...
   // 每行控件数量的定义
   @AName("row_item_count")
   protected String _rowItemCount;

   // 控件宽度的定义
   @AName("item_control_width")
   protected String _itemControlWidth;

   // 控件标签宽度的定义
   @AName("item_label_width")
   protected String _itemLabelWidth;
   ...
   // @param value 每行控件数量
   //============================================================
   public void setRowItemCount(String value){
      _rowItemCount = value;
   }
   ...
   // @return 控件宽度
   //============================================================
   public String getItemControlWidth(){
      return _itemControlWidth;
   }
   ...
   // @param value 控件宽度
   //============================================================
   public void setItemControlWidth(String value){
      _itemControlWidth = value;
   }
   ...
   // @return 控件标签宽度
   //============================================================
   public String getItemLabelWidth(){
      return _itemLabelWidth;
   }
   ...
   // @param value 控件标签宽度
   //============================================================
   public void setItemLabelWidth(String value){
      _itemLabelWidth = value;
   }
   ...
   public String innerGet(String name){
      if(RString.isEmpty(name)){
         ...
         return getTypeAble();
      }else if(PTY_ITEM_TYPE.equalsIgnoreCase(name)){
         return getItemType();
      }else if(PTY_ROW_ITEM_COUNT.equalsIgnoreCase(name)){
         return getRowItemCount();
      }else if(PTY_ITEM_CONTROL_WIDTH.equalsIgnoreCase(name)){
         return getItemControlWidth();
      }else if(PTY_ITEM_LABEL_WIDTH.equalsIgnoreCase(name)){
         return getItemLabelWidth();
      }
      return null;
   }
   ...
   public void innerSet(String name, String value){
      if(RString.isEmpty(name)){
         ...
         setRowItemCount(value);
      }else if(PTY_ITEM_CONTROL_WIDTH.equalsIgnoreCase(name)){
         setItemControlWidth(value);
      }else if(PTY_ITEM_LABEL_WIDTH.equalsIgnoreCase(name)){
         setItemLabelWidth(value);
      }
   }
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("item_type")){
            setItemType(config.get(PTY_ITEM_TYPE));
         }
         if(config.contains("row_item_count")){
            setRowItemCount(config.get(PTY_ROW_ITEM_COUNT));
         }
         if(config.contains("item_control_width")){
            setItemControlWidth(config.get(PTY_ITEM_CONTROL_WIDTH));
         }
         if(config.contains("item_label_width")){
            setItemLabelWidth(config.get(PTY_ITEM_LABEL_WIDTH));
         }
         ...
         if(RString.isEmpty(getItemType())){
            if(config.contains("item_type")){
               setItemType(config.get(PTY_ITEM_TYPE));
            }
         }
         if(RString.isEmpty(getRowItemCount())){
            if(config.contains("row_item_count")){
               setRowItemCount(config.get(PTY_ROW_ITEM_COUNT));
            }
         }
         if(RString.isEmpty(getItemControlWidth())){
            if(config.contains("item_control_width")){
               setItemControlWidth(config.get(PTY_ITEM_CONTROL_WIDTH));
            }
         }
         if(RString.isEmpty(getItemLabelWidth())){
            if(config.contains("item_label_width")){
               setItemLabelWidth(config.get(PTY_ITEM_LABEL_WIDTH));
            }
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getItemType())){
            config.set(PTY_ITEM_TYPE, getItemType());
         }
         if(RString.isNotEmpty(getRowItemCount())){
            config.set(PTY_ROW_ITEM_COUNT, getRowItemCount());
         }
         if(RString.isNotEmpty(getItemControlWidth())){
            config.set(PTY_ITEM_CONTROL_WIDTH, getItemControlWidth());
         }
         if(RString.isNotEmpty(getItemLabelWidth())){
            config.set(PTY_ITEM_LABEL_WIDTH, getItemLabelWidth());
         }
      }else if(EXmlConfig.Simple == type){
         if(RString.isNotEmpty(getName())){
            config.set(PTY_NAME, getName());
         ...
         String sItemType = getItemType();
         if(RString.isNotEmpty(sItemType)){
            config.set(PTY_ITEM_TYPE, sItemType);
         }
         String sRowItemCount = getRowItemCount();
         if(RString.isNotEmpty(sRowItemCount)){
            config.set(PTY_ROW_ITEM_COUNT, sRowItemCount);
         }
         String sItemControlWidth = getItemControlWidth();
         if(RString.isNotEmpty(sItemControlWidth)){
            config.set(PTY_ITEM_CONTROL_WIDTH, sItemControlWidth);
         }
         String sItemLabelWidth = getItemLabelWidth();
         if(RString.isNotEmpty(sItemLabelWidth)){
            config.set(PTY_ITEM_LABEL_WIDTH, sItemLabelWidth);
         }
      }else if(EXmlConfig.Default == type){
         String sPadLeft = getPadLeft();
         if(RString.isNotEmpty(sPadLeft)){
