...
// <T>主题对象的XML节点基类。</T>
//============================================================
public abstract class XBaseWebTheme
      extends FXmlObject
      implements
         XObjectFace
{
   // 名称定义
   public static final String NAME = "WebTheme";
   ...
   // 文件路径的名称定义
   public static final String PTY_FILE_PATH = "file_path";
   ...
   public String innerGet(String name){
      if(RString.isEmpty(name)){
         ...
         return getNote();
      }else if(PTY_FILE_PATH.equalsIgnoreCase(name)){
         return getFilePath();
      }
      return null;
   }
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("file_path")){
            setFilePath(config.get(PTY_FILE_PATH));
         }
         ...
         if(RString.isEmpty(getFilePath())){
            if(config.contains("file_path")){
               setFilePath(config.get(PTY_FILE_PATH));
            }
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getFilePath())){
            config.set(PTY_FILE_PATH, getFilePath());
         }
      }else if(EXmlConfig.Simple == type){
         if(RString.isNotEmpty(getName())){
            config.set(PTY_NAME, getName());
         ...
         if(RString.isNotEmpty(sFilePath)){
            config.set(PTY_FILE_PATH, sFilePath);
         }
      }else if(EXmlConfig.Default == type){
         String sParentStyle = getParentStyle();
         if(RString.isNotEmpty(sParentStyle)){
