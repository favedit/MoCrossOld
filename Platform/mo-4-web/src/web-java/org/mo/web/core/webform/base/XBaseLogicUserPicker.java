...
//============================================================
// <T>用户逻辑控件对象的XML节点基类。</T>
//============================================================
public abstract class XBaseLogicUserPicker
      extends FXmlObject
      implements
         XEditControlFace
{
   // 名称定义
   public static final String NAME = "LogicUserPicker";
   ...
   // 编辑框样式的名称定义
   public static final String PTY_EDIT_STYLE = "edit_style";
   ...
   // @param value 编辑框样式
   //============================================================
   public void setEditStyle(String value){
      _editStyle = value;
   }
   ...
   public String innerGet(String name){
      if(RString.isEmpty(name)){
         ...
         return getTypeAble();
      }else if(PTY_EDIT_STYLE.equalsIgnoreCase(name)){
         return getEditStyle();
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("edit_style")){
            setEditStyle(config.get(PTY_EDIT_STYLE));
         }
         ...
         if(RString.isEmpty(getEditStyle())){
            if(config.contains("edit_style")){
               setEditStyle(config.get(PTY_EDIT_STYLE));
            }
         }
         if(RString.isEmpty(getService())){
            if(config.contains("service")){
               setService(config.get(PTY_SERVICE));
            }
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getEditStyle())){
            config.set(PTY_EDIT_STYLE, getEditStyle());
         }
         ...
         String sEditStyle = getEditStyle();
         if(RString.isNotEmpty(sEditStyle)){
            config.set(PTY_EDIT_STYLE, sEditStyle);
         }
