...
// <T>表单窗口对象的XML节点基类。</T>
//============================================================
public abstract class XBaseWebForm
      extends FXmlObject
      implements
         XControlFace,
         XDatasetFace
{
   // 名称定义
   public static final String NAME = "WebForm";
   ...
   // 表格名称的名称定义
   public static final String PTY_TABLE_NAME = "table_name";
   ...
   public String innerGet(String name){
      ...
      }else if(PTY_TABLE_NAME.equalsIgnoreCase(name)){
         return getTableName();
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("table_name")){
            setTableName(config.get(PTY_TABLE_NAME));
         }
         ...
         if(RString.isEmpty(getTableName())){
            if(config.contains("table_name")){
               setTableName(config.get(PTY_TABLE_NAME));
            }
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getTableName())){
            config.set(PTY_TABLE_NAME, getTableName());
         }
         ...
         if(RString.isNotEmpty(sTableName)){
            config.set(PTY_TABLE_NAME, sTableName);
         }
