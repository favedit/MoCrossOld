...
import org.mo.web.core.webform.control.XDescCheckFace;
...
{
   // 名称定义
   public static final String NAME = "ColumnCheck";
   ...
   // 真值的名称定义
   public static final String PTY_EDIT_TRUE = "edit_true";

   // 假值的名称定义
   public static final String PTY_EDIT_FALSE = "edit_false";
   ...
   // 真值的定义
   @AName("edit_true")
   protected String _editTrue;

   // 假值的定义
   @AName("edit_false")
   protected String _editFalse;
   ...
   // @param value 真值
   //============================================================
   public void setEditTrue(String value){
      _editTrue = value;
   }
   ...
   // @param value 假值
   //============================================================
   public void setEditFalse(String value){
      _editFalse = value;
   }
   ...
   public String innerGet(String name){
      if(RString.isEmpty(name)){
         ...
         return getOrderAble();
      }else if(PTY_EDIT_TRUE.equalsIgnoreCase(name)){
         return getEditTrue();
      }else if(PTY_EDIT_FALSE.equalsIgnoreCase(name)){
         return getEditFalse();
      }
      return null;
   }
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("edit_true")){
            setEditTrue(config.get(PTY_EDIT_TRUE));
         }
         if(config.contains("edit_false")){
            setEditFalse(config.get(PTY_EDIT_FALSE));
         }
         ...
         if(RString.isEmpty(getEditTrue())){
            if(config.contains("edit_true")){
               setEditTrue(config.get(PTY_EDIT_TRUE));
            }
         }
         if(RString.isEmpty(getEditFalse())){
            if(config.contains("edit_false")){
               setEditFalse(config.get(PTY_EDIT_FALSE));
            }
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getEditTrue())){
            config.set(PTY_EDIT_TRUE, getEditTrue());
         }
         if(RString.isNotEmpty(getEditFalse())){
            config.set(PTY_EDIT_FALSE, getEditFalse());
         }
      }else if(EXmlConfig.Simple == type){
         if(RString.isNotEmpty(getName())){
            config.set(PTY_NAME, getName());
         ...
         String sEditTrue = getEditTrue();
         if(RString.isNotEmpty(sEditTrue)){
            config.set(PTY_EDIT_TRUE, sEditTrue);
         }
         String sEditFalse = getEditFalse();
         if(RString.isNotEmpty(sEditFalse)){
            config.set(PTY_EDIT_FALSE, sEditFalse);
         }
      }else if(EXmlConfig.Default == type){
         String sPadLeft = getPadLeft();
         if(RString.isNotEmpty(sPadLeft)){
