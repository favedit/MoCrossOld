...
import org.mo.web.core.webform.control.XDescPictureFace;

//============================================================
// <T>图片框对象的XML节点基类。</T>
//============================================================
public abstract class XBasePicture
      extends FXmlObject
      implements
         XEditControlFace,
         XDescPictureFace
{
   ...
   // 存储类型的名称定义
   public static final String PTY_STORE_TYPE = "store_type";

   // 存储代码的名称定义
   public static final String PTY_STORE_CODE = "store_code";

   // 存储名称的名称定义
   public static final String PTY_STORE_NAME = "store_name";

   // 自动调整的名称定义
   public static final String PTY_EDIT_ADJUST = "edit_adjust";

   // 最大宽度的名称定义
   public static final String PTY_EDIT_MAX_WIDTH = "edit_max_width";

   // 最大高度的名称定义
   public static final String PTY_EDIT_MAX_HEIGHT = "edit_max_height";
   ...
   // 自动调整的定义
   @AName("edit_adjust")
   protected String _editAdjust;

   // 最大宽度的定义
   @AName("edit_max_width")
   protected String _editMaxWidth;

   // 最大高度的定义
   @AName("edit_max_height")
   protected String _editMaxHeight;
   ...
   // @param value 自动调整
   //============================================================
   public void setEditAdjust(String value){
      _editAdjust = value;
   }
   ...
   // @return 最大宽度
   //============================================================
   public String getEditMaxWidth(){
      return _editMaxWidth;
   }
   ...
   // @param value 最大宽度
   //============================================================
   public void setEditMaxWidth(String value){
      _editMaxWidth = value;
   }
   ...
   // @return 最大高度
   //============================================================
   public String getEditMaxHeight(){
      return _editMaxHeight;
   }
   ...
   // @param value 最大高度
   //============================================================
   public void setEditMaxHeight(String value){
      _editMaxHeight = value;
   }
   ...
   public String innerGet(String name){
      if(RString.isEmpty(name)){
         ...
         return getTypeAble();
      }else if(PTY_STORE_TYPE.equalsIgnoreCase(name)){
         return getStoreType();
      }else if(PTY_STORE_CODE.equalsIgnoreCase(name)){
         return getStoreCode();
      }else if(PTY_STORE_NAME.equalsIgnoreCase(name)){
         return getStoreName();
      }else if(PTY_EDIT_ADJUST.equalsIgnoreCase(name)){
         return getEditAdjust();
      }else if(PTY_EDIT_MAX_WIDTH.equalsIgnoreCase(name)){
         return getEditMaxWidth();
      }else if(PTY_EDIT_MAX_HEIGHT.equalsIgnoreCase(name)){
         return getEditMaxHeight();
      }
      return null;
   }
   ...
   public void innerSet(String name, String value){
      if(RString.isEmpty(name)){
         ...
         setEditMaxWidth(value);
      }else if(PTY_EDIT_MAX_HEIGHT.equalsIgnoreCase(name)){
         setEditMaxHeight(value);
      }
   }
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("store_type")){
            setStoreType(config.get(PTY_STORE_TYPE));
         }
         if(config.contains("store_code")){
            setStoreCode(config.get(PTY_STORE_CODE));
         }
         if(config.contains("store_name")){
            setStoreName(config.get(PTY_STORE_NAME));
         }
         if(config.contains("edit_adjust")){
            setEditAdjust(config.get(PTY_EDIT_ADJUST));
         }
         if(config.contains("edit_max_width")){
            setEditMaxWidth(config.get(PTY_EDIT_MAX_WIDTH));
         }
         if(config.contains("edit_max_height")){
            setEditMaxHeight(config.get(PTY_EDIT_MAX_HEIGHT));
         }
         ...
         if(RString.isEmpty(getEditAdjust())){
            if(config.contains("edit_adjust")){
               setEditAdjust(config.get(PTY_EDIT_ADJUST));
            }
         }
         if(RString.isEmpty(getEditMaxWidth())){
            if(config.contains("edit_max_width")){
               setEditMaxWidth(config.get(PTY_EDIT_MAX_WIDTH));
            }
         }
         if(RString.isEmpty(getEditMaxHeight())){
            if(config.contains("edit_max_height")){
               setEditMaxHeight(config.get(PTY_EDIT_MAX_HEIGHT));
            }
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getStoreType())){
            config.set(PTY_STORE_TYPE, getStoreType());
         }
         if(RString.isNotEmpty(getStoreCode())){
            config.set(PTY_STORE_CODE, getStoreCode());
         }
         if(RString.isNotEmpty(getStoreName())){
            config.set(PTY_STORE_NAME, getStoreName());
         }
         if(RString.isNotEmpty(getEditAdjust())){
            config.set(PTY_EDIT_ADJUST, getEditAdjust());
         }
         if(RString.isNotEmpty(getEditMaxWidth())){
            config.set(PTY_EDIT_MAX_WIDTH, getEditMaxWidth());
         }
         if(RString.isNotEmpty(getEditMaxHeight())){
            config.set(PTY_EDIT_MAX_HEIGHT, getEditMaxHeight());
         }
      }else if(EXmlConfig.Simple == type){
         if(RString.isNotEmpty(getName())){
            config.set(PTY_NAME, getName());
         ...
         String sStoreType = getStoreType();
         if(RString.isNotEmpty(sStoreType)){
            config.set(PTY_STORE_TYPE, sStoreType);
         }
         String sStoreCode = getStoreCode();
         if(RString.isNotEmpty(sStoreCode)){
            config.set(PTY_STORE_CODE, sStoreCode);
         }
         String sStoreName = getStoreName();
         if(RString.isNotEmpty(sStoreName)){
            config.set(PTY_STORE_NAME, sStoreName);
         }
         String sEditAdjust = getEditAdjust();
         if(RString.isNotEmpty(sEditAdjust)){
            config.set(PTY_EDIT_ADJUST, sEditAdjust);
         }
         String sEditMaxWidth = getEditMaxWidth();
         if(RString.isNotEmpty(sEditMaxWidth)){
            config.set(PTY_EDIT_MAX_WIDTH, sEditMaxWidth);
         }
         String sEditMaxHeight = getEditMaxHeight();
         if(RString.isNotEmpty(sEditMaxHeight)){
            config.set(PTY_EDIT_MAX_HEIGHT, sEditMaxHeight);
         }
      }else if(EXmlConfig.Default == type){
         String sPadLeft = getPadLeft();
         if(RString.isNotEmpty(sPadLeft)){
