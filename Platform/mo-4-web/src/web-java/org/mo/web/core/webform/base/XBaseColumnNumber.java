...
import org.mo.web.core.webform.control.XDescNumberFace;
...
{
   // 名称定义
   public static final String NAME = "ColumnNumber";
   ...
   // 是否分隔的名称定义
   public static final String PTY_EDIT_SPLITTER = "edit_splitter";

   // 增减单位的名称定义
   public static final String PTY_EDIT_INCREATE = "edit_increate";

   // 精度的名称定义
   public static final String PTY_EDIT_PRECISION = "edit_precision";

   // 输入模板的名称定义
   public static final String PTY_EDIT_PATTERN = "edit_pattern";

   // 四舍五入的名称定义
   public static final String PTY_EDIT_ROUND = "edit_round";

   // 允许最小值的名称定义
   public static final String PTY_VALID_EQLMIN = "valid_eqlmin";

   // 允许最大值的名称定义
   public static final String PTY_VALID_EQLMAX = "valid_eqlmax";

   // 最小值的名称定义
   public static final String PTY_VALID_VALMIN = "valid_valmin";

   // 最大值的名称定义
   public static final String PTY_VALID_VALMAX = "valid_valmax";
   ...
   // 显示格式的名称定义
   public static final String PTY_DISP_FORMAT = "disp_format";

   // 合计类型的名称定义
   public static final String PTY_DATA_TOTAL = "data_total";

   // 编辑下的关联的名称定义
   public static final String PTY_EDIT_LINK = "edit_link";
   ...
   // 是否分隔的定义
   @AName("edit_splitter")
   protected Boolean _editSplitter = Boolean.FALSE;

   // 增减单位的定义
   @AName("edit_increate")
   protected String _editIncreate;

   // 精度的定义
   @AName("edit_precision")
   protected String _editPrecision;
   ...
   // 四舍五入的定义
   @AName("edit_round")
   protected String _editRound;

   // 允许最小值的定义
   @AName("valid_eqlmin")
   protected Boolean _validEqlmin = Boolean.FALSE;

   // 允许最大值的定义
   @AName("valid_eqlmax")
   protected Boolean _validEqlmax = Boolean.FALSE;

   // 最小值的定义
   @AName("valid_valmin")
   protected String _validValmin;

   // 最大值的定义
   @AName("valid_valmax")
   protected String _validValmax;
   ...
   // 显示格式的定义
   @AName("disp_format")
   protected String _dispFormat;

   // 合计类型的定义
   @AName("data_total")
   protected String _dataTotal;

   // 编辑下的关联的定义
   @AName("edit_link")
   protected Boolean _editLink = Boolean.FALSE;
   ...
   // @return 是否分隔
   //============================================================
   public Boolean getEditSplitter(){
      return _editSplitter;
   }
   ...
   // @param value 是否分隔
   //============================================================
   public void setEditSplitter(Boolean value){
      _editSplitter = value;
   }
   ...
   // @return 增减单位
   //============================================================
   public String getEditIncreate(){
      return _editIncreate;
   }
   ...
   // @param value 增减单位
   //============================================================
   public void setEditIncreate(String value){
      _editIncreate = value;
   }
   ...
   // @return 精度
   //============================================================
   public String getEditPrecision(){
      return _editPrecision;
   }
   ...
   // @param value 精度
   //============================================================
   public void setEditPrecision(String value){
      _editPrecision = value;
   }
   ...
   // @param value 四舍五入
   //============================================================
   public void setEditRound(String value){
      _editRound = value;
   }
   ...
   // @param value 允许最小值
   //============================================================
   public void setValidEqlmin(Boolean value){
      _validEqlmin = value;
   }
   ...
   // @param value 允许最大值
   //============================================================
   public void setValidEqlmax(Boolean value){
      _validEqlmax = value;
   }
   ...
   // @param value 最小值
   //============================================================
   public void setValidValmin(String value){
      _validValmin = value;
   }
   ...
   // @param value 最大值
   //============================================================
   public void setValidValmax(String value){
      _validValmax = value;
   }
   ...
   // @param value 显示格式
   //============================================================
   public void setDispFormat(String value){
      _dispFormat = value;
   }
   ...
   // @param value 合计类型
   //============================================================
   public void setDataTotal(String value){
      _dataTotal = value;
   }
   ...
   // @param value 编辑下的关联
   //============================================================
   public void setEditLink(Boolean value){
      _editLink = value;
   }
   ...
   public String innerGet(String name){
      if(RString.isEmpty(name)){
         ...
         return getOrderAble();
      }else if(PTY_EDIT_SPLITTER.equalsIgnoreCase(name)){
         return RBoolean.toString(getEditSplitter());
      }else if(PTY_EDIT_INCREATE.equalsIgnoreCase(name)){
         return getEditIncreate();
      }else if(PTY_EDIT_PRECISION.equalsIgnoreCase(name)){
         return getEditPrecision();
      }else if(PTY_EDIT_PATTERN.equalsIgnoreCase(name)){
         return getEditPattern();
      }else if(PTY_EDIT_ROUND.equalsIgnoreCase(name)){
         return getEditRound();
      }else if(PTY_VALID_EQLMIN.equalsIgnoreCase(name)){
         return RBoolean.toString(getValidEqlmin());
      }else if(PTY_VALID_EQLMAX.equalsIgnoreCase(name)){
         return RBoolean.toString(getValidEqlmax());
      }else if(PTY_VALID_VALMIN.equalsIgnoreCase(name)){
         return getValidValmin();
      }else if(PTY_VALID_VALMAX.equalsIgnoreCase(name)){
         return getValidValmax();
         ...
         return getLovOrder();
      }else if(PTY_DISP_FORMAT.equalsIgnoreCase(name)){
         return getDispFormat();
      }else if(PTY_DATA_TOTAL.equalsIgnoreCase(name)){
         return getDataTotal();
      }else if(PTY_EDIT_LINK.equalsIgnoreCase(name)){
         return RBoolean.toString(getEditLink());
      }
      return null;
   }
   ...
   public void innerSet(String name, String value){
      if(RString.isEmpty(name)){
         ...
         setEditSplitter(RBoolean.parse(value));
      }else if(PTY_EDIT_INCREATE.equalsIgnoreCase(name)){
         setEditIncreate(value);
      }else if(PTY_EDIT_PRECISION.equalsIgnoreCase(name)){
         setEditPrecision(value);
      }else if(PTY_EDIT_PATTERN.equalsIgnoreCase(name)){
         setEditPattern(value);
      }else if(PTY_EDIT_ROUND.equalsIgnoreCase(name)){
         setEditRound(value);
      }else if(PTY_VALID_EQLMIN.equalsIgnoreCase(name)){
         setValidEqlmin(RBoolean.parse(value));
      }else if(PTY_VALID_EQLMAX.equalsIgnoreCase(name)){
         setValidEqlmax(RBoolean.parse(value));
      }else if(PTY_VALID_VALMIN.equalsIgnoreCase(name)){
         setValidValmin(value);
      }else if(PTY_VALID_VALMAX.equalsIgnoreCase(name)){
         setValidValmax(value);
      }else if(PTY_EDIT_LENGTH.equalsIgnoreCase(name)){
         setEditLength(value);
      }else if(PTY_EDIT_FORMAT.equalsIgnoreCase(name)){
         setEditFormat(value);
         ...
         setEditLink(RBoolean.parse(value));
      }
   }
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("edit_splitter")){
            setEditSplitter(RBoolean.parse(config.get(PTY_EDIT_SPLITTER)));
         }
         if(config.contains("edit_increate")){
            setEditIncreate(config.get(PTY_EDIT_INCREATE));
         }
         if(config.contains("edit_precision")){
            setEditPrecision(config.get(PTY_EDIT_PRECISION));
         }
         if(config.contains("edit_pattern")){
            setEditPattern(config.get(PTY_EDIT_PATTERN));
         }
         if(config.contains("edit_round")){
            setEditRound(config.get(PTY_EDIT_ROUND));
         }
         if(config.contains("valid_eqlmin")){
            setValidEqlmin(RBoolean.parse(config.get(PTY_VALID_EQLMIN)));
         }
         if(config.contains("valid_eqlmax")){
            setValidEqlmax(RBoolean.parse(config.get(PTY_VALID_EQLMAX)));
         }
         if(config.contains("valid_valmin")){
            setValidValmin(config.get(PTY_VALID_VALMIN));
         }
         if(config.contains("valid_valmax")){
            setValidValmax(config.get(PTY_VALID_VALMAX));
         }
         ...
         if(config.contains("disp_format")){
            setDispFormat(config.get(PTY_DISP_FORMAT));
         }
         if(config.contains("data_total")){
            setDataTotal(config.get(PTY_DATA_TOTAL));
         }
         if(config.contains("edit_link")){
            setEditLink(RBoolean.parse(config.get(PTY_EDIT_LINK)));
         }
         ...
         if(RString.isEmpty(getEditPrecision())){
            if(config.contains("edit_precision")){
               setEditPrecision(config.get(PTY_EDIT_PRECISION));
            }
         }
         if(RString.isEmpty(getEditLength())){
            if(config.contains("edit_length")){
               setEditLength(config.get(PTY_EDIT_LENGTH));
            }
         }
         if(RString.isEmpty(getEditFormat())){
            if(config.contains("edit_format")){
               setEditFormat(config.get(PTY_EDIT_FORMAT));
            }
         }
         ...
         if(RString.isEmpty(getDataTotal())){
            if(config.contains("data_total")){
               setDataTotal(config.get(PTY_DATA_TOTAL));
            }
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RBoolean.parse(getEditSplitter())){
            config.set(PTY_EDIT_SPLITTER, RBoolean.toString(getEditSplitter()));
         }
         if(RString.isNotEmpty(getEditIncreate())){
            config.set(PTY_EDIT_INCREATE, getEditIncreate());
         }
         if(RString.isNotEmpty(getEditPrecision())){
            config.set(PTY_EDIT_PRECISION, getEditPrecision());
         }
         if(RString.isNotEmpty(getEditPattern())){
            config.set(PTY_EDIT_PATTERN, getEditPattern());
         }
         if(RString.isNotEmpty(getEditRound())){
            config.set(PTY_EDIT_ROUND, getEditRound());
         }
         if(RBoolean.parse(getValidEqlmin())){
            config.set(PTY_VALID_EQLMIN, RBoolean.toString(getValidEqlmin()));
         }
         if(RBoolean.parse(getValidEqlmax())){
            config.set(PTY_VALID_EQLMAX, RBoolean.toString(getValidEqlmax()));
         }
         if(RString.isNotEmpty(getValidValmin())){
            config.set(PTY_VALID_VALMIN, getValidValmin());
         }
         if(RString.isNotEmpty(getValidValmax())){
            config.set(PTY_VALID_VALMAX, getValidValmax());
         }
         ...
         if(RString.isNotEmpty(getDispFormat())){
            config.set(PTY_DISP_FORMAT, getDispFormat());
         }
         if(RString.isNotEmpty(getDataTotal())){
            config.set(PTY_DATA_TOTAL, getDataTotal());
         }
         if(RBoolean.parse(getEditLink())){
            config.set(PTY_EDIT_LINK, RBoolean.toString(getEditLink()));
         }
      }else if(EXmlConfig.Simple == type){
         if(RString.isNotEmpty(getName())){
            config.set(PTY_NAME, getName());
         ...
         Boolean bEditSplitter = getEditSplitter();
         if(RBoolean.parse(bEditSplitter)){
            config.set(PTY_EDIT_SPLITTER, RBoolean.toString(bEditSplitter));
         }
         String sEditIncreate = getEditIncreate();
         if(RString.isNotEmpty(sEditIncreate)){
            config.set(PTY_EDIT_INCREATE, sEditIncreate);
         }
         String sEditPrecision = getEditPrecision();
         if(RString.isNotEmpty(sEditPrecision)){
            config.set(PTY_EDIT_PRECISION, sEditPrecision);
         }
         String sEditPattern = getEditPattern();
         if(RString.isNotEmpty(sEditPattern)){
            config.set(PTY_EDIT_PATTERN, sEditPattern);
         }
         String sEditRound = getEditRound();
         if(RString.isNotEmpty(sEditRound)){
            config.set(PTY_EDIT_ROUND, sEditRound);
         }
         Boolean bValidEqlmin = getValidEqlmin();
         if(RBoolean.parse(bValidEqlmin)){
            config.set(PTY_VALID_EQLMIN, RBoolean.toString(bValidEqlmin));
         }
         Boolean bValidEqlmax = getValidEqlmax();
         if(RBoolean.parse(bValidEqlmax)){
            config.set(PTY_VALID_EQLMAX, RBoolean.toString(bValidEqlmax));
         }
         String sValidValmin = getValidValmin();
         if(RString.isNotEmpty(sValidValmin)){
            config.set(PTY_VALID_VALMIN, sValidValmin);
         }
         String sValidValmax = getValidValmax();
         if(RString.isNotEmpty(sValidValmax)){
            config.set(PTY_VALID_VALMAX, sValidValmax);
         }
         ...
         String sDispFormat = getDispFormat();
         if(RString.isNotEmpty(sDispFormat)){
            config.set(PTY_DISP_FORMAT, sDispFormat);
         }
         String sDataTotal = getDataTotal();
         if(RString.isNotEmpty(sDataTotal)){
            config.set(PTY_DATA_TOTAL, sDataTotal);
         }
         Boolean bEditLink = getEditLink();
         if(RBoolean.parse(bEditLink)){
            config.set(PTY_EDIT_LINK, RBoolean.toString(bEditLink));
         }
      }else if(EXmlConfig.Default == type){
         String sPadLeft = getPadLeft();
         if(RString.isNotEmpty(sPadLeft)){
