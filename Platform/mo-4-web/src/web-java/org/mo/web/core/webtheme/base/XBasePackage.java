         ...
         XObjectFace
{
   ...
   // 文件名称的名称定义
   public static final String PTY_FILE_NAME = "file_name";
   ...
   public String innerGet(String name){
      if(RString.isEmpty(name)){
         ...
         return getNote();
      }else if(PTY_FILE_NAME.equalsIgnoreCase(name)){
         return getFileName();
      }
      return null;
   }
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("file_name")){
            setFileName(config.get(PTY_FILE_NAME));
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getFileName())){
            config.set(PTY_FILE_NAME, getFileName());
         }
      }else if(EXmlConfig.Simple == type){
         if(RString.isNotEmpty(getName())){
            config.set(PTY_NAME, getName());
         ...
         if(RString.isNotEmpty(sFileName)){
            config.set(PTY_FILE_NAME, sFileName);
         }
      }else if(EXmlConfig.Default == type){
         String sParentStyle = getParentStyle();
         if(RString.isNotEmpty(sParentStyle)){
