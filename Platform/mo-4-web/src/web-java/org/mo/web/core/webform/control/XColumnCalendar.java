...
import org.mo.web.core.webform.base.XBaseColumnCalendar;

public class XColumnCalendar
      extends XBaseColumnCalendar
{
   ...
   public String getEditDate(){
      return RPropertyMaker.getEditTime(this);
   }

   @Override
   public void setEditDate(String value){
      RPropertyMaker.setEditTime(this, value);
   }
}
