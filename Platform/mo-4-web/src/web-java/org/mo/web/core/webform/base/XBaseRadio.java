...
//============================================================
// <T>单项选择按钮对象的XML节点基类。</T>
//============================================================
public abstract class XBaseRadio
      extends FXmlObject
      implements
         XEditControlFace
{
   ...
   // 默认选择的名称定义
   public static final String PTY_EDIT_CHECKED = "edit_checked";
   ...
   // @param value 默认选择
   //============================================================
   public void setEditChecked(String value){
      _editChecked = value;
   }
   ...
   public String innerGet(String name){
      if(RString.isEmpty(name)){
         ...
         return getGroupName();
      }else if(PTY_EDIT_CHECKED.equalsIgnoreCase(name)){
         return getEditChecked();
      }
      return null;
   }
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("edit_checked")){
            setEditChecked(config.get(PTY_EDIT_CHECKED));
         }
         ...
         if(RString.isEmpty(getEditChecked())){
            if(config.contains("edit_checked")){
               setEditChecked(config.get(PTY_EDIT_CHECKED));
            }
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getEditChecked())){
            config.set(PTY_EDIT_CHECKED, getEditChecked());
         }
      }else if(EXmlConfig.Simple == type){
         if(RString.isNotEmpty(getName())){
            config.set(PTY_NAME, getName());
         ...
         String sEditChecked = getEditChecked();
         if(RString.isNotEmpty(sEditChecked)){
            config.set(PTY_EDIT_CHECKED, sEditChecked);
         }
      }else if(EXmlConfig.Default == type){
         String sPadLeft = getPadLeft();
         if(RString.isNotEmpty(sPadLeft)){
