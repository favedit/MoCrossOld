...
// <T>引用编辑框对象的XML节点基类。</T>
//============================================================
public abstract class XBaseReference
      extends FXmlObject
      implements
         XEditControlFace,
         XListViewFace,
         ...
         XZoomFace
{
   ...
   // 选取宽度的名称定义
   public static final String PTY_PICKER_WIDTH = "picker_width";
   ...
   // @param value 选取宽度
   //============================================================
   public void setPickerWidth(String value){
      _pickerWidth = value;
   }
   ...
   public String innerGet(String name){
      if(RString.isEmpty(name)){
         ...
         return getZoomField();
      }else if(PTY_PICKER_WIDTH.equalsIgnoreCase(name)){
         return getPickerWidth();
      }
      return null;
   }
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("picker_width")){
            setPickerWidth(config.get(PTY_PICKER_WIDTH));
         }
         ...
         if(RString.isEmpty(getPickerWidth())){
            if(config.contains("picker_width")){
               setPickerWidth(config.get(PTY_PICKER_WIDTH));
            }
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getPickerWidth())){
            config.set(PTY_PICKER_WIDTH, getPickerWidth());
         }
      }else if(EXmlConfig.Simple == type){
         if(RString.isNotEmpty(getName())){
            config.set(PTY_NAME, getName());
         ...
         String sPickerWidth = getPickerWidth();
         if(RString.isNotEmpty(sPickerWidth)){
            config.set(PTY_PICKER_WIDTH, sPickerWidth);
         }
      }else if(EXmlConfig.Default == type){
         String sPadLeft = getPadLeft();
         if(RString.isNotEmpty(sPadLeft)){
