...
// <T>图标选取对象的XML节点基类。</T>
//============================================================
public abstract class XBaseIconPicker
      extends FXmlObject
      implements
         XEditControlFace,
         XListViewFace
{
   // 名称定义
   public static final String NAME = "IconPicker";
   ...
   // 默认图标的名称定义
   public static final String PTY_ICON_DEFAULT = "icon_default";
   ...
   // @param value 默认图标
   //============================================================
   public void setIconDefault(String value){
      _iconDefault = value;
   }
   ...
   public String innerGet(String name){
      if(RString.isEmpty(name)){
         ...
         return getLovOrder();
      }else if(PTY_ICON_DEFAULT.equalsIgnoreCase(name)){
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("icon_default")){
            setIconDefault(config.get(PTY_ICON_DEFAULT));
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getIconDefault())){
            config.set(PTY_ICON_DEFAULT, getIconDefault());
         }
      }else if(EXmlConfig.Simple == type){
         if(RString.isNotEmpty(getName())){
            config.set(PTY_NAME, getName());
         ...
         String sIconDefault = getIconDefault();
         if(RString.isNotEmpty(sIconDefault)){
            config.set(PTY_ICON_DEFAULT, sIconDefault);
         }
      }else if(EXmlConfig.Default == type){
         String sPadLeft = getPadLeft();
         if(RString.isNotEmpty(sPadLeft)){
