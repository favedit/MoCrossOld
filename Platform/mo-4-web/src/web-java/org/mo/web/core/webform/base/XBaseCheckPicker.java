...
import org.mo.web.core.webform.control.XDescCheckPickerFace;

//============================================================
// <T>多项选择框对象的XML节点基类。</T>
//============================================================
public abstract class XBaseCheckPicker
      extends FXmlObject
      implements
         XEditControlFace,
         XDescCheckPickerFace
{
   // 名称定义
   public static final String NAME = "CheckPicker";
   ...
   // @param value 可输入
   //============================================================
   public void setEditCheck(String value){
      _editCheck = value;
   }
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("edit_check")){
            setEditCheck(config.get(PTY_EDIT_CHECK));
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getEditCheck())){
            config.set(PTY_EDIT_CHECK, getEditCheck());
         }
      }else if(EXmlConfig.Simple == type){
         if(RString.isNotEmpty(getName())){
            config.set(PTY_NAME, getName());
         ...
         String sEditCheck = getEditCheck();
         if(RString.isNotEmpty(sEditCheck)){
            config.set(PTY_EDIT_CHECK, sEditCheck);
         }
      }else if(EXmlConfig.Default == type){
         String sPadLeft = getPadLeft();
         if(RString.isNotEmpty(sPadLeft)){
