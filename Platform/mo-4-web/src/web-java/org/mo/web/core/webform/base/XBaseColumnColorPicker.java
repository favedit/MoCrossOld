...
import org.mo.web.core.webform.control.XDescColorPickerFace;

//============================================================
// <T>颜色列对象的XML节点基类。</T>
//============================================================
public abstract class XBaseColumnColorPicker
      extends FXmlObject
      implements
         XColumnEditControlFace,
         XDescColorPickerFace
{
   // 名称定义
   public static final String NAME = "ColumnColorPicker";
