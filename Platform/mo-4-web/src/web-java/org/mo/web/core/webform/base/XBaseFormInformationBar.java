...
import org.mo.web.core.webform.control.XEditValueFace;
import org.mo.web.core.webform.control.XEditDescriptorFace;

//============================================================
// <T>表单信息控件对象的XML节点基类。</T>
//============================================================
public abstract class XBaseFormInformationBar
      extends FXmlObject
      implements
         XControlFace,
         XEditValueFace,
...
{
   // 名称定义
   public static final String NAME = "FormInformationBar";
