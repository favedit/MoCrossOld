...
import org.mo.web.core.webform.control.XDescCalendarFace;

//============================================================
// <T>日期时间列对象的XML节点基类。</T>
//============================================================
public abstract class XBaseColumnCalendar
      extends FXmlObject
      implements
         ...
         XDescCalendarFace
{
   ...
   // 时间格式的名称定义
   public static final String PTY_EDIT_DATE = "edit_date";

   // 小时显示的名称定义
   public static final String PTY_EDIT_HOUR = "edit_hour";

   // 分钟显示的名称定义
   public static final String PTY_EDIT_MINUTE = "edit_minute";

   // 秒数显示的名称定义
   public static final String PTY_EDIT_SECOND = "edit_second";

   // 分钟间隔的名称定义
   public static final String PTY_EDIT_MINUTE_INTERVAL = "edit_minute_interval";

   // 秒数间隔的名称定义
   public static final String PTY_EDIT_SECOND_INTERVAL = "edit_second_interval";
   ...
   // 小时显示的定义
   @AName("edit_hour")
   protected String _editHour;

   // 分钟显示的定义
   @AName("edit_minute")
   protected String _editMinute;

   // 秒数显示的定义
   @AName("edit_second")
   protected String _editSecond;

   // 分钟间隔的定义
   @AName("edit_minute_interval")
   protected String _editMinuteInterval;

   // 秒数间隔的定义
   @AName("edit_second_interval")
   protected String _editSecondInterval;
   ...
   // @return 时间格式
   //============================================================
   public abstract String getEditDate();
   ...
   // @param value 时间格式
   //============================================================
   public abstract void setEditDate(String value);
   ...
   // @param value 小时显示
   //============================================================
   public void setEditHour(String value){
      _editHour = value;
   }
   ...
   // @param value 分钟显示
   //============================================================
   public void setEditMinute(String value){
      _editMinute = value;
   }
   ...
   // @param value 秒数显示
   //============================================================
   public void setEditSecond(String value){
      _editSecond = value;
   }
   ...
   // @return 分钟间隔
   //============================================================
   public String getEditMinuteInterval(){
      return _editMinuteInterval;
   }
   ...
   // @param value 分钟间隔
   //============================================================
   public void setEditMinuteInterval(String value){
      _editMinuteInterval = value;
   }
   ...
   // @return 秒数间隔
   //============================================================
   public String getEditSecondInterval(){
      return _editSecondInterval;
   }
   ...
   // @param value 秒数间隔
   //============================================================
   public void setEditSecondInterval(String value){
      _editSecondInterval = value;
   }
   ...
   public String innerGet(String name){
      if(RString.isEmpty(name)){
         ...
         return getEditAlign();
      }else if(PTY_EDIT_DATE.equalsIgnoreCase(name)){
         return getEditDate();
      }else if(PTY_EDIT_HOUR.equalsIgnoreCase(name)){
         return getEditHour();
      }else if(PTY_EDIT_MINUTE.equalsIgnoreCase(name)){
         return getEditMinute();
      }else if(PTY_EDIT_SECOND.equalsIgnoreCase(name)){
         return getEditSecond();
      }else if(PTY_EDIT_MINUTE_INTERVAL.equalsIgnoreCase(name)){
         return getEditMinuteInterval();
      }else if(PTY_EDIT_SECOND_INTERVAL.equalsIgnoreCase(name)){
         return getEditSecondInterval();
      }
      return null;
   }
   ...
   public void innerSet(String name, String value){
      if(RString.isEmpty(name)){
         ...
         setEditMinuteInterval(value);
      }else if(PTY_EDIT_SECOND_INTERVAL.equalsIgnoreCase(name)){
         setEditSecondInterval(value);
      }
   }
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("edit_hour")){
            setEditHour(config.get(PTY_EDIT_HOUR));
         }
         if(config.contains("edit_minute")){
            setEditMinute(config.get(PTY_EDIT_MINUTE));
         }
         if(config.contains("edit_second")){
            setEditSecond(config.get(PTY_EDIT_SECOND));
         }
         if(config.contains("edit_minute_interval")){
            setEditMinuteInterval(config.get(PTY_EDIT_MINUTE_INTERVAL));
         }
         if(config.contains("edit_second_interval")){
            setEditSecondInterval(config.get(PTY_EDIT_SECOND_INTERVAL));
         }
         ...
         if(config.contains("edit_date")){
            setEditDate(config.get(PTY_EDIT_DATE));
         }
         if(config.contains("edit_second")){
            setEditSecond(config.get(PTY_EDIT_SECOND));
         }
         ...
         if(RString.isEmpty(getEditSecond())){
            if(config.contains("edit_second")){
               setEditSecond(config.get(PTY_EDIT_SECOND));
            }
         }
         if(RString.isEmpty(getEditMinuteInterval())){
            if(config.contains("edit_minute_interval")){
               setEditMinuteInterval(config.get(PTY_EDIT_MINUTE_INTERVAL));
            }
         }
         if(RString.isEmpty(getEditSecondInterval())){
            if(config.contains("edit_second_interval")){
               setEditSecondInterval(config.get(PTY_EDIT_SECOND_INTERVAL));
            }
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getEditHour())){
            config.set(PTY_EDIT_HOUR, getEditHour());
         }
         if(RString.isNotEmpty(getEditMinute())){
            config.set(PTY_EDIT_MINUTE, getEditMinute());
         }
         if(RString.isNotEmpty(getEditSecond())){
            config.set(PTY_EDIT_SECOND, getEditSecond());
         }
         if(RString.isNotEmpty(getEditMinuteInterval())){
            config.set(PTY_EDIT_MINUTE_INTERVAL, getEditMinuteInterval());
         }
         if(RString.isNotEmpty(getEditSecondInterval())){
            config.set(PTY_EDIT_SECOND_INTERVAL, getEditSecondInterval());
         }
      }else if(EXmlConfig.Simple == type){
         if(RString.isNotEmpty(getName())){
            config.set(PTY_NAME, getName());
         ...
         if(RString.isNotEmpty(getEditDate())){
            config.set(PTY_EDIT_DATE, getEditDate());
         }
         if(RString.isNotEmpty(getEditSecond())){
            config.set(PTY_EDIT_SECOND, getEditSecond());
         }
         ...
         String sEditDate = getEditDate();
         if(RString.isNotEmpty(sEditDate)){
            config.set(PTY_EDIT_DATE, sEditDate);
         }
         String sEditHour = getEditHour();
         if(RString.isNotEmpty(sEditHour)){
            config.set(PTY_EDIT_HOUR, sEditHour);
         }
         String sEditMinute = getEditMinute();
         if(RString.isNotEmpty(sEditMinute)){
            config.set(PTY_EDIT_MINUTE, sEditMinute);
         }
         String sEditSecond = getEditSecond();
         if(RString.isNotEmpty(sEditSecond)){
            config.set(PTY_EDIT_SECOND, sEditSecond);
         }
         String sEditMinuteInterval = getEditMinuteInterval();
         if(RString.isNotEmpty(sEditMinuteInterval)){
            config.set(PTY_EDIT_MINUTE_INTERVAL, sEditMinuteInterval);
         }
         String sEditSecondInterval = getEditSecondInterval();
         if(RString.isNotEmpty(sEditSecondInterval)){
            config.set(PTY_EDIT_SECOND_INTERVAL, sEditSecondInterval);
         }
      }else if(EXmlConfig.Default == type){
         String sPadLeft = getPadLeft();
         if(RString.isNotEmpty(sPadLeft)){
