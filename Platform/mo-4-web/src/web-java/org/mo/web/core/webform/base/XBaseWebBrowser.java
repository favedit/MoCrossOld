...
// <T>流程窗口对象的XML节点基类。</T>
//============================================================
public abstract class XBaseWebBrowser
      extends FXmlObject
      implements
         XControlFace,
         XDatasetFace,
         XGridFace
{
   ...
   // 显示图标的名称定义
   public static final String PTY_DISP_ICON = "disp_icon";

   // 显示搜索栏的名称定义
   public static final String PTY_DISP_SEARCHBAR = "disp_searchbar";

   // 显示标题栏的名称定义
   public static final String PTY_DISP_TITLEBAR = "disp_titlebar";

   // 最大行数的名称定义
   public static final String PTY_DISP_COUNT = "disp_count";

   // 定义导入的名称定义
   public static final String PTY_DEFINE_IMPORTS = "define_imports";

   // 行高的名称定义
   public static final String PTY_ROW_HEIGHT = "row_height";

   // 字段名称的名称定义
   public static final String PTY_FIELD_NAME = "field_name";

   // 字段标签的名称定义
   public static final String PTY_FIELD_LABEL = "field_label";

   // 字段标签的名称定义
   public static final String PTY_FIELD_ICON = "field_icon";

   // 字段分组的名称定义
   public static final String PTY_FIELD_GROUP = "field_group";

   // 业务代码的名称定义
   public static final String PTY_BUSINESS_CODE = "business_code";
   ...
   // 显示图标的定义
   @AName("disp_icon")
   protected String _dispIcon;

   // 显示搜索栏的定义
   @AName("disp_searchbar")
   protected Boolean _dispSearchbar = Boolean.FALSE;

   // 显示标题栏的定义
   @AName("disp_titlebar")
   protected Boolean _dispTitlebar = Boolean.FALSE;
   ...
   // 定义导入的定义
   @AName("define_imports")
   protected String _defineImports;

   // 行高的定义
   @AName("row_height")
   protected String _rowHeight;
   ...
   // @param value 显示图标
   //============================================================
   public void setDispIcon(String value){
      _dispIcon = value;
   }
   ...
   // @return 显示搜索栏
   //============================================================
   public Boolean getDispSearchbar(){
   ...
   // @param value 显示搜索栏
   //============================================================
   public void setDispSearchbar(Boolean value){
      _dispSearchbar = value;
   }
   ...
   // @return 显示标题栏
   //============================================================
   public Boolean getDispTitlebar(){
      return _dispTitlebar;
   }
   ...
   // @param value 显示标题栏
   //============================================================
   public void setDispTitlebar(Boolean value){
      _dispTitlebar = value;
   }
   ...
   // @return 定义导入
   //============================================================
   public String getDefineImports(){
      return _defineImports;
   }
   ...
   // @param value 定义导入
   //============================================================
   public void setDefineImports(String value){
      _defineImports = value;
   }
   ...
   // @param value 字段标签
   //============================================================
   public void setFieldIcon(String value){
      _fieldIcon = value;
   }
   ...
   public String innerGet(String name){
      ...
      }else if(PTY_DISP_ICON.equalsIgnoreCase(name)){
         return getDispIcon();
      }else if(PTY_DISP_SEARCHBAR.equalsIgnoreCase(name)){
         return RBoolean.toString(getDispSearchbar());
      }else if(PTY_DISP_TITLEBAR.equalsIgnoreCase(name)){
         return RBoolean.toString(getDispTitlebar());
      }else if(PTY_DISP_COUNT.equalsIgnoreCase(name)){
         return getDispCount();
      }else if(PTY_DEFINE_IMPORTS.equalsIgnoreCase(name)){
         return getDefineImports();
      }else if(PTY_ROW_HEIGHT.equalsIgnoreCase(name)){
         return getRowHeight();
      }else if(PTY_FIELD_NAME.equalsIgnoreCase(name)){
         return getFieldName();
      }else if(PTY_FIELD_LABEL.equalsIgnoreCase(name)){
         return getFieldLabel();
      }else if(PTY_FIELD_ICON.equalsIgnoreCase(name)){
         return getFieldIcon();
      }else if(PTY_FIELD_GROUP.equalsIgnoreCase(name)){
         return getFieldGroup();
      }else if(PTY_BUSINESS_CODE.equalsIgnoreCase(name)){
   ...
   public void innerSet(String name, String value){
      if(RString.isEmpty(name)){
         ...
         setDispSearchbar(RBoolean.parse(value));
      }else if(PTY_DISP_TITLEBAR.equalsIgnoreCase(name)){
         setDispTitlebar(RBoolean.parse(value));
      }else if(PTY_DISP_COUNT.equalsIgnoreCase(name)){
         setDispCount(value);
      }else if(PTY_DEFINE_IMPORTS.equalsIgnoreCase(name)){
         setDefineImports(value);
      }else if(PTY_ROW_HEIGHT.equalsIgnoreCase(name)){
         setRowHeight(value);
      }else if(PTY_FIELD_NAME.equalsIgnoreCase(name)){
         setFieldName(value);
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("disp_icon")){
            setDispIcon(config.get(PTY_DISP_ICON));
         }
         if(config.contains("disp_searchbar")){
            setDispSearchbar(RBoolean.parse(config.get(PTY_DISP_SEARCHBAR)));
         }
         if(config.contains("disp_titlebar")){
            setDispTitlebar(RBoolean.parse(config.get(PTY_DISP_TITLEBAR)));
         }
         if(config.contains("disp_count")){
            setDispCount(config.get(PTY_DISP_COUNT));
         }
         if(config.contains("define_imports")){
            setDefineImports(config.get(PTY_DEFINE_IMPORTS));
         }
         if(config.contains("row_height")){
            setRowHeight(config.get(PTY_ROW_HEIGHT));
         }
         if(config.contains("field_name")){
            setFieldName(config.get(PTY_FIELD_NAME));
         }
         if(config.contains("field_label")){
            setFieldLabel(config.get(PTY_FIELD_LABEL));
         }
         if(config.contains("field_icon")){
            setFieldIcon(config.get(PTY_FIELD_ICON));
         }
         if(config.contains("field_group")){
            setFieldGroup(config.get(PTY_FIELD_GROUP));
         }
         if(config.contains("business_code")){
            setBusinessCode(config.get(PTY_BUSINESS_CODE));
         }
         ...
         if(RString.isEmpty(getDispIcon())){
            if(config.contains("disp_icon")){
               setDispIcon(config.get(PTY_DISP_ICON));
            }
         }
         ...
         if(RString.isEmpty(getDefineImports())){
            if(config.contains("define_imports")){
               setDefineImports(config.get(PTY_DEFINE_IMPORTS));
            }
         }
         if(RString.isEmpty(getFieldName())){
            if(config.contains("field_name")){
               setFieldName(config.get(PTY_FIELD_NAME));
            }
         }
         if(RString.isEmpty(getFieldLabel())){
            if(config.contains("field_label")){
               setFieldLabel(config.get(PTY_FIELD_LABEL));
            }
         }
         if(RString.isEmpty(getFieldIcon())){
            if(config.contains("field_icon")){
               setFieldIcon(config.get(PTY_FIELD_ICON));
            }
         }
         if(RString.isEmpty(getFieldGroup())){
            if(config.contains("field_group")){
               setFieldGroup(config.get(PTY_FIELD_GROUP));
            }
         }
         if(RString.isEmpty(getBusinessCode())){
            if(config.contains("business_code")){
               setBusinessCode(config.get(PTY_BUSINESS_CODE));
            }
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getDispIcon())){
            config.set(PTY_DISP_ICON, getDispIcon());
         }
         if(RBoolean.parse(getDispSearchbar())){
            config.set(PTY_DISP_SEARCHBAR, RBoolean.toString(getDispSearchbar()));
         }
         if(RBoolean.parse(getDispTitlebar())){
            config.set(PTY_DISP_TITLEBAR, RBoolean.toString(getDispTitlebar()));
         }
         if(RString.isNotEmpty(getDispCount())){
            config.set(PTY_DISP_COUNT, getDispCount());
         }
         if(RString.isNotEmpty(getDefineImports())){
            config.set(PTY_DEFINE_IMPORTS, getDefineImports());
         }
         if(RString.isNotEmpty(getRowHeight())){
            config.set(PTY_ROW_HEIGHT, getRowHeight());
         }
         if(RString.isNotEmpty(getFieldName())){
            config.set(PTY_FIELD_NAME, getFieldName());
         }
         if(RString.isNotEmpty(getFieldLabel())){
            config.set(PTY_FIELD_LABEL, getFieldLabel());
         }
         if(RString.isNotEmpty(getFieldIcon())){
            config.set(PTY_FIELD_ICON, getFieldIcon());
         }
         if(RString.isNotEmpty(getFieldGroup())){
            config.set(PTY_FIELD_GROUP, getFieldGroup());
         }
         if(RString.isNotEmpty(getBusinessCode())){
            config.set(PTY_BUSINESS_CODE, getBusinessCode());
         }
      }else if(EXmlConfig.Simple == type){
         if(RString.isNotEmpty(getName())){
            config.set(PTY_NAME, getName());
         ...
         String sDispIcon = getDispIcon();
         if(RString.isNotEmpty(sDispIcon)){
            config.set(PTY_DISP_ICON, sDispIcon);
         }
         Boolean bDispSearchbar = getDispSearchbar();
         if(RBoolean.parse(bDispSearchbar)){
            config.set(PTY_DISP_SEARCHBAR, RBoolean.toString(bDispSearchbar));
         }
         Boolean bDispTitlebar = getDispTitlebar();
         if(RBoolean.parse(bDispTitlebar)){
            config.set(PTY_DISP_TITLEBAR, RBoolean.toString(bDispTitlebar));
         }
         String sDispCount = getDispCount();
         if(RString.isNotEmpty(sDispCount)){
            config.set(PTY_DISP_COUNT, sDispCount);
         }
         String sDefineImports = getDefineImports();
         if(RString.isNotEmpty(sDefineImports)){
            config.set(PTY_DEFINE_IMPORTS, sDefineImports);
         }
         String sRowHeight = getRowHeight();
         if(RString.isNotEmpty(sRowHeight)){
            config.set(PTY_ROW_HEIGHT, sRowHeight);
         }
         String sFieldName = getFieldName();
         if(RString.isNotEmpty(sFieldName)){
            config.set(PTY_FIELD_NAME, sFieldName);
         }
         String sFieldLabel = getFieldLabel();
         if(RString.isNotEmpty(sFieldLabel)){
            config.set(PTY_FIELD_LABEL, sFieldLabel);
         }
         String sFieldIcon = getFieldIcon();
         if(RString.isNotEmpty(sFieldIcon)){
            config.set(PTY_FIELD_ICON, sFieldIcon);
         }
         String sFieldGroup = getFieldGroup();
         if(RString.isNotEmpty(sFieldGroup)){
            config.set(PTY_FIELD_GROUP, sFieldGroup);
         }
         String sBusinessCode = getBusinessCode();
         if(RString.isNotEmpty(sBusinessCode)){
            config.set(PTY_BUSINESS_CODE, sBusinessCode);
         }
      }else if(EXmlConfig.Default == type){
         String sPadLeft = getPadLeft();
         if(RString.isNotEmpty(sPadLeft)){
