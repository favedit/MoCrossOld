         ...
         XDescCalendarFace
{
   ...
   // 显示年的名称定义
   public static final String PTY_EDIT_YEAR = "edit_year";

   // 月显示的名称定义
   public static final String PTY_EDIT_MONTH = "edit_month";

   // 天显示的名称定义
   public static final String PTY_EDIT_DAY = "edit_day";

   // 开始年份的名称定义
   public static final String PTY_EDIT_YEAR_BEGIN = "edit_year_begin";

   // 结束年份的名称定义
   public static final String PTY_EDIT_YEAR_END = "edit_year_end";
   ...
   // 显示年的定义
   @AName("edit_year")
   protected String _editYear;

   // 月显示的定义
   @AName("edit_month")
   protected String _editMonth;

   // 天显示的定义
   @AName("edit_day")
   protected String _editDay;

   // 开始年份的定义
   @AName("edit_year_begin")
   protected String _editYearBegin;

   // 结束年份的定义
   @AName("edit_year_end")
   protected String _editYearEnd;
   ...
   // @param value 显示年
   //============================================================
   public void setEditYear(String value){
      _editYear = value;
   }
   ...
   // @param value 月显示
   //============================================================
   public void setEditMonth(String value){
      _editMonth = value;
   }
   ...
   // @param value 天显示
   //============================================================
   public void setEditDay(String value){
      _editDay = value;
   }
   ...
   // @return 开始年份
   //============================================================
   public String getEditYearBegin(){
      return _editYearBegin;
   }
   ...
   // @param value 开始年份
   //============================================================
   public void setEditYearBegin(String value){
      _editYearBegin = value;
   }
   ...
   // @param value 结束年份
   //============================================================
   public void setEditYearEnd(String value){
      _editYearEnd = value;
   }
   ...
   public String innerGet(String name){
      if(RString.isEmpty(name)){
         ...
         return getEditDate();
      }else if(PTY_EDIT_YEAR.equalsIgnoreCase(name)){
         return getEditYear();
      }else if(PTY_EDIT_MONTH.equalsIgnoreCase(name)){
         return getEditMonth();
      }else if(PTY_EDIT_DAY.equalsIgnoreCase(name)){
         return getEditDay();
      }else if(PTY_EDIT_YEAR_BEGIN.equalsIgnoreCase(name)){
         return getEditYearBegin();
      }else if(PTY_EDIT_YEAR_END.equalsIgnoreCase(name)){
         return getEditYearEnd();
      }
      return null;
   }
   ...
   public void innerSet(String name, String value){
      if(RString.isEmpty(name)){
         ...
         setEditYearBegin(value);
      }else if(PTY_EDIT_YEAR_END.equalsIgnoreCase(name)){
         setEditYearEnd(value);
      }
   }
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("edit_year")){
            setEditYear(config.get(PTY_EDIT_YEAR));
         }
         if(config.contains("edit_month")){
            setEditMonth(config.get(PTY_EDIT_MONTH));
         }
         if(config.contains("edit_day")){
            setEditDay(config.get(PTY_EDIT_DAY));
         }
         if(config.contains("edit_year_begin")){
            setEditYearBegin(config.get(PTY_EDIT_YEAR_BEGIN));
         }
         if(config.contains("edit_year_end")){
            setEditYearEnd(config.get(PTY_EDIT_YEAR_END));
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getEditYear())){
            config.set(PTY_EDIT_YEAR, getEditYear());
         }
         if(RString.isNotEmpty(getEditMonth())){
            config.set(PTY_EDIT_MONTH, getEditMonth());
         }
         if(RString.isNotEmpty(getEditDay())){
            config.set(PTY_EDIT_DAY, getEditDay());
         }
         if(RString.isNotEmpty(getEditYearBegin())){
            config.set(PTY_EDIT_YEAR_BEGIN, getEditYearBegin());
         }
         if(RString.isNotEmpty(getEditYearEnd())){
            config.set(PTY_EDIT_YEAR_END, getEditYearEnd());
         }
      }else if(EXmlConfig.Simple == type){
         if(RString.isNotEmpty(getName())){
            config.set(PTY_NAME, getName());
         ...
         String sEditYear = getEditYear();
         if(RString.isNotEmpty(sEditYear)){
            config.set(PTY_EDIT_YEAR, sEditYear);
         }
         String sEditMonth = getEditMonth();
         if(RString.isNotEmpty(sEditMonth)){
            config.set(PTY_EDIT_MONTH, sEditMonth);
         }
         String sEditDay = getEditDay();
         if(RString.isNotEmpty(sEditDay)){
            config.set(PTY_EDIT_DAY, sEditDay);
         }
         String sEditYearBegin = getEditYearBegin();
         if(RString.isNotEmpty(sEditYearBegin)){
            config.set(PTY_EDIT_YEAR_BEGIN, sEditYearBegin);
         }
         String sEditYearEnd = getEditYearEnd();
         if(RString.isNotEmpty(sEditYearEnd)){
            config.set(PTY_EDIT_YEAR_END, sEditYearEnd);
         }
      }else if(EXmlConfig.Default == type){
         String sPadLeft = getPadLeft();
         if(RString.isNotEmpty(sPadLeft)){
