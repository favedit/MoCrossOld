...
// @return 是否解析成功
//============================================================
TBool S{type_name}Size2::Parse(TCharC* pValue){
   // 检查长度
...
// @return 字符串
//============================================================
TCharC* S{type_name}Size2::Format(TChar* pBuffer, TInt capacity){
   TStringRefer result(pBuffer, capacity);
   result.AssignFormat(TC("width={format}, height={format}"), width, height);
   return pBuffer;
}
...
// @return 字符串
//============================================================
TCharC* S{type_name}Size2::ToString(TChar* pBuffer, TInt capacity){
   TStringRefer result(pBuffer, capacity);
   result.AppendFormat(TC("{format},{format}"), width, height);
   return pBuffer;
}
