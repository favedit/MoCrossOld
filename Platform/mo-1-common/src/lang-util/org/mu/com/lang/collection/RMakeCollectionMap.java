...
public class RMakeCollectionMap
{
   public static String makeMethods(String entries,
                                    String memory){
      FStringFile file = new FStringFile();
      file.loadFile("D:\\WP-Platform\\mo-1-common\\src\\lang-util\\org\\mu\\com\\lang\\collection\\template.map.methods.txt", "utf-8");
   ...
   public static void main(String[] args){
      String filePath = "D:\\WP-Script\\1-Common\\MoLanguage";
      ...
      FStringFile file = new FStringFile();
      file.loadFile(sourcePath + "\\template.map.txt", "utf-8");
      // 生成Array
      String source = file.toString();
      ...
      soureFile.saveFile(filePath + "\\MoCmMap.h", "GBK");
