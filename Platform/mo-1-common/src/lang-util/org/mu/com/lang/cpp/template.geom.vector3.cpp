...
// @return 是否解析成功
//============================================================
TBool S{type_name}Vector3::Parse(TCharC* pValue){
   // 检查长度
...
// @return 字符串
//============================================================
TCharC* S{type_name}Vector3::Format(TChar* pBuffer, TInt capacity){
...
// @return 字符串
//============================================================
TCharC* S{type_name}Vector3::ToString(TChar* pBuffer, TInt capacity){
   TStringRefer result(pBuffer, capacity);
