...
// @return 是否解析成功
//============================================================
TBool S{type_name}Point4::Parse(TCharC* pValue){
   // 检查长度
...
// @return 字符串
//============================================================
TCharC* S{type_name}Point4::Format(TChar* pBuffer, TInt capacity){
...
// @return 字符串
//============================================================
TCharC* S{type_name}Point4::ToString(TChar* pBuffer, TInt capacity){
   TStringRefer result(pBuffer, capacity);
