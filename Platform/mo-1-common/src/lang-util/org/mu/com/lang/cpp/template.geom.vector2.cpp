...
// @return 是否解析成功
//============================================================
TBool S{type_name}Vector2::Parse(TCharC* pValue){
   // 检查长度
...
// @return 字符串
//============================================================
TCharC* S{type_name}Vector2::Format(TChar* pBuffer, TInt capacity){
   TStringRefer result(pBuffer, capacity);
   result.AssignFormat(TC("x={format}, y={format}"), x, y);
   return pBuffer;
}
...
// @return 字符串
//============================================================
TCharC* S{type_name}Vector2::ToString(TChar* pBuffer, TInt capacity){
   TStringRefer result(pBuffer, capacity);
   result.AppendFormat(TC("{format},{format}"), x, y);
   return pBuffer;
}
