...
//============================================================
@ATypes
public abstract class MDoubles
{
   // 容量
   ...
   // @param values 基础类型集合
   //============================================================
   public void assign(MDoubles values){
   ...
   // @param values 基础类型集合
   //============================================================
   public void append(MDoubles values){
   ...
   //============================================================
   public double pop(){
      double value = _memory[_length - 1];
      _length--;
      return value;
   }
   ...
   public double[] toArray(){
      double[] alloc = new double[_length];
      if(null != _memory){
         System.arraycopy(_memory, 0, alloc, 0, _length);
      }
      return alloc;
   ...
   // @param length 数据长度
   //============================================================
   public void copy(double[] memory,
                    int offset,
                    int length){
      if(null != _memory){
