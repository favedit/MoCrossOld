...
public class RBaseDouble
{
   ...
   // @return 是否相等
   //============================================================
   public final static boolean equals(double[] source, int sourceLength, double[] target, int targetLength){
      // 内容都为空
   ...
   // @return 是否相等
   //============================================================
   public final static boolean equals(double[] source, int sourceOffset, int sourceLength, double[] target, int targetOffset, int targetLength){
      // 内容都为空
      if((source == null) && (sourceLength == 0) && (target == null) && (targetLength == 0)){
         return true;
      }
   ...
   // @return 是否含有
   //============================================================
   public final static boolean contains(double[] values, double find){
      if(null != values){
   ...
   // @return 是否含有
   //============================================================
   public final static boolean contains(double[] values, int offset, int length, double find){
      if(null != values){
   ...
   // @return 比较结果
   //============================================================
   public final static int compare(double[] source, double[] target){
   ...
   // @return 比较结果
   //============================================================
   public final static int compare(double[] source, int sourceOffset, int sourceLength, double[] target, int targetOffset, int targetLength){
   ...
   // @return 索引位置
   //============================================================
   public final static int indexOf(double[] values, double find){
      if(null != values){
         int loop = values.length;
         for(int n = 0; n < loop; n++){
            if(values[n] == find){
   ...
   // @return 索引位置
   //============================================================
   public final static int indexOf(double[] values, int offset, int length, double find){
      if(null != values){
         int loop = offset + length;
         for(int n = 0; n < loop; n++){
            if(values[n] == find){
   ...
   // @return 索引位置
   //============================================================
   public final static int search(double[] source, double[] target){
   ...
   // @return 索引位置
   //============================================================
   public final static int search(double[] source, int offset, int length, double[] target){
   ...
   // @return 索引位置
   //============================================================
   public final static int search(double[] source, int sourceOffset, int sourceLength, double[] target, int targetOffset, int targetLength){
   ...
   // @return 索引位置
   //============================================================
   public final static int search(double[] source, int offset, int length, double before, double[] target, int targetOffset, int targetLength, double after){
      int i;
      int el;
      int n = offset - 1;
   ...
   //============================================================
   public final static void fill(double[] source, double value){
   ...
   // @param value 双精度浮点数内容
   //============================================================
   public final static void fill(double[] source, int offset, int length, double value){
      int n = offset - 1;
   ...
   // @param to 被替换字符数组
   //============================================================
   public final static void replace(double[] source, double from, double to){
   ...
   // @param to 被替换字符数组
   //============================================================
   public final static void replace(double[] source, int offset, int length, double from, double to){
      int n = offset - 1;
      while(++n < length){
         if(source[n] == from){
            source[n] = to;
   ...
   // @return 替换后的字符数组
   //============================================================
   public final static double[] replace(double[] source, int offset, int length, double[] from, double[] to){
   ...
   // @return 替换后的字符数组
   //============================================================
   public final static double[] replace(double[] source, int offset, int length, double[] from, int fromOffset, int fromLength, double[] to, int toOffset, int toLength){
      boolean same = true;
   ...
   // @return 中间数组
   //============================================================
   public final static double[] sub(double[] source, int offset, int length){
      double[] result = null;
      if(length > 0){
   ...
   // @return 中间数组
   //============================================================
   public static double[] mid(double[] source, int start, int end){
   ...
   // @param length 索引长度
   //============================================================
   public final static void reverse(double[] values, int index, int length){
      int s = index - 1;
   ...
   // @param length 索引长度
   //============================================================
   public final static int erase(double[] values, int index, int length){
      if(null != values){
   ...
   // @param find 双精度浮点数内容
   //============================================================
   public final static int remove(double[] values, int offset, int length, double find){
      int index = offset;
   ...
   // @param targetLength 目标长度
   //============================================================
   public final static int remove(double[] source, int sourceOffset, int sourceLength, double[] target, int targetOffset, int targetLength){
   ...
   // @param count 数组长度
   //============================================================
   public final static void clear(double[] values, int offset, int length){
      if(null != values){
         int loop = offset + length;
         for(int n = offset; n < loop; n++){
            values[n] = 0;
