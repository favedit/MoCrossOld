...
// @history 130219 创建
//============================================================
public class RBaseFloat
{
   // 默认值
   public final static float DEFAULT = 0;

   // 空集合
   public final static float EMPTY_COLLECTION[] = new float[0];

   //============================================================
   // <T>判断来源浮点数数组和目标浮点数数组是否相等。</T>
   //
   // @param source 来源浮点数数组
   ...
   //============================================================
   // <T>以指定字符开头和结尾，从源浮点数数组中查找目标浮点数数组存在索引位置。</T>
   //
   // @param source 源对象数组
   // @param offset 开始位置
   // @param count 项目总数
