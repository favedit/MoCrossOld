 ...
 * 
 * @author ALEX
 * @version 1.00 - 2005/10/14
 */
public class RNamingList<V>
{
   //   /**
   ...
   //    * @return 最长的长度
   //    */
   //   public static <V>int nameMaxLength(FCustomNamingList<?, V> oList){
   //      int nLength = 0;
   //      int nMaxLength = 0;
   //      int nCount = oList.size();
   //      String[] arNames = oList.memoryNames();
   //      for(int n = 0; n < nCount; n++){
   //         nLength = arNames.length;
   ...
   //    * @param oList 名称列表
   //    */
   //   public static <V>void namesToLowerCase(FCustomNamingList<?, V> oList){
   //      int nCount = oList.size();
   //      String[] arNames = oList.memoryNames();
   //      for(int n = 0; n < nCount; n++){
   //         arNames[n] = arNames[n].toLowerCase();
   //      }
   //   }
   //
   //   /**
   ...
   //    * @param oList 名称列表
   //    */
   //   public static <V>void namesToUpperCase(FCustomNamingList<?, V> oList){
   //      int nCount = oList.size();
   //      String[] arNames = oList.memoryNames();
   //      for(int n = 0; n < nCount; n++){
   //         arNames[n] = arNames[n].toUpperCase();
   //      }
   //   }
   //
   //   /**
