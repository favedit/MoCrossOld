...
${OBJECTDIR}/Alloc.o: Alloc.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Alloc.o Alloc.c

${OBJECTDIR}/Bra.o: Bra.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Bra.o Bra.c

${OBJECTDIR}/LzFind.o: LzFind.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/LzFind.o LzFind.c

${OBJECTDIR}/Lzma2Dec.o: Lzma2Dec.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Lzma2Dec.o Lzma2Dec.c

${OBJECTDIR}/Lzma86Dec.o: Lzma86Dec.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Lzma86Dec.o Lzma86Dec.c

${OBJECTDIR}/LzmaDec.o: LzmaDec.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/LzmaDec.o LzmaDec.c

${OBJECTDIR}/LzmaLib.o: LzmaLib.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/LzmaLib.o LzmaLib.c
