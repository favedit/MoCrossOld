...
// <T>WindowsX86平台定义。</T>
//============================================================
#if defined(_MO_WINDOWS) && defined(_MO_X86)
#ifndef __MO_CM_WINDOWS_86_H__
#define __MO_CM_WINDOWS_86_H__
...
//============================================================
/// @define 产生例外
#define MO_RAISE_DEBUG() __asm{int 3};
/// @define 产生例外退出
...
#else
#define MO_FS_PACK_LENGTH       1024*1024
#define MO_FS_SQL_MAX_LENGTH    1024*1024
#define MO_FS_SPRINT_LENGTH     1024*1024
#define MO_FS_LOGGER_LENGTH     1024*1024
#define MO_FS_DUMP_LENGTH       1024*1024
#define MO_FS_TRACK_LENGTH      1024*1024
#endif // _MO_STACK_MIN
...
/// @type 只读32位无符号整数
typedef const unsigned long TUint32C;
/// @type 32位无符号整数
