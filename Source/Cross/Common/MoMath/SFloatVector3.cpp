...
// @return 是否解析成功
//============================================================
TBool SFloatVector3::Parse(TCharC* pValue){
   // 检查长度
...
// @return 字符串
//============================================================
TCharC* SFloatVector3::Format(TChar* pBuffer, TInt capacity){
   TStringRefer result(pBuffer, capacity);
   result.AssignFormat(TC("x=%f, y=%f, z=%f"), x, y, z);
   return pBuffer;
}
...
// @return 字符串
//============================================================
TCharC* SFloatVector3::ToString(TChar* pBuffer, TInt capacity){
   TStringRefer result(pBuffer, capacity);
   result.AppendFormat(TC("%f,%f,%f"), x, y, z);
   return pBuffer;
}
