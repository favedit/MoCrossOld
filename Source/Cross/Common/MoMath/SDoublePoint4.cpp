...
// @return 是否解析成功
//============================================================
TBool SDoublePoint4::Parse(TCharC* pValue){
   // 检查长度
...
// @return 字符串
//============================================================
TCharC* SDoublePoint4::Format(TChar* pBuffer, TInt capacity){
...
// @return 字符串
//============================================================
TCharC* SDoublePoint4::ToString(TChar* pBuffer, TInt capacity){
   TStringRefer result(pBuffer, capacity);
