#ifndef __MO_BF_RENDER_H__
#define __MO_BF_RENDER_H__
//************************************************************
...
// <T>渲染层信息。</T>
//============================================================
class MO_BF_DECLARE FBfRenderLayout : public FRenderLayout
{
...
//------------------------------------------------------------
typedef MO_BF_DECLARE FObjects<FBfRenderLayout*> FBfRenderLayoutCollection;

//============================================================
// <T>渲染顶点缓冲。</T>
//============================================================
class MO_BF_DECLARE FBfRenderVertexBuffer : public FRenderVertexBuffer
{
...
// <T>渲染索引缓冲。</T>
//============================================================
class MO_BF_DECLARE FBfRenderIndexBuffer : public FRenderIndexBuffer
{
...
// <T>渲染器缓冲。</T>
//============================================================
class MO_BF_DECLARE FBfRenderShaderBuffer : public FRenderShaderBuffer
{
...
// <T>渲染器参数。</T>
//============================================================
class MO_BF_DECLARE FBfRenderShaderParameter : public FRenderShaderParameter
{
...
// <T>顶点渲染器。</T>
//============================================================
class MO_BF_DECLARE FBfRenderVertexShader : public FRenderVertexShader
{
...
// <T>像素渲染器。</T>
//============================================================
class MO_BF_DECLARE FBfRenderFragmentShader : public FRenderFragmentShader
{
...
// <T>渲染程序。</T>
//============================================================
class MO_BF_DECLARE FBfRenderProgram : public FRenderProgram
{
...
// <T>渲染目标。</T>
//============================================================
class MO_BF_DECLARE FBfRenderTarget : public FRenderTarget
{
...
// <T>渲染平面纹理。</T>
//============================================================
class MO_BF_DECLARE FBfRenderFlatTexture : public FRenderFlatTexture
{
...
// <T>渲染CUBE纹理。</T>
//============================================================
class MO_BF_DECLARE FBfRenderCubeTexture : public FRenderCubeTexture
{
...
// <T>渲染设备。</T>
//============================================================
class MO_BF_DECLARE FBfRenderDevice : public FRenderDevice
{
