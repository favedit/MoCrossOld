...
MO_CLASS_IMPLEMENT_INHERITS(FBfRenderTarget, FRenderTarget);

//============================================================
// <T>构造渲染目标。</T>
//============================================================
FBfRenderTarget::FBfRenderTarget(){
...
// @return 处理结果
//============================================================
TResult FBfRenderTarget::OnSetup(){
   TResult resultCd = ESuccess;
   MO_CHECK(_pDevice, return ENull);
   FBfRenderDevice* pDevice = _pDevice->Convert<FBfRenderDevice>();
   //............................................................
   // 创建渲染目标
...
// @return 处理结果
//============================================================
TResult FBfRenderTarget::Suspend(){
   TResult resultCd = ESuccess;
   //if(_depthBufferId != 0){
...
// @return 处理结果
//============================================================
TResult FBfRenderTarget::Resume(){
   OnSetup();
...
// @return 处理结果
//============================================================
TResult FBfRenderTarget::Dispose(){
   return ESuccess;
}
