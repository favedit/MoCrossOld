...
// @return 处理结果
//============================================================
TResult FUiNumber::SetTextAlignCd(EControlTextAlign textAlignCd){
   // 检查数据
...
// @return 处理结果
//============================================================
TResult FUiNumber::SetText(TWideCharC* pText){
   // 检查数据
...
// @return 处理结果
//============================================================
TResult FUiNumber::OnUnserialize(IDataInput* pInput){
   // 父信息反序列化
