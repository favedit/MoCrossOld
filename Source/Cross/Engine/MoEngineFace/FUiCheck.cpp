...
// @return 处理结果
//============================================================
TResult FUiCheck::SetTextAlignCd(EControlTextAlign textAlignCd){
   // 检查数据
...
// @return 处理结果
//============================================================
TResult FUiCheck::SetText(TWideCharC* pText){
   // 检查数据
...
// @return 处理结果
//============================================================
TResult FUiCheck::OnUnserialize(IDataInput* pInput){
   // 父信息反序列化
