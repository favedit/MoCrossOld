...
// <T>构造显示颜色渲染器。</T>
//============================================================
FPoe22dColorEffect::FPoe22dColorEffect(){
   _limitCount = 16384;
   _count = 0;
...
// <T>配置处理。</T>
//============================================================
TResult FPoe22dColorEffect::Setup(){
...
// <T>更新开始处理。</T>
//============================================================
TResult FPoe22dColorEffect::UpdateBegin(){
   _limitCount = 0;
   _count = 0;
...
//============================================================
TResult FPoe22dColorEffect::WriteRenderable(FRenderable* pRenderable){
   //// 检查限制
...
// <T>更新结束处理。</T>
//============================================================
TResult FPoe22dColorEffect::UpdateEnd(){
   // 上传顶点数据
...
// @return 处理结果
//============================================================
TResult FPoe22dColorEffect::Resize(TInt width, TInt height){
   // 计算MVP矩阵
   _mvpMatrix.tx = -1;
   _mvpMatrix.ty = 1;
...
// <T>绘制处理。</T>
//============================================================
TResult FPoe22dColorEffect::Draw(){
   //// 获得引用
   //FRenderDevice* pRenderDevice = RDeviceManager::Instance().RenderDevice();
   //// 设定程序
   //FPoe2RenderProgram* pProgram = (FPoe2RenderProgram*)_program;
