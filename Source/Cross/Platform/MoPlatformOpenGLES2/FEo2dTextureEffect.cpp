...
// <T>构造显示渲染技术。</T>
//============================================================
FPoe22dTextureEffect::FPoe22dTextureEffect(){
   //_limitCount = 16384;
   //_count = 0;
...
// <T>配置处理。</T>
//============================================================
TResult FPoe22dTextureEffect::Setup(){
 ...
 //  }
 //  // 上传顶点位置
 //  _pVertexPositionBuffer = (FPoe2RenderVertexBuffer*)pRenderDevice->CreateVertexBuffer();
 ...
 //  // 上传顶点颜色
 //  _pVertexColorBuffer = (FPoe2RenderVertexBuffer*)pRenderDevice->CreateVertexBuffer();
 ...
 //  // 上传顶点纹理坐标
 //  _pVertexCoordBuffer = (FPoe2RenderVertexBuffer*)pRenderDevice->CreateVertexBuffer();
 ...
 //  // 创建索引流
 //  TInt vertexIndex = 0;
 //  _pIndexBuffer = (FPoe2RenderIndexBuffer*)pRenderDevice->CreateIndexBuffer();
...
// <T>更新开始处理。</T>
//============================================================
TResult FPoe22dTextureEffect::UpdateBegin(){
   _count = 0;
...
//============================================================
TResult FPoe22dTextureEffect::WriteRenderable(FRenderable* pRenderable){
   //// 计算数据
...
// <T>更新结束处理。</T>
//============================================================
TResult FPoe22dTextureEffect::UpdateEnd(){
   // 上传顶点数据
...
// @return 处理结果
//============================================================
TResult FPoe22dTextureEffect::Resize(TInt width, TInt height){
   // 计算MVP矩阵
   _mvpMatrix.tx = -1;
   _mvpMatrix.ty = 1;
   _mvpMatrix.rx = MO_PI_FLOAT;
...
// <T>绘制处理。</T>
//============================================================
TResult FPoe22dTextureEffect::Draw(){
   //// 设置设备状态
