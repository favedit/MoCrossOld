...
TResult FPd9RenderTarget::OnSetup(){
   ...
   FPd9RenderDevice* pDevice = _pDevice->Convert<FPd9RenderDevice>();
   //............................................................
   // 创建渲染目标
   //ID3D9Resource* pBackBuffer = NULL;
   //dxResult = pDevice->NativeSwapChain()->GetBuffer(0, __uuidof(ID3D9Texture2D), (LPVOID*)&pBackBuffer);
   //if(FAILED(dxResult)){
   //   MO_FATAL("Get backbugger failure.");
   //   return EFailure;
   //}
   //ID3D9RenderTargetView* _pRenderTarget = NULL;
