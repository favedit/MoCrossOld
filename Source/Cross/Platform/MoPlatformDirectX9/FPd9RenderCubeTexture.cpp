...
TResult FPd9RenderCubeTexture::Upload(TByteC* pData, TInt length){
   ...
   //MO_RELEASE(_piTexture);
   //// 设置参数
   //D3D9_TEXTURE2D_DESC descriptor = {0};
   ...
   //descriptor.MiscFlags = D3D9_RESOURCE_MISC_TEXTURECUBE;
   ////descriptor.MiscFlags = D3D9_RESOURCE_MISC_TEXTURECUBE | D3D9_RESOURCE_MISC_GENERATE_MIPS;
   //// 设置内存
   //D3D9_SUBRESOURCE_DATA data[6] = {0};
   //for(TInt n = 0; n < 6; n++){
   //   D3D9_SUBRESOURCE_DATA& item = data[n];
   ...
   //viewDescriptor.ViewDimension = D3D9_SRV_DIMENSION_TEXTURECUBE;
