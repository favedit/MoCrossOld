...
// @return 处理结果
//============================================================
ERenderAttributeFormat RDirectX11::ParseAttrbuteFormat(D3D_REGISTER_COMPONENT_TYPE componentType, TInt mask){
   // 判断位数
   TInt count = 0;
   if(mask & 0x01){
      count++;
...
// @return 属性格式
//============================================================
DXGI_FORMAT RDirectX11::ConvertAttrbuteFormat(ERenderAttributeFormat formatCd){
   switch(formatCd){
