...
MO_CLASS_IMPLEMENT_INHERITS(FPoRenderFlatTexture, FRenderFlatTexture);

//============================================================
// <T>构造平面纹理。</T>
//============================================================
FPoRenderFlatTexture::FPoRenderFlatTexture(){
   _textureId = 0;
}
...
// @return 处理结果
//============================================================
TResult FPoRenderFlatTexture::Resize(TInt width, TInt height){
...
// @return 处理结果
//============================================================
TResult FPoRenderFlatTexture::Upload(TByteC* pData, TInt length){
   // 检查参数
...
// @return 处理结果
//============================================================
TResult FPoRenderFlatTexture::Unserialize(IDataInput* pInput){
   // 检查参数
...
// <T>加载数据文件。</T>
//============================================================
TResult FPoRenderFlatTexture::LoadDataFile(TCharC* pFileName){
   // 检查参数
...
// @return 处理结果
//============================================================
TResult FPoRenderFlatTexture::Suspend(){
   return ESuccess;
}
...
// @return 处理结果
//============================================================
TResult FPoRenderFlatTexture::Resume(){
   OnSetup();
   if(!_pData->IsEmpty()){
...
// @return 处理结果
//============================================================
TResult FPoRenderFlatTexture::Dispose(){
   return ESuccess;
}
