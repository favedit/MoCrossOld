...
MO_CLASS_IMPLEMENT_INHERITS(FPoRenderTarget, FRenderTarget);
...
// @return 处理结果
//============================================================
TResult FPoRenderTarget::OnSetup(){
...
// @return 处理结果
//============================================================
TResult FPoRenderTarget::Suspend(){
   TResult resultCd = ESuccess;
   if(_depthBufferId != 0){
...
// @return 处理结果
//============================================================
TResult FPoRenderTarget::Dispose(){
   return ESuccess;
}
