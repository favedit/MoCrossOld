...
// <T>共通定义。</T>
//============================================================
#ifndef __MO_POE3_PUBLIC_H__
#define __MO_POE3_PUBLIC_H__
...
//============================================================
/// @define 导出定义
#ifdef _MO_POE3_EXPORTS
#define MO_POE3_DECLARE MO_EXPORT
#else
#define MO_POE3_DECLARE MO_IMPORT
#endif // _MO_POE3_EXPORTS

MO_NAMESPACE_BEGIN

MO_NAMESPACE_END

#endif // __MO_POE3_PUBLIC_H__
