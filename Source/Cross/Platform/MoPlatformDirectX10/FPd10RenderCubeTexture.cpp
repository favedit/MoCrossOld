...
MO_CLASS_IMPLEMENT_INHERITS(FPd10RenderCubeTexture, FRenderFlatTexture);

//============================================================
// <T>构造渲染CUBE纹理。</T>
//============================================================
FPd10RenderCubeTexture::FPd10RenderCubeTexture(){
   MO_CLEAR(_piTexture);
   MO_CLEAR(_piView);
   MO_CLEAR(_piState);
}
...
// @return 处理结果
//============================================================
TResult FPd10RenderCubeTexture::OnSetup(){
...
// @return 处理结果
//============================================================
TResult FPd10RenderCubeTexture::Resize(TInt size){
   _size.Set(size, size);
   return ESuccess;
}
...
// @return 处理结果
//============================================================
TResult FPd10RenderCubeTexture::Upload(TByteC* pData, TInt length){
   // 检查参数
...
// @return 处理结果
//============================================================
TResult FPd10RenderCubeTexture::Unserialize(IDataInput* pInput){
   // 检查参数
...
// <T>加载数据文件。</T>
//============================================================
TResult FPd10RenderCubeTexture::LoadDataFile(TCharC* pFileName){
   // 检查参数
...
// @return 处理结果
//============================================================
TResult FPd10RenderCubeTexture::Suspend(){
   return ESuccess;
}
...
// @return 处理结果
//============================================================
TResult FPd10RenderCubeTexture::Resume(){
   OnSetup();
   //if(!_pData->IsEmpty()){
...
// @return 处理结果
//============================================================
TResult FPd10RenderCubeTexture::Dispose(){
   return ESuccess;
}
