...
MO_CLASS_IMPLEMENT_INHERITS(FPd10RenderTarget, FRenderTarget);

//============================================================
// <T>构造渲染目标。</T>
//============================================================
FPd10RenderTarget::FPd10RenderTarget(){
...
// @return 处理结果
//============================================================
TResult FPd10RenderTarget::OnSetup(){
   TResult resultCd = ESuccess;
   MO_CHECK(_pDevice, return ENull);
   FPd10RenderDevice* pDevice = _pDevice->Convert<FPd10RenderDevice>();
   //............................................................
   // 创建渲染目标
   //ID3D10Resource* pBackBuffer = NULL;
   //dxResult = pDevice->NativeSwapChain()->GetBuffer(0, __uuidof(ID3D10Texture2D), (LPVOID*)&pBackBuffer);
   //if(FAILED(dxResult)){
   //   MO_FATAL("Get backbugger failure.");
   //   return EFailure;
   //}
   //ID3D10RenderTargetView* _pRenderTarget = NULL;
...
// @return 处理结果
//============================================================
TResult FPd10RenderTarget::Suspend(){
   TResult resultCd = ESuccess;
   //if(_depthBufferId != 0){
...
// @return 处理结果
//============================================================
TResult FPd10RenderTarget::Resume(){
   OnSetup();
...
// @return 处理结果
//============================================================
TResult FPd10RenderTarget::Dispose(){
   return ESuccess;
}
