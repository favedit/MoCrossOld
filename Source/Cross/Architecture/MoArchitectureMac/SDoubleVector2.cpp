...
// @return 是否解析成功
//============================================================
TBool SDoubleVector2::Parse(TCharC* pValue){
   // 检查长度
...
// @return 字符串
//============================================================
TCharC* SDoubleVector2::Format(TChar* pBuffer, TInt capacity){
...
// @return 字符串
//============================================================
TCharC* SDoubleVector2::ToString(TChar* pBuffer, TInt capacity){
   TStringRefer result(pBuffer, capacity);
