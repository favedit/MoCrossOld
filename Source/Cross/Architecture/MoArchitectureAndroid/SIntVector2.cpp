...
// @return 是否解析成功
//============================================================
TBool SIntVector2::Parse(TCharC* pValue){
   // 检查长度
...
// @return 字符串
//============================================================
TCharC* SIntVector2::Format(TChar* pBuffer, TInt capacity){
   TStringRefer result(pBuffer, capacity);
   result.AssignFormat(TC("x=%d, y=%d"), x, y);
   return pBuffer;
}
...
// @return 字符串
//============================================================
TCharC* SIntVector2::ToString(TChar* pBuffer, TInt capacity){
   TStringRefer result(pBuffer, capacity);
   result.AppendFormat(TC("%d,%d"), x, y);
   return pBuffer;
}
