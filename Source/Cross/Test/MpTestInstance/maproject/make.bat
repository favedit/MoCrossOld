SET MO_HOME=%MO_ROOT%\Cross\Test\MpTestInstance\maproject
...
COPY /Y %MO_ROOT%\Cross\Engine\MoEngineAndroid\maproject\obj\local\armeabi\libMoEngineAndroid.a      %MO_HOME%\jni\libMoEngineAndroid.a
COPY /Y %MO_ROOT%\Cross\Engine\MoEngineOpenGL\maproject\obj\local\armeabi\libMoEngineOpenGL.a        %MO_HOME%\jni\libMoEngineOpenGL.a
...
echo COPY /Y %MO_HOME%\libs\armeabi\libMpCoolLight.so %MO_ROOT%\Android\MpTestInstance\libs\armeabi\libMpCoolLight.so
COPY /Y %MO_HOME%\libs\armeabi\libMpCoolLight.so %MO_ROOT%\Android\MpTestInstance\libs\armeabi\libMpCoolLight.so
