...
namespace MO.Core.Window.Api {
   ...
   public interface IMultiLanguage2 {
      ...
      void GetCharsetInfo(
         ...
         out SMimeCsetInfo pCharsetInfo);
      ...
      void CreateConvertCharset(
         ...
         [In] uint dwProperty,
         [MarshalAs(UnmanagedType.Interface)] out FMLangConvertCharset ppMLangConvertCharset);
      ...
      void ValidateCodePage(
         [In] uint uiCodePage,
         [In, ComAliasName("MultiLanguage.wireHWND")] ref SRemotableHandle hwnd);
