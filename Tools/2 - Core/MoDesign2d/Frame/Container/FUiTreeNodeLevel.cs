...
namespace MO.Design2d.Frame.Container
{
   ...
   // <T>控件声明。</T>
   //============================================================
   public class FUiTreeNodeLevel : FUiControl
   {
      //============================================================
      // <T>构造控件。</T>
      //============================================================
      public FUiTreeNodeLevel(FUiFrameConsole console = null)
         : base(console) {
      }
      ...
      // <T>获得资源。</T>
      //============================================================
      public FRcTreeNodeLevel TreeNodeLevelResource {
         get { return _resource as FRcTreeNodeLevel; }
      }
