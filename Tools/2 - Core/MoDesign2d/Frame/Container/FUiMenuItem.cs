...
namespace MO.Design2d.Frame.Container
{
   ...
   // <T>控件声明。</T>
   //============================================================
   public class FUiMenuItem : FUiControl
   {
      //============================================================
      // <T>构造控件。</T>
      //============================================================
      public FUiMenuItem(FUiFrameConsole console = null)
         : base(console) {
      }
      ...
      // <T>获得资源。</T>
      //============================================================
      public FRcMenuItem MenuItemResource {
         get { return _resource as FRcMenuItem; }
      }
