...
namespace MO.Design2d.Frame.Container
{
   ...
   // <T>控件声明。</T>
   //============================================================
   public class FUiTreeNodeType : FUiControl
   {
      //============================================================
      // <T>构造控件。</T>
      //============================================================
      public FUiTreeNodeType(FUiFrameConsole console = null)
         : base(console) {
      }
      ...
      // <T>获得资源。</T>
      //============================================================
      public FRcTreeNodeType TreeNodeTypeResource {
         get { return _resource as FRcTreeNodeType; }
      }
