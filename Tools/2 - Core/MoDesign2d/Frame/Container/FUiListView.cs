...
namespace MO.Design2d.Frame.Container
{
   ...
   // <T>控件声明。</T>
   //============================================================
   public class FUiListView : FUiControl
   {
      //============================================================
      // <T>构造控件。</T>
      //============================================================
      public FUiListView(FUiFrameConsole console = null)
         : base(console) {
      }
      ...
      // <T>获得资源。</T>
      //============================================================
      public FRcListView ListViewResource {
         get { return _resource as FRcListView; }
      }
