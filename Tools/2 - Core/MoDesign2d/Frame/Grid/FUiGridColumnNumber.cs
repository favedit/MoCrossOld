...
namespace MO.Design2d.Frame.Grid
{
   ...
   // <T>控件声明。</T>
   //============================================================
   public class FUiGridColumnNumber : FUiControl
   {
      //============================================================
      // <T>构造控件。</T>
      //============================================================
      public FUiGridColumnNumber(FUiFrameConsole console = null)
         : base(console) {
      }
      ...
      // <T>获得资源。</T>
      //============================================================
      public FRcGridColumnNumber GridColumnNumberResource {
         get { return _resource as FRcGridColumnNumber; }
      }
