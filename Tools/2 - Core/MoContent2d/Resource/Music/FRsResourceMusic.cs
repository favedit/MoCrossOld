...
namespace MO.Content2d.Resource.Music
{
   //============================================================
   // <T>设计声音资源。</T>
   //============================================================
   public class FRsResourceMusic : FRsResource
   {
      // 日志输出接口
      private static ILogger _logger = RLogger.Find(typeof(FRsResourceMusic));
      ...
      // <T>构造设计声音资源。</T>
      //============================================================
      public FRsResourceMusic() {
         _typeCd = ERsResource.Music;
         _typeName = ERsResource.MusicCode;
      }
      ...
      public override void Export(ERsExportMode modeCd){
         ...
         Open();
         //............................................................
         string exportDirectory = RContent2dManager.ResourceConsole.ExportDirectory + "\\ms";
         //............................................................
         FByteFile file = new FByteFile();
         file.LoadFile(_fileName);
         file.SaveFile(exportDirectory + "\\" + Code + ".mp3");
         //............................................................
         _logger.Debug(this, "Export", "Export music resource. (type_name={0}, code={1})", _typeName, _code);
      }
