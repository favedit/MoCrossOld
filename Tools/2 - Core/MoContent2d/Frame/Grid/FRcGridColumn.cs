...
namespace MO.Content2d.Frame.Grid
{
   ...
   // <T>控件声明。</T>
   //============================================================
   public class FRcGridColumn : FRcControl
   {
      //============================================================
      // <T>构造控件。</T>
      //============================================================
      public FRcGridColumn(FRcFrameConsole console = null)
         : base(console) {
      ...
      public override void LoadStyleProperty() {
         ...
         // 加载样式信息
         FTplThemeStyle style = RContent2dManager.ThemeConsole.FindActiveStyle("frame.grid.column");
         if (style != null) {
         }
      }
