...
namespace MO.Content2d.Frame.Common
{
   ...
   //============================================================
   public class FRcDataControl : FRcControl
   {
      // 数据名称
      ...
      public override void OnLoadConfig(FXmlNode xconfig) {
         ...
         _displayInsert = xconfig.GetBoolean("display_insert");
         _displayUpdate = xconfig.GetBoolean("display_update");
         _displayDelete = xconfig.GetBoolean("display_delete");
      ...
      public override void OnSaveConfig(FXmlNode xconfig) {
         ...
         xconfig.Set("display_insert", _displayInsert);
         xconfig.Set("display_update", _displayUpdate);
         xconfig.Set("display_delete", _displayDelete);
