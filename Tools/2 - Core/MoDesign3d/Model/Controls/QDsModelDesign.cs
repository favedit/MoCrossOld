...
namespace MO.Design3d.Model.Controls
{
   ...
   // <T>模型设计表单。</T>
   //============================================================
   public partial class QDsModelDesign : UserControl
   {
      //============================================================
      // <T>构造模型设计表单。</T>
      //============================================================
      public QDsModelDesign() {
         InitializeComponent();
      }
      ...
      private void LoadCatalogNode(TreeNodeCollection nodes, FCfgFolder folder) {
         ...
         for(int n = 0; n < count; n++) {
            ...
            if(tag is FDrModel) {
               childNode.ImageKey = "Model";
               childNode.SelectedImageKey = "Model";
               loaded = false;
            } else {
      ...
      public void Open() {
         ...
         LoadCatalogNode(tvwCatalog.Nodes, RContent3dManager.ModelConsole.Folder);
