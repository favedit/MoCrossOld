...
{
   partial class QDsModelDesignForm
   {
      /// <summary>
      ...
      private void InitializeComponent() {
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(QDsModelDesignForm));
         ...
         this.qdsModelDesign = new MO.Design3d.Model.Controls.QDsModelDesign();
         ...
         this.tspMainToolbar.Size = new System.Drawing.Size(1044, 25);
         ...
         // sspMainStatus
         // 
         this.sspMainStatus.Location = new System.Drawing.Point(0, 651);
         this.sspMainStatus.Name = "sspMainStatus";
         this.sspMainStatus.Size = new System.Drawing.Size(1044, 22);
         this.sspMainStatus.TabIndex = 24;
         this.sspMainStatus.Text = "statusStrip1";
         // 
         // qdsModelDesign
         // 
         this.qdsModelDesign.Dock = System.Windows.Forms.DockStyle.Fill;
         this.qdsModelDesign.Location = new System.Drawing.Point(0, 25);
         this.qdsModelDesign.Name = "qdsModelDesign";
         this.qdsModelDesign.Size = new System.Drawing.Size(1044, 626);
         this.qdsModelDesign.TabIndex = 25;
         // 
         // QDsModelDesignForm
         // 
         ...
         this.Controls.Add(this.qdsModelDesign);
         this.Controls.Add(this.sspMainStatus);
         this.Controls.Add(this.tspMainToolbar);
         this.Name = "QDsModelDesignForm";
         this.Text = "QDsModelDesignForm";
      ...
      private Controls.QDsModelDesign qdsModelDesign;
   }
}